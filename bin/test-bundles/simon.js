  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/simon.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery/simon", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/simon.data');
      }
      Module['addRunDependency']('datafile_/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/simon.data');
