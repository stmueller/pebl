  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/TNT.data';
      var REMOTE_PACKAGE_BASE = 'TNT.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "TNT", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/TNT", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/TNT", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/TNT.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/TNT.data');
    ...
    Module['removeRunDependency']('TNT.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('TNT.js.metadata');
    var metadataUrl = Module['locateFile']?.('TNT.js.metadata', '') ?? 'TNT.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
