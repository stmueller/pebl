  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/affectgrid.data';
      var REMOTE_PACKAGE_BASE = 'affectgrid.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "affectgrid", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/affectgrid", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/affectgrid", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/affectgrid.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/affectgrid.data');
    ...
    Module['removeRunDependency']('affectgrid.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('affectgrid.js.metadata');
    var metadataUrl = Module['locateFile']?.('affectgrid.js.metadata', '') ?? 'affectgrid.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
