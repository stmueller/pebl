  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/vsearch.data';
      var REMOTE_PACKAGE_BASE = 'vsearch.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "vsearch", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/vsearch", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/vsearch", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/vsearch.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/vsearch.data');
    ...
    Module['removeRunDependency']('vsearch.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('vsearch.js.metadata');
    var metadataUrl = Module['locateFile']?.('vsearch.js.metadata', '') ?? 'vsearch.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
