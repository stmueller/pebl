  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/tracking.data';
      var REMOTE_PACKAGE_BASE = 'tracking.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "tracking", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/tracking", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/tracking", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/tracking.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/tracking.data');
    ...
    Module['removeRunDependency']('tracking.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('tracking.js.metadata');
    var metadataUrl = Module['locateFile']?.('tracking.js.metadata', '') ?? 'tracking.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
