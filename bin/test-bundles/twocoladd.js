  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/twocoladd.data';
      var REMOTE_PACKAGE_BASE = 'twocoladd.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "twocoladd", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/twocoladd", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/twocoladd", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/twocoladd.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/twocoladd.data');
    ...
    Module['removeRunDependency']('twocoladd.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('twocoladd.js.metadata');
    var metadataUrl = Module['locateFile']?.('twocoladd.js.metadata', '') ?? 'twocoladd.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
