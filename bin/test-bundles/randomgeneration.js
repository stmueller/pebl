  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/randomgeneration.data';
      var REMOTE_PACKAGE_BASE = 'randomgeneration.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "randomgeneration", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/randomgeneration", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/randomgeneration", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/randomgeneration.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/randomgeneration.data');
    ...
    Module['removeRunDependency']('randomgeneration.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('randomgeneration.js.metadata');
    var metadataUrl = Module['locateFile']?.('randomgeneration.js.metadata', '') ?? 'randomgeneration.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
