  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/dotjudgment.data';
      var REMOTE_PACKAGE_BASE = 'dotjudgment.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery/dotjudgment", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/dotjudgment.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/dotjudgment.data');
    ...
    Module['removeRunDependency']('dotjudgment.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('dotjudgment.js.metadata');
    var metadataUrl = Module['locateFile']?.('dotjudgment.js.metadata', '') ?? 'dotjudgment.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
