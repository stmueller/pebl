  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/matrixrotation.data';
      var REMOTE_PACKAGE_BASE = 'matrixrotation.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "matrixrotation", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/matrixrotation", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/matrixrotation", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/matrixrotation.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/matrixrotation.data');
    ...
    Module['removeRunDependency']('matrixrotation.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('matrixrotation.js.metadata');
    var metadataUrl = Module['locateFile']?.('matrixrotation.js.metadata', '') ?? 'matrixrotation.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
