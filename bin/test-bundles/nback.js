  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/nback.data';
      var REMOTE_PACKAGE_BASE = 'nback.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "nback", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/nback", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/nback", "sounds", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/nback", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/nback.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/nback.data');
    ...
    Module['removeRunDependency']('nback.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('nback.js.metadata');
    var metadataUrl = Module['locateFile']?.('nback.js.metadata', '') ?? 'nback.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
