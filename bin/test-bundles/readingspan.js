  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/readingspan.data';
      var REMOTE_PACKAGE_BASE = 'readingspan.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "readingspan", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/readingspan", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/readingspan", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/readingspan.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/readingspan.data');
    ...
    Module['removeRunDependency']('readingspan.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('readingspan.js.metadata');
    var metadataUrl = Module['locateFile']?.('readingspan.js.metadata', '') ?? 'readingspan.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
