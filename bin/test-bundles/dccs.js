  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/dccs.data';
      var REMOTE_PACKAGE_BASE = 'dccs.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "dccs", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/dccs", "audio", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/dccs", "imgs", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/dccs", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/dccs", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/dccs.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/dccs.data');
    ...
    Module['removeRunDependency']('dccs.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('dccs.js.metadata');
    var metadataUrl = Module['locateFile']?.('dccs.js.metadata', '') ?? 'dccs.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
