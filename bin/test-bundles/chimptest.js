  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/chimptest.data';
      var REMOTE_PACKAGE_BASE = 'chimptest.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "chimptest", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/chimptest", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/chimptest", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/chimptest.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/chimptest.data');
    ...
    Module['removeRunDependency']('chimptest.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('chimptest.js.metadata');
    var metadataUrl = Module['locateFile']?.('chimptest.js.metadata', '') ?? 'chimptest.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
