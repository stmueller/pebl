...
#DS-ROC: make an ROC based on the #count and a high-low
...
#Size-ROC: make an ROC based on the size of the stimulus, which shouldn't matter.
...
Because Line-related ROC can measure association between a stimulus property and response, let's calculate AUC for each session.
