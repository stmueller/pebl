  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/matrixrotation.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery/matrixrotation", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/matrixrotation.data');
      }
      Module['addRunDependency']('datafile_/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/matrixrotation.data');
