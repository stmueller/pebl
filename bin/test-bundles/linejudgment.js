  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/linejudgment.data';
      var REMOTE_PACKAGE_BASE = 'linejudgment.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "linejudgment", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/linejudgment", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/linejudgment", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/linejudgment.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/linejudgment.data');
    ...
    Module['removeRunDependency']('linejudgment.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('linejudgment.js.metadata');
    var metadataUrl = Module['locateFile']?.('linejudgment.js.metadata', '') ?? 'linejudgment.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
