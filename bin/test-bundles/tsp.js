  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/tsp.data';
      var REMOTE_PACKAGE_BASE = 'tsp.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "tsp", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/tsp", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/tsp", "tours", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/tsp", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/tsp.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/tsp.data');
    ...
    Module['removeRunDependency']('tsp.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('tsp.js.metadata');
    var metadataUrl = Module['locateFile']?.('tsp.js.metadata', '') ?? 'tsp.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
