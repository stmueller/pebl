  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/pattcomp-samediff.data';
      var REMOTE_PACKAGE_BASE = 'pattcomp-samediff.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "pattcomp-samediff", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/pattcomp-samediff", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/pattcomp-samediff", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/pattcomp-samediff.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/pattcomp-samediff.data');
    ...
    Module['removeRunDependency']('pattcomp-samediff.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('pattcomp-samediff.js.metadata');
    var metadataUrl = Module['locateFile']?.('pattcomp-samediff.js.metadata', '') ?? 'pattcomp-samediff.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
