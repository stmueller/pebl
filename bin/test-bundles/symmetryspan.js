  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/symmetryspan.data';
      var REMOTE_PACKAGE_BASE = 'symmetryspan.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "symmetryspan", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/symmetryspan", "img", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/symmetryspan", "img_practice", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/symmetryspan", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/symmetryspan", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/symmetryspan.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/symmetryspan.data');
    ...
    Module['removeRunDependency']('symmetryspan.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('symmetryspan.js.metadata');
    var metadataUrl = Module['locateFile']?.('symmetryspan.js.metadata', '') ?? 'symmetryspan.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
