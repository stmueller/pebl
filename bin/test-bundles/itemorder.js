  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/itemorder.data';
      var REMOTE_PACKAGE_BASE = 'itemorder.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "itemorder", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/itemorder", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/itemorder", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/itemorder.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/itemorder.data');
    ...
    Module['removeRunDependency']('itemorder.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('itemorder.js.metadata');
    var metadataUrl = Module['locateFile']?.('itemorder.js.metadata', '') ?? 'itemorder.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
