############################################################################################
#      NSIS Installation Script for PEBL 2.4
...
!define INSTALLER_NAME "..\PEBL_setup.2.4.2.exe"
!define MAIN_APP_EXE "pebl2.exe"
!define INSTALL_TYPE "SetShellVarContext all"
!define REG_ROOT "HKCU"
!define REG_APP_PATH "Software\Microsoft\Windows\CurrentVersion\App Paths\${MAIN_APP_EXE}"
!define UNINSTALL_PATH "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APP_NAME}"
!define USERDIR "$DOCUMENTS\pebl-exp.2.4"
...
File "..\doc\pman\PEBLManual2.4.pdf"
...
File /r /x data "..\battery\digitsymbol"
...
File /r /x data "..\battery\pattcomp-samediff"
File /r /x data "..\battery\pattcomp-seq"
...
File /r /x data "..\battery\spatialcueing"
...
SetOutPath "$INSTDIR"
CreateShortCut "$SMPROGRAMS\$SM_Folder\Documentation.lnk" "$INSTDIR\doc\PEBLManual2.4.pdf"
!ifdef WEB_SITE
