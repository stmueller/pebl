  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/ptrails.data';
      var REMOTE_PACKAGE_BASE = 'ptrails.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery/ptrails", "data", true, true);
...
Module['FS_createPath']("/usr/local/share/pebl2/battery/ptrails", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/ptrails.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/ptrails.data');
    ...
    Module['removeRunDependency']('ptrails.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('ptrails.js.metadata');
    var metadataUrl = Module['locateFile']?.('ptrails.js.metadata', '') ?? 'ptrails.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
