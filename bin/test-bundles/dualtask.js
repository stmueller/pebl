  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/dualtask.data';
      var REMOTE_PACKAGE_BASE = 'dualtask.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "dualtask", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/dualtask", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/dualtask", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/dualtask.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/dualtask.data');
    ...
    Module['removeRunDependency']('dualtask.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('dualtask.js.metadata');
    var metadataUrl = Module['locateFile']?.('dualtask.js.metadata', '') ?? 'dualtask.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
