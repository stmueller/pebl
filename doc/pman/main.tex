...
% (sphinx.sty is copied to this directory by: cd doc/sphinx-doc && make latex-chapter-with-styles)
\usepackage{sphinx}
...
\normalsize
\noindent\copyright 2003-2026 Shane T.~Mueller \href{mailto:smueller@obereed.net}{smueller@obereed.net}\\
\href{mailto:shanem@mtu.edu}{shanem@mtu.edu}\\
\\
\\


Current for PEBL Version 2.4 -- Released 2025 \\
\href{http://pebl.sourceforge.net}{http://pebl.sourceforge.net}


\newpage
\normalsize
\noindent COPYRIGHT \copyright 2026 Shane T.~Mueller. All rights reserved.\\
\vspace{2cm}
