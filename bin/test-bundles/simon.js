  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/simon.data';
      var REMOTE_PACKAGE_BASE = 'simon.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "simon", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/simon", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/simon", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/simon.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/simon.data');
    ...
    Module['removeRunDependency']('simon.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('simon.js.metadata');
    var metadataUrl = Module['locateFile']?.('simon.js.metadata', '') ?? 'simon.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
