...
## http=2 is curl
CXXFLAGS_WIN32 =   -pipe -DPEBL_WIN32 -DNO_STDIO_REDIRECT -DENABLE_BINRELOC -DPREFIX=$(PREFIX) -DEXECNAME=$(EXECNAME) -DPEBLNAME=$(PEBLNAME) -DPEBLDIRNAME=$(PEBLDIRNAME) -DPEBL_VERSION=\"$(PEBL_VERSION)\" -DHTTP_LIB=2 -DCURL_NO_OLDIES -Isrc/libs -Isrc/base -Isrc/utility -Isrc/devices -Isrc/objects -Isrc/platforms/sdl
