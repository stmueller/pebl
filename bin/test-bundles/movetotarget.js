  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/movetotarget.data';
      var REMOTE_PACKAGE_BASE = 'movetotarget.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "movetotarget", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/movetotarget", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/movetotarget", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/movetotarget.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/movetotarget.data');
    ...
    Module['removeRunDependency']('movetotarget.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('movetotarget.js.metadata');
    var metadataUrl = Module['locateFile']?.('movetotarget.js.metadata', '') ?? 'movetotarget.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
