  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/luckvogel.data';
      var REMOTE_PACKAGE_BASE = 'luckvogel.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "luckvogel", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/luckvogel", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/luckvogel", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/luckvogel.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/luckvogel.data');
    ...
    Module['removeRunDependency']('luckvogel.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('luckvogel.js.metadata');
    var metadataUrl = Module['locateFile']?.('luckvogel.js.metadata', '') ?? 'luckvogel.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
