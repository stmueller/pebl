  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/pattcomp-seq.data';
      var REMOTE_PACKAGE_BASE = 'pattcomp-seq.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "pattcomp-seq", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/pattcomp-seq", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/pattcomp-seq", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/pattcomp-seq.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/pattcomp-seq.data');
    ...
    Module['removeRunDependency']('pattcomp-seq.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('pattcomp-seq.js.metadata');
    var metadataUrl = Module['locateFile']?.('pattcomp-seq.js.metadata', '') ?? 'pattcomp-seq.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
