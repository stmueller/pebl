  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/mathproc.data';
      var REMOTE_PACKAGE_BASE = 'mathproc.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "mathproc", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/mathproc", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/mathproc", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/mathproc.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/mathproc.data');
    ...
    Module['removeRunDependency']('mathproc.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('mathproc.js.metadata');
    var metadataUrl = Module['locateFile']?.('mathproc.js.metadata', '') ?? 'mathproc.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
