...
//This is a modified platform font that attempts to use harfbuzz renderer
//to support RTL and other craziness
...
public:
    ...
    PlatformFont(PlatformFont & font);              ///Copy constructor
...
//     virtual PColor GetBackgroundColor() const {return SDLUtility::SDLColorToPColor(mSDL_BGColor);}
    ...
    //SDL_Texture * DrawTextHB(const std::wstring & text);
...
private:
    ...
    FT_Library * mLibrary;// FT library reference
    //TTF_Font * mTTF_Font;
    FT_Face * mFace;       //freetype face
    bh_font_t * mHBFont;   //harfbuzz font
