  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/brownpeterson.data';
      var REMOTE_PACKAGE_BASE = 'brownpeterson.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "brownpeterson", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/brownpeterson", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/brownpeterson", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/brownpeterson.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/brownpeterson.data');
    ...
    Module['removeRunDependency']('brownpeterson.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('brownpeterson.js.metadata');
    var metadataUrl = Module['locateFile']?.('brownpeterson.js.metadata', '') ?? 'brownpeterson.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
