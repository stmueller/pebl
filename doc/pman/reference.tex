...
\item {} 
\sphinxAtStartPar
{\hyperref[\detokenize{reference/peblmath::doc}]{\sphinxcrossref{\DUrole{doc}{PEBLMath \sphinxhyphen{} Mathematical}}}}
...
\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id4}}{\hyperref[\detokenize{reference/peblenvironment:checkprocessstatus}]{\sphinxcrossref{CheckProcessStatus()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id5}}{\hyperref[\detokenize{reference/peblenvironment:deletefile}]{\sphinxcrossref{DeleteFile()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id6}}{\hyperref[\detokenize{reference/peblenvironment:exitquietly}]{\sphinxcrossref{ExitQuietly()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id7}}{\hyperref[\detokenize{reference/peblenvironment:fileexists}]{\sphinxcrossref{FileExists()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id8}}{\hyperref[\detokenize{reference/peblenvironment:getcurrentscreenresolution}]{\sphinxcrossref{GetCurrentScreenResolution()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id9}}{\hyperref[\detokenize{reference/peblenvironment:getdirectorylisting}]{\sphinxcrossref{GetDirectoryListing()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id10}}{\hyperref[\detokenize{reference/peblenvironment:getdrivers}]{\sphinxcrossref{GetDrivers()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id11}}{\hyperref[\detokenize{reference/peblenvironment:getexecutablename}]{\sphinxcrossref{GetExecutableName()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id12}}{\hyperref[\detokenize{reference/peblenvironment:gethomedirectory}]{\sphinxcrossref{GetHomeDirectory()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id13}}{\hyperref[\detokenize{reference/peblenvironment:getjoystickaxisstate}]{\sphinxcrossref{GetJoystickAxisState()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id14}}{\hyperref[\detokenize{reference/peblenvironment:getjoystickballstate}]{\sphinxcrossref{GetJoystickBallState()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id15}}{\hyperref[\detokenize{reference/peblenvironment:getjoystickbuttonstate}]{\sphinxcrossref{GetJoystickButtonState()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id16}}{\hyperref[\detokenize{reference/peblenvironment:getjoystickhatstate}]{\sphinxcrossref{GetJoystickHatState()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id17}}{\hyperref[\detokenize{reference/peblenvironment:getmousecursorposition}]{\sphinxcrossref{GetMouseCursorPosition()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id18}}{\hyperref[\detokenize{reference/peblenvironment:getmousestate}]{\sphinxcrossref{GetMouseState()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id19}}{\hyperref[\detokenize{reference/peblenvironment:getnumjoystickaxes}]{\sphinxcrossref{GetNumJoystickAxes()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id20}}{\hyperref[\detokenize{reference/peblenvironment:getnumjoystickballs}]{\sphinxcrossref{GetNumJoystickBalls()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id21}}{\hyperref[\detokenize{reference/peblenvironment:getnumjoystickbuttons}]{\sphinxcrossref{GetNumJoystickButtons()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id22}}{\hyperref[\detokenize{reference/peblenvironment:getnumjoystickhats}]{\sphinxcrossref{GetNumJoystickHats()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id23}}{\hyperref[\detokenize{reference/peblenvironment:getnumjoysticks}]{\sphinxcrossref{GetNumJoysticks()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id24}}{\hyperref[\detokenize{reference/peblenvironment:getpeblversion}]{\sphinxcrossref{GetPEBLVersion()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id25}}{\hyperref[\detokenize{reference/peblenvironment:getsystemtype}]{\sphinxcrossref{GetSystemType()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id26}}{\hyperref[\detokenize{reference/peblenvironment:gettextboxcursorfromclick}]{\sphinxcrossref{GetTextBoxCursorFromClick()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id27}}{\hyperref[\detokenize{reference/peblenvironment:gettime}]{\sphinxcrossref{GetTime()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id28}}{\hyperref[\detokenize{reference/peblenvironment:gettimeofday}]{\sphinxcrossref{GetTimeOfDay()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id29}}{\hyperref[\detokenize{reference/peblenvironment:getvideomodes}]{\sphinxcrossref{GetVideoModes()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id30}}{\hyperref[\detokenize{reference/peblenvironment:getworkingdirectory}]{\sphinxcrossref{GetWorkingDirectory()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id31}}{\hyperref[\detokenize{reference/peblenvironment:isanykeydown}]{\sphinxcrossref{IsAnyKeyDown()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id32}}{\hyperref[\detokenize{reference/peblenvironment:isaudioout}]{\sphinxcrossref{IsAudioOut()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id33}}{\hyperref[\detokenize{reference/peblenvironment:iscanvas}]{\sphinxcrossref{IsCanvas()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id34}}{\hyperref[\detokenize{reference/peblenvironment:iscolor}]{\sphinxcrossref{IsColor()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id35}}{\hyperref[\detokenize{reference/peblenvironment:iscustomobject}]{\sphinxcrossref{IsCustomObject()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id36}}{\hyperref[\detokenize{reference/peblenvironment:ispeblobject}]{\sphinxcrossref{IsPEBLObject()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id37}}{\hyperref[\detokenize{reference/peblenvironment:isdirectory}]{\sphinxcrossref{IsDirectory()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id38}}{\hyperref[\detokenize{reference/peblenvironment:isfilestream}]{\sphinxcrossref{IsFileStream()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id39}}{\hyperref[\detokenize{reference/peblenvironment:isfloat}]{\sphinxcrossref{IsFloat()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id40}}{\hyperref[\detokenize{reference/peblenvironment:isfont}]{\sphinxcrossref{IsFont()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id41}}{\hyperref[\detokenize{reference/peblenvironment:isimage}]{\sphinxcrossref{IsImage()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id42}}{\hyperref[\detokenize{reference/peblenvironment:isinteger}]{\sphinxcrossref{IsInteger()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id43}}{\hyperref[\detokenize{reference/peblenvironment:iskeydown}]{\sphinxcrossref{IsKeyDown()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id44}}{\hyperref[\detokenize{reference/peblenvironment:iskeyup}]{\sphinxcrossref{IsKeyUp()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id45}}{\hyperref[\detokenize{reference/peblenvironment:islabel}]{\sphinxcrossref{IsLabel()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id46}}{\hyperref[\detokenize{reference/peblenvironment:islist}]{\sphinxcrossref{IsList()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id47}}{\hyperref[\detokenize{reference/peblenvironment:isnumber}]{\sphinxcrossref{IsNumber()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id48}}{\hyperref[\detokenize{reference/peblenvironment:isshape}]{\sphinxcrossref{IsShape()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id49}}{\hyperref[\detokenize{reference/peblenvironment:isstring}]{\sphinxcrossref{IsString()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id50}}{\hyperref[\detokenize{reference/peblenvironment:istext}]{\sphinxcrossref{IsText()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id51}}{\hyperref[\detokenize{reference/peblenvironment:istextbox}]{\sphinxcrossref{IsTextBox()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id52}}{\hyperref[\detokenize{reference/peblenvironment:iswidget}]{\sphinxcrossref{IsWidget()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id53}}{\hyperref[\detokenize{reference/peblenvironment:iswindow}]{\sphinxcrossref{IsWindow()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id54}}{\hyperref[\detokenize{reference/peblenvironment:launchfile}]{\sphinxcrossref{LaunchFile()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id55}}{\hyperref[\detokenize{reference/peblenvironment:makedirectory}]{\sphinxcrossref{MakeDirectory()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id56}}{\hyperref[\detokenize{reference/peblenvironment:openjoystick}]{\sphinxcrossref{OpenJoystick()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id57}}{\hyperref[\detokenize{reference/peblenvironment:playmovie}]{\sphinxcrossref{PlayMovie()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id58}}{\hyperref[\detokenize{reference/peblenvironment:registerevent}]{\sphinxcrossref{RegisterEvent()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id59}}{\hyperref[\detokenize{reference/peblenvironment:setmousecursorposition}]{\sphinxcrossref{SetMouseCursorPosition()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id60}}{\hyperref[\detokenize{reference/peblenvironment:setworkingdirectory}]{\sphinxcrossref{SetWorkingDirectory()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id61}}{\hyperref[\detokenize{reference/peblenvironment:showcursor}]{\sphinxcrossref{ShowCursor()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id62}}{\hyperref[\detokenize{reference/peblenvironment:signalfatalerror}]{\sphinxcrossref{SignalFatalError()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id63}}{\hyperref[\detokenize{reference/peblenvironment:starteventloop}]{\sphinxcrossref{StartEventLoop()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id64}}{\hyperref[\detokenize{reference/peblenvironment:systemcall}]{\sphinxcrossref{SystemCall()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id65}}{\hyperref[\detokenize{reference/peblenvironment:systemcallupdate}]{\sphinxcrossref{SystemCallUpdate()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id66}}{\hyperref[\detokenize{reference/peblenvironment:timestamp}]{\sphinxcrossref{TimeStamp()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id67}}{\hyperref[\detokenize{reference/peblenvironment:translatekeycode}]{\sphinxcrossref{TranslateKeyCode()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id68}}{\hyperref[\detokenize{reference/peblenvironment:translatestring}]{\sphinxcrossref{TranslateString()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id69}}{\hyperref[\detokenize{reference/peblenvironment:variableexists}]{\sphinxcrossref{VariableExists()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id70}}{\hyperref[\detokenize{reference/peblenvironment:wait}]{\sphinxcrossref{Wait()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id71}}{\hyperref[\detokenize{reference/peblenvironment:waitforallkeysup}]{\sphinxcrossref{WaitForAllKeysUp()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id72}}{\hyperref[\detokenize{reference/peblenvironment:waitforkeydown}]{\sphinxcrossref{WaitForKeyDown()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id73}}{\hyperref[\detokenize{reference/peblenvironment:waitforanykeydown}]{\sphinxcrossref{WaitForAnyKeyDown()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id74}}{\hyperref[\detokenize{reference/peblenvironment:waitforanykeydownwithtimeout}]{\sphinxcrossref{WaitForAnyKeyDownWithTimeout()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id75}}{\hyperref[\detokenize{reference/peblenvironment:waitforanykeypress}]{\sphinxcrossref{WaitForAnyKeyPress()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id76}}{\hyperref[\detokenize{reference/peblenvironment:waitforanykeypresswithtimeout}]{\sphinxcrossref{WaitForAnyKeyPressWithTimeout()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id77}}{\hyperref[\detokenize{reference/peblenvironment:waitforkeylistdown}]{\sphinxcrossref{WaitForKeyListDown()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id78}}{\hyperref[\detokenize{reference/peblenvironment:waitforkeypress}]{\sphinxcrossref{WaitForKeyPress()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id79}}{\hyperref[\detokenize{reference/peblenvironment:waitforkeyup}]{\sphinxcrossref{WaitForKeyUp()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id80}}{\hyperref[\detokenize{reference/peblenvironment:waitforkeyrelease}]{\sphinxcrossref{WaitForKeyRelease()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id81}}{\hyperref[\detokenize{reference/peblenvironment:waitforlistkeypress}]{\sphinxcrossref{WaitForListKeyPress()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id82}}{\hyperref[\detokenize{reference/peblenvironment:waitforlistkeypresswithtimeout}]{\sphinxcrossref{WaitForListKeyPressWithTimeout()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id83}}{\hyperref[\detokenize{reference/peblenvironment:waitformousebutton}]{\sphinxcrossref{WaitForMouseButton()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblenvironment:id84}}{\hyperref[\detokenize{reference/peblenvironment:waitformousebuttonwithtimeout}]{\sphinxcrossref{WaitForMouseButtonWithTimeout()}}}
...
\index{CheckProcessStatus@\spxentry{CheckProcessStatus}}\ignorespaces 

\subsection{CheckProcessStatus()}
\label{\detokenize{reference/peblenvironment:checkprocessstatus}}\label{\detokenize{reference/peblenvironment:index-3}}
\sphinxAtStartPar
\sphinxstyleemphasis{Checks if a background process is still running}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Checks the status of a background process launched with SystemCall(). Takes a process ID (PID) as an argument and returns 1 if the process is still running, 0 if it has finished, or \sphinxhyphen{}1 if there was an error checking the status. This is only available on Unix/Linux systems and requires the process to have been launched from within PEBL.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{CheckProcessStatus}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{pid}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Launch a background process (Unix only)}
\PYG{n+nv}{pid}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{SystemCall}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}sleep 5 \PYGZam{}\PYGZdq{}}\PYG{p}{)}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Check if it\PYGZsq{}s still running}
\PYG{n+nv}{status}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{CheckProcessStatus}\PYG{p}{(}\PYG{n+nv}{pid}\PYG{p}{)}
\PYG{k}{if}\PYG{p}{(}\PYG{n+nv}{status}\PYG{+w}{ }\PYG{o}{==}\PYG{+w}{ }\PYG{l+m+mi}{1}\PYG{p}{)}
\PYG{p}{\PYGZob{}}
\PYG{+w}{   }\PYG{n+nf}{Print}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}Process still running\PYGZdq{}}\PYG{p}{)}
\PYG{p}{\PYGZcb{}}\PYG{+w}{ }\PYG{k}{elseif}\PYG{p}{(}\PYG{n+nv}{status}\PYG{+w}{ }\PYG{o}{==}\PYG{+w}{ }\PYG{l+m+mi}{0}\PYG{p}{)}\PYG{+w}{ }\PYG{p}{\PYGZob{}}
\PYG{+w}{   }\PYG{n+nf}{Print}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}Process finished\PYGZdq{}}\PYG{p}{)}
\PYG{p}{\PYGZcb{}}\PYG{+w}{ }\PYG{k}{else}\PYG{+w}{ }\PYG{p}{\PYGZob{}}
\PYG{+w}{   }\PYG{n+nf}{Print}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}Error checking process\PYGZdq{}}\PYG{p}{)}
\PYG{p}{\PYGZcb{}}
\end{sphinxVerbatim}
...
\label{\detokenize{reference/peblenvironment:deletefile}}\label{\detokenize{reference/peblenvironment:index-4}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:exitquietly}}\label{\detokenize{reference/peblenvironment:index-5}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblenvironment:fileexists}}\label{\detokenize{reference/peblenvironment:index-6}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:getcurrentscreenresolution}}\label{\detokenize{reference/peblenvironment:index-7}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblenvironment:getdirectorylisting}}\label{\detokenize{reference/peblenvironment:index-8}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:getdrivers}}\label{\detokenize{reference/peblenvironment:index-9}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:getexecutablename}}\label{\detokenize{reference/peblenvironment:index-10}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:gethomedirectory}}\label{\detokenize{reference/peblenvironment:index-11}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:getjoystickaxisstate}}\label{\detokenize{reference/peblenvironment:index-12}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:getjoystickballstate}}\label{\detokenize{reference/peblenvironment:index-13}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:getjoystickbuttonstate}}\label{\detokenize{reference/peblenvironment:index-14}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblenvironment:getjoystickhatstate}}\label{\detokenize{reference/peblenvironment:index-15}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:getmousecursorposition}}\label{\detokenize{reference/peblenvironment:index-16}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblenvironment:getmousestate}}\label{\detokenize{reference/peblenvironment:index-17}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:getnumjoystickaxes}}\label{\detokenize{reference/peblenvironment:index-18}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:getnumjoystickballs}}\label{\detokenize{reference/peblenvironment:index-19}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:getnumjoystickbuttons}}\label{\detokenize{reference/peblenvironment:index-20}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblenvironment:getnumjoystickhats}}\label{\detokenize{reference/peblenvironment:index-21}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:getnumjoysticks}}\label{\detokenize{reference/peblenvironment:index-22}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:getpeblversion}}\label{\detokenize{reference/peblenvironment:index-23}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:getsystemtype}}\label{\detokenize{reference/peblenvironment:index-24}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:gettextboxcursorfromclick}}\label{\detokenize{reference/peblenvironment:index-25}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{GetTime()}
\label{\detokenize{reference/peblenvironment:gettime}}\label{\detokenize{reference/peblenvironment:index-26}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:gettimeofday}}\label{\detokenize{reference/peblenvironment:index-27}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:getvideomodes}}\label{\detokenize{reference/peblenvironment:index-28}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:getworkingdirectory}}\label{\detokenize{reference/peblenvironment:index-29}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:isanykeydown}}\label{\detokenize{reference/peblenvironment:index-30}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:isaudioout}}\label{\detokenize{reference/peblenvironment:index-31}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{IsCanvas()}
\label{\detokenize{reference/peblenvironment:iscanvas}}\label{\detokenize{reference/peblenvironment:index-32}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{IsColor()}
\label{\detokenize{reference/peblenvironment:iscolor}}\label{\detokenize{reference/peblenvironment:index-33}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblenvironment:iscustomobject}}\label{\detokenize{reference/peblenvironment:index-34}}
\sphinxAtStartPar
...
\index{IsPEBLObject@\spxentry{IsPEBLObject}}\ignorespaces 

\subsection{IsPEBLObject()}
\label{\detokenize{reference/peblenvironment:ispeblobject}}\label{\detokenize{reference/peblenvironment:index-35}}
\sphinxAtStartPar
\sphinxstyleemphasis{Tests whether a value is any PEBL graphics or custom object.}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Returns 1 if \sphinxcode{\sphinxupquote{obj}} is any PEBL object — window, label, image, canvas, textbox, shape, font, color, audio, widget, or custom object.  Returns 0 for plain values (strings, numbers, lists).  Use this as a generic type guard when you need to distinguish objects from scalar values, for example before calling property\sphinxhyphen{}access functions.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{IsPEBLObject}\PYG{p}{(}\PYG{n+nv}{obj}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{if}\PYG{p}{(}\PYG{n+nf}{IsPEBLObject}\PYG{p}{(}\PYG{n+nv}{val}\PYG{p}{)}\PYG{p}{)}
\PYG{p}{\PYGZob{}}
\PYG{+w}{    }\PYG{n+nv}{propNames}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{GetPropertyList}\PYG{p}{(}\PYG{n+nv}{val}\PYG{p}{)}
\PYG{p}{\PYGZcb{}}\PYG{+w}{ }\PYG{k}{else}\PYG{+w}{ }\PYG{p}{\PYGZob{}}
\PYG{+w}{    }\PYG{n+nf}{Print}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}Value: \PYGZdq{}}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{n+nv}{val}\PYG{p}{)}
\PYG{p}{\PYGZcb{}}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{IsCustomObject()}}, \sphinxcode{\sphinxupquote{IsLabel()}}, \sphinxcode{\sphinxupquote{IsWindow()}}, \sphinxcode{\sphinxupquote{IsWidget()}}

\index{IsDirectory@\spxentry{IsDirectory}}\ignorespaces 

\subsection{IsDirectory()}
\label{\detokenize{reference/peblenvironment:isdirectory}}\label{\detokenize{reference/peblenvironment:index-36}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:isfilestream}}\label{\detokenize{reference/peblenvironment:index-37}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{IsFloat()}
\label{\detokenize{reference/peblenvironment:isfloat}}\label{\detokenize{reference/peblenvironment:index-38}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{IsFont()}
\label{\detokenize{reference/peblenvironment:isfont}}\label{\detokenize{reference/peblenvironment:index-39}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{IsImage()}
\label{\detokenize{reference/peblenvironment:isimage}}\label{\detokenize{reference/peblenvironment:index-40}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblenvironment:isinteger}}\label{\detokenize{reference/peblenvironment:index-41}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblenvironment:iskeydown}}\label{\detokenize{reference/peblenvironment:index-42}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{IsKeyUp()}
\label{\detokenize{reference/peblenvironment:iskeyup}}\label{\detokenize{reference/peblenvironment:index-43}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{IsLabel()}
\label{\detokenize{reference/peblenvironment:islabel}}\label{\detokenize{reference/peblenvironment:index-44}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{IsList()}
\label{\detokenize{reference/peblenvironment:islist}}\label{\detokenize{reference/peblenvironment:index-45}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{IsNumber()}
\label{\detokenize{reference/peblenvironment:isnumber}}\label{\detokenize{reference/peblenvironment:index-46}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{IsShape()}
\label{\detokenize{reference/peblenvironment:isshape}}\label{\detokenize{reference/peblenvironment:index-47}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{IsString()}
\label{\detokenize{reference/peblenvironment:isstring}}\label{\detokenize{reference/peblenvironment:index-48}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{IsText()}
\label{\detokenize{reference/peblenvironment:istext}}\label{\detokenize{reference/peblenvironment:index-49}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblenvironment:istextbox}}\label{\detokenize{reference/peblenvironment:index-50}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{IsWidget()}
\label{\detokenize{reference/peblenvironment:iswidget}}\label{\detokenize{reference/peblenvironment:index-51}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{IsWindow()}
\label{\detokenize{reference/peblenvironment:iswindow}}\label{\detokenize{reference/peblenvironment:index-52}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblenvironment:launchfile}}\label{\detokenize{reference/peblenvironment:index-53}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:makedirectory}}\label{\detokenize{reference/peblenvironment:index-54}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:openjoystick}}\label{\detokenize{reference/peblenvironment:index-55}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:playmovie}}\label{\detokenize{reference/peblenvironment:index-56}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:registerevent}}\label{\detokenize{reference/peblenvironment:index-57}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:setmousecursorposition}}\label{\detokenize{reference/peblenvironment:index-58}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblenvironment:setworkingdirectory}}\label{\detokenize{reference/peblenvironment:index-59}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:showcursor}}\label{\detokenize{reference/peblenvironment:index-60}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:signalfatalerror}}\label{\detokenize{reference/peblenvironment:index-61}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:starteventloop}}\label{\detokenize{reference/peblenvironment:index-62}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:systemcall}}\label{\detokenize{reference/peblenvironment:index-63}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:systemcallupdate}}\label{\detokenize{reference/peblenvironment:index-64}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:timestamp}}\label{\detokenize{reference/peblenvironment:index-65}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:translatekeycode}}\label{\detokenize{reference/peblenvironment:index-66}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:translatestring}}\label{\detokenize{reference/peblenvironment:index-67}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:variableexists}}\label{\detokenize{reference/peblenvironment:index-68}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{Wait()}
\label{\detokenize{reference/peblenvironment:wait}}\label{\detokenize{reference/peblenvironment:index-69}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblenvironment:waitforallkeysup}}\label{\detokenize{reference/peblenvironment:index-70}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:waitforkeydown}}\label{\detokenize{reference/peblenvironment:index-71}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:waitforanykeydown}}\label{\detokenize{reference/peblenvironment:index-72}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:waitforanykeydownwithtimeout}}\label{\detokenize{reference/peblenvironment:index-73}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblenvironment:waitforanykeypress}}\label{\detokenize{reference/peblenvironment:index-74}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:waitforanykeypresswithtimeout}}\label{\detokenize{reference/peblenvironment:index-75}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblenvironment:waitforkeylistdown}}\label{\detokenize{reference/peblenvironment:index-76}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:waitforkeypress}}\label{\detokenize{reference/peblenvironment:index-77}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblenvironment:waitforkeyup}}\label{\detokenize{reference/peblenvironment:index-78}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblenvironment:waitforkeyrelease}}\label{\detokenize{reference/peblenvironment:index-79}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:waitforlistkeypress}}\label{\detokenize{reference/peblenvironment:index-80}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblenvironment:waitforlistkeypresswithtimeout}}\label{\detokenize{reference/peblenvironment:index-81}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblenvironment:waitformousebutton}}\label{\detokenize{reference/peblenvironment:index-82}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblenvironment:waitformousebuttonwithtimeout}}\label{\detokenize{reference/peblenvironment:index-83}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id1}}{\hyperref[\detokenize{reference/pebllist:append}]{\sphinxcrossref{Append()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id2}}{\hyperref[\detokenize{reference/pebllist:crossfactorwithoutduplicates}]{\sphinxcrossref{CrossFactorWithoutDuplicates()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id3}}{\hyperref[\detokenize{reference/pebllist:designfullcounterbalance}]{\sphinxcrossref{DesignFullCounterbalance()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id4}}{\hyperref[\detokenize{reference/pebllist:first}]{\sphinxcrossref{First()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id5}}{\hyperref[\detokenize{reference/pebllist:ismember}]{\sphinxcrossref{IsMember()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id6}}{\hyperref[\detokenize{reference/pebllist:last}]{\sphinxcrossref{Last()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id7}}{\hyperref[\detokenize{reference/pebllist:length}]{\sphinxcrossref{Length()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id8}}{\hyperref[\detokenize{reference/pebllist:list}]{\sphinxcrossref{List()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id9}}{\hyperref[\detokenize{reference/pebllist:listtostring}]{\sphinxcrossref{ListToString()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id10}}{\hyperref[\detokenize{reference/pebllist:merge}]{\sphinxcrossref{Merge()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id11}}{\hyperref[\detokenize{reference/pebllist:modlist}]{\sphinxcrossref{ModList()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id12}}{\hyperref[\detokenize{reference/pebllist:nth}]{\sphinxcrossref{Nth()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id13}}{\hyperref[\detokenize{reference/pebllist:second}]{\sphinxcrossref{Second()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id14}}{\hyperref[\detokenize{reference/pebllist:third}]{\sphinxcrossref{Third()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id15}}{\hyperref[\detokenize{reference/pebllist:fourth}]{\sphinxcrossref{Fourth()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id16}}{\hyperref[\detokenize{reference/pebllist:fifth}]{\sphinxcrossref{Fifth()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id17}}{\hyperref[\detokenize{reference/pebllist:pushonend}]{\sphinxcrossref{PushOnEnd()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id18}}{\hyperref[\detokenize{reference/pebllist:repeat}]{\sphinxcrossref{Repeat()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id19}}{\hyperref[\detokenize{reference/pebllist:repeatlist}]{\sphinxcrossref{RepeatList()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id20}}{\hyperref[\detokenize{reference/pebllist:rotate}]{\sphinxcrossref{Rotate()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id21}}{\hyperref[\detokenize{reference/pebllist:sequence}]{\sphinxcrossref{Sequence()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id22}}{\hyperref[\detokenize{reference/pebllist:setelement}]{\sphinxcrossref{SetElement()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id23}}{\hyperref[\detokenize{reference/pebllist:shuffle}]{\sphinxcrossref{Shuffle()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id24}}{\hyperref[\detokenize{reference/pebllist:sort}]{\sphinxcrossref{Sort()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id25}}{\hyperref[\detokenize{reference/pebllist:sortby}]{\sphinxcrossref{SortBy()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id26}}{\hyperref[\detokenize{reference/pebllist:sublist}]{\sphinxcrossref{SubList()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/pebllist:id27}}{\hyperref[\detokenize{reference/pebllist:transpose}]{\sphinxcrossref{Transpose()}}}
...
\sphinxAtStartPar
Transposes or \sphinxcode{\sphinxupquote{rotates}} a list of lists.  Each   sublist must be of the same length.
...
\section{PEBLMath \sphinxhyphen{} Mathematical}
\label{\detokenize{reference/peblmath:peblmath-mathematical}}\label{\detokenize{reference/peblmath::doc}}
\sphinxAtStartPar
...
\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id1}}{\hyperref[\detokenize{reference/peblmath:abs}]{\sphinxcrossref{Abs()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id2}}{\hyperref[\detokenize{reference/peblmath:absfloor}]{\sphinxcrossref{AbsFloor()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id3}}{\hyperref[\detokenize{reference/peblmath:acos}]{\sphinxcrossref{ACos()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id4}}{\hyperref[\detokenize{reference/peblmath:asin}]{\sphinxcrossref{ASin()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id5}}{\hyperref[\detokenize{reference/peblmath:atan}]{\sphinxcrossref{ATan()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id6}}{\hyperref[\detokenize{reference/peblmath:ceiling}]{\sphinxcrossref{Ceiling()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id7}}{\hyperref[\detokenize{reference/peblmath:cos}]{\sphinxcrossref{Cos()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id8}}{\hyperref[\detokenize{reference/peblmath:degtorad}]{\sphinxcrossref{DegToRad()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id9}}{\hyperref[\detokenize{reference/peblmath:div}]{\sphinxcrossref{Div()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id10}}{\hyperref[\detokenize{reference/peblmath:exp}]{\sphinxcrossref{Exp()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id11}}{\hyperref[\detokenize{reference/peblmath:floor}]{\sphinxcrossref{Floor()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id12}}{\hyperref[\detokenize{reference/peblmath:ln}]{\sphinxcrossref{Ln()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id13}}{\hyperref[\detokenize{reference/peblmath:logn}]{\sphinxcrossref{LogN()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id14}}{\hyperref[\detokenize{reference/peblmath:mod}]{\sphinxcrossref{Mod()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id15}}{\hyperref[\detokenize{reference/peblmath:nthroot}]{\sphinxcrossref{NthRoot()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id16}}{\hyperref[\detokenize{reference/peblmath:pow}]{\sphinxcrossref{Pow()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id17}}{\hyperref[\detokenize{reference/peblmath:radtodeg}]{\sphinxcrossref{RadToDeg()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id18}}{\hyperref[\detokenize{reference/peblmath:random}]{\sphinxcrossref{Random()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id19}}{\hyperref[\detokenize{reference/peblmath:randombernoulli}]{\sphinxcrossref{RandomBernoulli()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id20}}{\hyperref[\detokenize{reference/peblmath:randombinomial}]{\sphinxcrossref{RandomBinomial()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id21}}{\hyperref[\detokenize{reference/peblmath:randomdiscrete}]{\sphinxcrossref{RandomDiscrete()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id22}}{\hyperref[\detokenize{reference/peblmath:randomexponential}]{\sphinxcrossref{RandomExponential()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id23}}{\hyperref[\detokenize{reference/peblmath:randomizetimer}]{\sphinxcrossref{RandomizeTimer()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id24}}{\hyperref[\detokenize{reference/peblmath:randomlogistic}]{\sphinxcrossref{RandomLogistic()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id25}}{\hyperref[\detokenize{reference/peblmath:randomlognormal}]{\sphinxcrossref{RandomLogNormal()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id26}}{\hyperref[\detokenize{reference/peblmath:randomnormal}]{\sphinxcrossref{RandomNormal()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id27}}{\hyperref[\detokenize{reference/peblmath:randomuniform}]{\sphinxcrossref{RandomUniform()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id28}}{\hyperref[\detokenize{reference/peblmath:round}]{\sphinxcrossref{Round()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id29}}{\hyperref[\detokenize{reference/peblmath:seedrng}]{\sphinxcrossref{SeedRNG()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id30}}{\hyperref[\detokenize{reference/peblmath:sign}]{\sphinxcrossref{Sign()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id31}}{\hyperref[\detokenize{reference/peblmath:sin}]{\sphinxcrossref{Sin()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id32}}{\hyperref[\detokenize{reference/peblmath:sqrt}]{\sphinxcrossref{Sqrt()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id33}}{\hyperref[\detokenize{reference/peblmath:tan}]{\sphinxcrossref{Tan()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id34}}{\hyperref[\detokenize{reference/peblmath:tofloat}]{\sphinxcrossref{ToFloat()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id35}}{\hyperref[\detokenize{reference/peblmath:tointeger}]{\sphinxcrossref{ToInteger()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id36}}{\hyperref[\detokenize{reference/peblmath:tonumber}]{\sphinxcrossref{ToNumber()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblmath:id37}}{\hyperref[\detokenize{reference/peblmath:tostring}]{\sphinxcrossref{ToString()}}}
...
\subsection{Abs()}
\label{\detokenize{reference/peblmath:abs}}
\sphinxAtStartPar
\sphinxstyleemphasis{Returns the absolute value of the number}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Abs}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Abs}\PYG{p}{(}\PYG{o}{\PYGZhy{}}\PYG{l+m+mi}{300}\PYG{p}{)}\PYG{+w}{    }\PYG{c+c1}{\PYGZsh{} ==300}
\PYG{n+nf}{Abs}\PYG{p}{(}\PYG{l+m+mi}{23}\PYG{p}{)}\PYG{+w}{      }\PYG{c+c1}{\PYGZsh{} ==23}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Round()}}, \sphinxcode{\sphinxupquote{Floor()}}, \sphinxcode{\sphinxupquote{AbsFloor()}}, \sphinxcode{\sphinxupquote{Sign()}}, \sphinxcode{\sphinxupquote{Ceiling()}}


\subsection{AbsFloor()}
\label{\detokenize{reference/peblmath:absfloor}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Rounds \sphinxcode{\sphinxupquote{\textless{}num\textgreater{}}} toward 0 to an integer.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{AbsFloor}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{AbsFloor}\PYG{p}{(}\PYG{o}{\PYGZhy{}}\PYG{l+m+mf}{332.7}\PYG{p}{)}\PYG{+w}{     }\PYG{c+c1}{\PYGZsh{} == \PYGZhy{}332}
\PYG{n+nf}{AbsFloor}\PYG{p}{(}\PYG{l+m+mf}{32.88}\PYG{p}{)}\PYG{+w}{      }\PYG{c+c1}{\PYGZsh{} == 32}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Round()}}, \sphinxcode{\sphinxupquote{Floor()}}, \sphinxcode{\sphinxupquote{Abs()}}, \sphinxcode{\sphinxupquote{Sign()}}, \sphinxcode{\sphinxupquote{Ceiling()}}


\subsection{ACos()}
\label{\detokenize{reference/peblmath:acos}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Inverse cosine of \sphinxcode{\sphinxupquote{\textless{}num\textgreater{}}}, in degrees.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{ACos}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Cos()}}, \sphinxcode{\sphinxupquote{Sin()}}, \sphinxcode{\sphinxupquote{Tan()}}, \sphinxcode{\sphinxupquote{ATan()}}, \sphinxcode{\sphinxupquote{ATan()}}


\subsection{ASin()}
\label{\detokenize{reference/peblmath:asin}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Inverse Sine of \sphinxcode{\sphinxupquote{\textless{}num\textgreater{}}}, in degrees.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{ASin}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Cos()}}, \sphinxcode{\sphinxupquote{Sin()}}, \sphinxcode{\sphinxupquote{Tan()}}, \sphinxcode{\sphinxupquote{ATan()}}, \sphinxcode{\sphinxupquote{ACos()}}, \sphinxcode{\sphinxupquote{ATan()}}


\subsection{ATan()}
\label{\detokenize{reference/peblmath:atan}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Inverse Tan of \sphinxcode{\sphinxupquote{\textless{}num\textgreater{}}}, in degrees.
...
\subsection{Ceiling()}
\label{\detokenize{reference/peblmath:ceiling}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Rounds \sphinxcode{\sphinxupquote{\textless{}num\textgreater{}}} up to the next integer.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Ceiling}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Ceiling}\PYG{p}{(}\PYG{l+m+mf}{33.23}\PYG{p}{)}\PYG{+w}{       }\PYG{c+c1}{\PYGZsh{} == 34}
\PYG{n+nf}{Ceiling}\PYG{p}{(}\PYG{o}{\PYGZhy{}}\PYG{l+m+mf}{33.02}\PYG{p}{)}\PYG{+w}{      }\PYG{c+c1}{\PYGZsh{} == \PYGZhy{}33}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Round()}}, \sphinxcode{\sphinxupquote{Floor()}}, \sphinxcode{\sphinxupquote{AbsFloor()}}, \sphinxcode{\sphinxupquote{Ceiling()}}


\subsection{Cos()}
\label{\detokenize{reference/peblmath:cos}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Cosine of \sphinxcode{\sphinxupquote{\textless{}deg\textgreater{}}} degrees.

\sphinxAtStartPar
\sphinxstylestrong{Example:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Cos}\PYG{p}{(}\PYG{l+m+mf}{33.5}\PYG{p}{)}
\PYG{+w}{  }\PYG{n+nf}{Cos}\PYG{p}{(}\PYG{o}{\PYGZhy{}}\PYG{l+m+mi}{32}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Sin()}}, \sphinxcode{\sphinxupquote{Tan()}}, \sphinxcode{\sphinxupquote{ATan()}}, \sphinxcode{\sphinxupquote{ACos()}}, \sphinxcode{\sphinxupquote{ATan()}}


\subsection{DegToRad()}
\label{\detokenize{reference/peblmath:degtorad}}
\sphinxAtStartPar
\sphinxstyleemphasis{Converts degrees to radians}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{DegToRad}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{deg}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{DegToRad}\PYG{p}{(}\PYG{l+m+mi}{180}\PYG{p}{)}\PYG{+w}{ }\PYG{c+c1}{\PYGZsh{} == 3.14159...}
\end{sphinxVerbatim}
...
\subsection{Div()}
\label{\detokenize{reference/peblmath:div}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Returns round(\sphinxcode{\sphinxupquote{\textless{}num\textgreater{}/\textless{}mod\textgreater{}}})

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Div}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{p}{,}\PYG{+w}{ }\PYG{o}{\PYGZlt{}}\PYG{n+nv}{mod}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Mod()}}


\subsection{Exp()}
\label{\detokenize{reference/peblmath:exp}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
\$e\$ to the power of \sphinxcode{\sphinxupquote{\textless{}pow\textgreater{}}}.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Exp}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{pow}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Exp}\PYG{p}{(}\PYG{l+m+mi}{0}\PYG{p}{)}\PYG{+w}{               }\PYG{c+c1}{\PYGZsh{} == 1}
\PYG{n+nf}{Exp}\PYG{p}{(}\PYG{l+m+mi}{3}\PYG{p}{)}\PYG{+w}{               }\PYG{c+c1}{\PYGZsh{} == 20.0855}
\end{sphinxVerbatim}
...
\subsection{Floor()}
\label{\detokenize{reference/peblmath:floor}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Rounds \sphinxcode{\sphinxupquote{\textless{}num\textgreater{}}} down to the next integer.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Floor}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Floor}\PYG{p}{(}\PYG{l+m+mf}{33.23}\PYG{p}{)}\PYG{+w}{ }\PYG{c+c1}{\PYGZsh{} == 33}
\PYG{n+nf}{Floor}\PYG{p}{(}\PYG{l+m+mf}{3.999}\PYG{p}{)}\PYG{+w}{         }\PYG{c+c1}{\PYGZsh{} ==3}
\PYG{n+nf}{Floor}\PYG{p}{(}\PYG{o}{\PYGZhy{}}\PYG{l+m+mf}{32.23}\PYG{p}{)}\PYG{+w}{        }\PYG{c+c1}{\PYGZsh{} == \PYGZhy{}33}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{AbsFloor()}}, \sphinxcode{\sphinxupquote{Round()}}, \sphinxcode{\sphinxupquote{Ceiling()}}


\subsection{Ln()}
\label{\detokenize{reference/peblmath:ln}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Natural log of \sphinxcode{\sphinxupquote{\textless{}num\textgreater{}}}.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Ln}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Log()}}, \sphinxcode{\sphinxupquote{Log2()}}, \sphinxcode{\sphinxupquote{LogN()}}, \sphinxcode{\sphinxupquote{Exp()}}


\subsection{LogN()}
\label{\detokenize{reference/peblmath:logn}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Log base \sphinxcode{\sphinxupquote{\textless{}base\textgreater{}}} of \sphinxcode{\sphinxupquote{\textless{}num\textgreater{}}}.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{LogN}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{p}{,}\PYG{+w}{ }\PYG{o}{\PYGZlt{}}\PYG{n+nv}{base}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{LogN}\PYG{p}{(}\PYG{l+m+mi}{100}\PYG{p}{,}\PYG{l+m+mi}{10}\PYG{p}{)}\PYG{+w}{ }\PYG{c+c1}{\PYGZsh{} == 2}
\PYG{n+nf}{LogN}\PYG{p}{(}\PYG{l+m+mi}{256}\PYG{p}{,}\PYG{l+m+mi}{2}\PYG{p}{)}\PYG{+w}{  }\PYG{c+c1}{\PYGZsh{} == 8}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Log()}}, \sphinxcode{\sphinxupquote{Log2()}}, \sphinxcode{\sphinxupquote{Ln()}}, \sphinxcode{\sphinxupquote{Exp()}}


\subsection{Mod()}
\label{\detokenize{reference/peblmath:mod}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Returns \sphinxcode{\sphinxupquote{\textless{}num\textgreater{}}}, \sphinxcode{\sphinxupquote{\textless{}mod\textgreater{}}}, or remainder of \sphinxcode{\sphinxupquote{\textless{}num\textgreater{}/\textless{}mod\textgreater{}}}

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Mod}\PYG{p}{(}\PYG{+w}{ }\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{+w}{ }\PYG{o}{\PYGZlt{}}\PYG{n+nv}{mod}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Mod}\PYG{p}{(}\PYG{l+m+mi}{34}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{10}\PYG{p}{)}\PYG{+w}{  }\PYG{c+c1}{\PYGZsh{} == 4}
\PYG{n+nf}{Mod}\PYG{p}{(}\PYG{l+m+mi}{3}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{10}\PYG{p}{)}\PYG{+w}{   }\PYG{c+c1}{\PYGZsh{} == 3}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Div()}}


\subsection{NthRoot()}
\label{\detokenize{reference/peblmath:nthroot}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
\sphinxcode{\sphinxupquote{\textless{}num\textgreater{}}} to the power of  1/\sphinxcode{\sphinxupquote{\textless{}root\textgreater{}}}.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{NthRoot}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{p}{,}\PYG{+w}{ }\PYG{o}{\PYGZlt{}}\PYG{n+nv}{root}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}


\subsection{Pow()}
\label{\detokenize{reference/peblmath:pow}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Raises or lowers \sphinxcode{\sphinxupquote{\textless{}num\textgreater{}}} to the power of \sphinxcode{\sphinxupquote{\textless{}pow\textgreater{}}}.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Pow}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{p}{,}\PYG{+w}{ }\PYG{o}{\PYGZlt{}}\PYG{n+nv}{pow}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Pow}\PYG{p}{(}\PYG{l+m+mi}{2}\PYG{p}{,}\PYG{l+m+mi}{6}\PYG{p}{)}\PYG{+w}{     }\PYG{c+c1}{\PYGZsh{} == 64}
\PYG{n+nf}{Pow}\PYG{p}{(}\PYG{l+m+mi}{5}\PYG{p}{,}\PYG{l+m+mi}{0}\PYG{p}{)}\PYG{+w}{     }\PYG{c+c1}{\PYGZsh{} == 1}
\end{sphinxVerbatim}


\subsection{RadToDeg()}
\label{\detokenize{reference/peblmath:radtodeg}}
\sphinxAtStartPar
\sphinxstyleemphasis{Converts radians to degrees}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Converts \sphinxcode{\sphinxupquote{\textless{}rad\textgreater{}}} radians to degrees.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{RadToDeg}\PYG{p}{(}\PYG{+w}{ }\PYG{o}{\PYGZlt{}}\PYG{n+nv}{rad}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{DegToRad()}}, \sphinxcode{\sphinxupquote{Tan()}}, \sphinxcode{\sphinxupquote{Cos()}}, \sphinxcode{\sphinxupquote{Sin()}}, \sphinxcode{\sphinxupquote{ATan()}}, \sphinxcode{\sphinxupquote{ASin()}}, \sphinxcode{\sphinxupquote{ACos()}}


\subsection{Random()}
\label{\detokenize{reference/peblmath:random}}
\sphinxAtStartPar
\sphinxstyleemphasis{Returns a random number between 0 and 1}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nv}{a}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{Random}\PYG{p}{(}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Random()}}, \sphinxcode{\sphinxupquote{RandomBernoulli()}}, \sphinxcode{\sphinxupquote{RandomBinomial()}}, \sphinxcode{\sphinxupquote{RandomDiscrete()}}, \sphinxcode{\sphinxupquote{RandomExponential()}}, \sphinxcode{\sphinxupquote{RandomLogistic()}}, \sphinxcode{\sphinxupquote{RandomLogNormal()}}, \sphinxcode{\sphinxupquote{RandomNormal()}}, \sphinxcode{\sphinxupquote{RandomUniform()}}, \sphinxcode{\sphinxupquote{RandomizeTimer()}}, \sphinxcode{\sphinxupquote{SeedRNG()}}


\subsection{RandomBernoulli()}
\label{\detokenize{reference/peblmath:randombernoulli}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Returns 0 with probability \sphinxcode{\sphinxupquote{(1\sphinxhyphen{}\textless{}p\textgreater{})}} and 1 with probability \sphinxcode{\sphinxupquote{\textless{}p\textgreater{}}}.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{RandomBernoulli}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{p}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{RandomBernoulli}\PYG{p}{(}\PYG{l+m+mf}{.3}\PYG{p}{)}
\end{sphinxVerbatim}
...
\subsection{RandomBinomial()}
\label{\detokenize{reference/peblmath:randombinomial}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Returns a random number according to the Binomial   distribution with probability \sphinxcode{\sphinxupquote{\textless{}p\textgreater{}}} and repetitions \sphinxcode{\sphinxupquote{\textless{}n\textgreater{}}},   i.e., the number of \sphinxcode{\sphinxupquote{\textless{}p\textgreater{}}} Bernoulli trials that succeed out of   \sphinxcode{\sphinxupquote{\textless{}n\textgreater{}}} attempts.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{RandomBinomial}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{p}\PYG{o}{\PYGZgt{}}\PYG{+w}{ }\PYG{o}{\PYGZlt{}}\PYG{n+nv}{n}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{RandomBinomial}\PYG{p}{(}\PYG{l+m+mf}{.3}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{10}\PYG{p}{)}\PYG{+w}{ }\PYG{c+c1}{\PYGZsh{} returns number from 0 to 10}
\end{sphinxVerbatim}
...
\subsection{RandomDiscrete()}
\label{\detokenize{reference/peblmath:randomdiscrete}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Returns a random integer between 1 and the argument             (inclusive), each with equal probability.  If the argument is           a floating\sphinxhyphen{}point value, it will be truncated down; if it is             less than 1, it will return 1, and possibly a warning message.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{RandomDiscrete}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{} Returns a random integer between 1 and 30:}
\PYG{n+nf}{RandomDiscrete}\PYG{p}{(}\PYG{l+m+mi}{30}\PYG{p}{)}
\end{sphinxVerbatim}
...
\subsection{RandomExponential()}
\label{\detokenize{reference/peblmath:randomexponential}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Returns a random number according to exponential                distribution with mean \sphinxcode{\sphinxupquote{\textless{}mean\textgreater{}}} (or decay 1/mean).

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{RandomExponential}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{mean}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{RandomExponential}\PYG{p}{(}\PYG{l+m+mi}{100}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Random()}}, \sphinxcode{\sphinxupquote{RandomBernoulli()}}, \sphinxcode{\sphinxupquote{RandomBinomial()}},            \sphinxcode{\sphinxupquote{RandomDiscrete()}}, \sphinxcode{\sphinxupquote{RandomLogistic()}}, \sphinxcode{\sphinxupquote{RandomLogNormal()}},                  \sphinxcode{\sphinxupquote{RandomNormal()}}, \sphinxcode{\sphinxupquote{RandomUniform()}}, \sphinxcode{\sphinxupquote{RandomizeTimer()}}, \sphinxcode{\sphinxupquote{SeedRNG()}}


\subsection{RandomizeTimer()}
\label{\detokenize{reference/peblmath:randomizetimer}}
\sphinxAtStartPar
\sphinxstyleemphasis{Seeds the RNG with the current time}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{RandomizeTimer}\PYG{p}{(}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{RandomizeTimer}\PYG{p}{(}\PYG{p}{)}
\PYG{n+nv}{x}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{Random}\PYG{p}{(}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Random()}}, \sphinxcode{\sphinxupquote{RandomBernoulli()}}, \sphinxcode{\sphinxupquote{RandomBinomial()}},            \sphinxcode{\sphinxupquote{RandomDiscrete()}}, \sphinxcode{\sphinxupquote{RandomExponential()}}, \sphinxcode{\sphinxupquote{RandomLogistic()}},                \sphinxcode{\sphinxupquote{RandomLogNormal()}}, \sphinxcode{\sphinxupquote{RandomNormal()}}, \sphinxcode{\sphinxupquote{RandomUniform()}}, \sphinxcode{\sphinxupquote{SeedRNG()}}


\subsection{RandomLogistic()}
\label{\detokenize{reference/peblmath:randomlogistic}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Returns a random number according to the logistic distribution                  with parameter \sphinxcode{\sphinxupquote{\textless{}p\textgreater{}}}: f(x) = exp(x)/(1+exp(x))

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{RandomLogistic}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{p}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Random()}}, \sphinxcode{\sphinxupquote{RandomBernoulli()}}, \sphinxcode{\sphinxupquote{RandomBinomial()}},            \sphinxcode{\sphinxupquote{RandomDiscrete()}}, \sphinxcode{\sphinxupquote{RandomExponential()}}, \sphinxcode{\sphinxupquote{RandomLogNormal()}},               \sphinxcode{\sphinxupquote{RandomNormal()}}, \sphinxcode{\sphinxupquote{RandomUniform()}}, \sphinxcode{\sphinxupquote{RandomizeTimer()}}, \sphinxcode{\sphinxupquote{SeedRNG()}}


\subsection{RandomLogNormal()}
\label{\detokenize{reference/peblmath:randomlognormal}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Returns a random number according to the log\sphinxhyphen{}normal             distribution with parameters \sphinxcode{\sphinxupquote{\textless{}median\textgreater{}}} and \sphinxcode{\sphinxupquote{\textless{}spread\textgreater{}}}. Generated           by calculating \$median \sphinxcode{\sphinxupquote{*}} exp(spread \sphinxcode{\sphinxupquote{*}} RandomNormal(0,1))\$.              \sphinxcode{\sphinxupquote{\textless{}spread\textgreater{}}} is a shape parameter, and only affects the variance                as a function of the median; similar to the coefficient of              variation.  A value near 0 is a sharp distribution (.1\sphinxhyphen{}.3),             larger values are more spread out; values greater than 2 make           little difference in the shape.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{RandomLogNormal}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{median}\PYG{o}{\PYGZgt{}}\PYG{p}{,}\PYG{+w}{ }\PYG{o}{\PYGZlt{}}\PYG{n+nv}{spread}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{RandomLogNormal}\PYG{p}{(}\PYG{l+m+mi}{5000}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mf}{.1}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Random()}}, \sphinxcode{\sphinxupquote{RandomBernoulli()}}, \sphinxcode{\sphinxupquote{RandomBinomial()}},            \sphinxcode{\sphinxupquote{RandomDiscrete()}}, \sphinxcode{\sphinxupquote{RandomExponential()}}, \sphinxcode{\sphinxupquote{RandomLogistic()}},                \sphinxcode{\sphinxupquote{RandomNormal()}}, \sphinxcode{\sphinxupquote{RandomUniform()}}, \sphinxcode{\sphinxupquote{RandomizeTimer()}}, \sphinxcode{\sphinxupquote{SeedRNG()}}


\subsection{RandomNormal()}
\label{\detokenize{reference/peblmath:randomnormal}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Returns a random number according to the standard               normal distribution with \sphinxcode{\sphinxupquote{\textless{}mean\textgreater{}}} and \sphinxcode{\sphinxupquote{\textless{}stdev\textgreater{}}}.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{RandomNormal}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{mean}\PYG{o}{\PYGZgt{}}\PYG{p}{,}\PYG{+w}{ }\PYG{o}{\PYGZlt{}}\PYG{n+nv}{stdev}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Random()}}, \sphinxcode{\sphinxupquote{RandomBernoulli()}}, \sphinxcode{\sphinxupquote{RandomBinomial()}},            \sphinxcode{\sphinxupquote{RandomDiscrete()}}, \sphinxcode{\sphinxupquote{RandomExponential()}}, \sphinxcode{\sphinxupquote{RandomLogistic()}},                \sphinxcode{\sphinxupquote{RandomLogNormal()}}, \sphinxcode{\sphinxupquote{RandomUniform()}}, \sphinxcode{\sphinxupquote{RandomizeTimer()}}, \sphinxcode{\sphinxupquote{SeedRNG()}}


\subsection{RandomUniform()}
\label{\detokenize{reference/peblmath:randomuniform}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Returns a random floating\sphinxhyphen{}point number between 0 and \sphinxcode{\sphinxupquote{\textless{}num\textgreater{}}}.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{RandomUniform}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Random()}}, \sphinxcode{\sphinxupquote{RandomBernoulli()}},   \sphinxcode{\sphinxupquote{RandomBinomial()}}, \sphinxcode{\sphinxupquote{RandomDiscrete()}},   \sphinxcode{\sphinxupquote{RandomExponential()}}, \sphinxcode{\sphinxupquote{RandomLogistic()}},   \sphinxcode{\sphinxupquote{RandomLogNormal()}}, \sphinxcode{\sphinxupquote{RandomNormal()}}, \sphinxcode{\sphinxupquote{RandomizeTimer()}},   \sphinxcode{\sphinxupquote{SeedRNG()}}


\subsection{Round()}
\label{\detokenize{reference/peblmath:round}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Rounds \sphinxcode{\sphinxupquote{\textless{}num\textgreater{}}} to nearest integer, or if optional \sphinxcode{\sphinxupquote{\textless{}precision\textgreater{}}} argument is included, to nearest \$10\textasciicircum{}\{\sphinxhyphen{}precision\}\$.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Round}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\PYG{n+nf}{Round}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{p}{,}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{precision}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Round}\PYG{p}{(}\PYG{l+m+mf}{33.23}\PYG{p}{)}\PYG{+w}{       }\PYG{c+c1}{\PYGZsh{} == 33}
\PYG{n+nf}{Round}\PYG{p}{(}\PYG{l+m+mf}{56.65}\PYG{p}{)}\PYG{+w}{       }\PYG{c+c1}{\PYGZsh{} == 57}
\PYG{n+nf}{Round}\PYG{p}{(}\PYG{l+m+mf}{33.12234}\PYG{p}{,}\PYG{l+m+mi}{2}\PYG{p}{)}\PYG{+w}{  }\PYG{c+c1}{\PYGZsh{} == 33.12}
\PYG{n+nf}{Round}\PYG{p}{(}\PYG{l+m+mf}{43134.23}\PYG{p}{,}\PYG{o}{\PYGZhy{}}\PYG{l+m+mi}{2}\PYG{p}{)}\PYG{+w}{ }\PYG{c+c1}{\PYGZsh{} == 43100}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Ceiling()}}, \sphinxcode{\sphinxupquote{Floor()}}, \sphinxcode{\sphinxupquote{AbsFloor()}}, \sphinxcode{\sphinxupquote{ToInt()}}


\subsection{SeedRNG()}
\label{\detokenize{reference/peblmath:seedrng}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Seeds the random number generator with \sphinxcode{\sphinxupquote{\textless{}num\textgreater{}}}   to reproduce a random sequence.  This function can be used cleverly   to create a multi\sphinxhyphen{}session experiment: Start by seeding the RNG with   a single number for each subject; generate the stimulus sequence,   then extract the appropriate stimuli for the current block. Remember   to \sphinxcode{\sphinxupquote{RandomizeTimer()}} afterward if necessary.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{SeedRNG}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}This makes sure you get the same random order}
\PYG{+w}{    }\PYG{c+c1}{\PYGZsh{}\PYGZsh{} across sessions for individual subjects.}
\PYG{+w}{     }\PYG{n+nf}{SeedRNG}\PYG{p}{(}\PYG{n+nv+vg}{gSubNum}\PYG{p}{)}
\PYG{+w}{     }\PYG{n+nv}{stimTmp}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{Sequence}\PYG{p}{(}\PYG{l+m+mi}{1}\PYG{o}{:}\PYG{l+m+mi}{100}\PYG{p}{,}\PYG{l+m+mi}{1}\PYG{p}{)}
\PYG{+w}{     }\PYG{n+nv}{stim}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{Shuffle}\PYG{p}{(}\PYG{n+nv}{stimTmp}\PYG{p}{)}
\PYG{+w}{     }\PYG{n+nf}{RandomizeTimer}\PYG{p}{(}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{RandomizeTimer()}}


\subsection{Sign()}
\label{\detokenize{reference/peblmath:sign}}
\sphinxAtStartPar
\sphinxstyleemphasis{Returns +1 or \sphinxhyphen{}1, depending on sign of argument}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Returns +1 or \sphinxhyphen{}1, depending on sign of argument.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Sign}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Sign}\PYG{p}{(}\PYG{o}{\PYGZhy{}}\PYG{l+m+mf}{332.1}\PYG{p}{)}\PYG{+w}{  }\PYG{c+c1}{\PYGZsh{} == \PYGZhy{}1}
\PYG{n+nf}{Sign}\PYG{p}{(}\PYG{l+m+mi}{65}\PYG{p}{)}\PYG{+w}{      }\PYG{c+c1}{\PYGZsh{} == 1}
\end{sphinxVerbatim}
...
\subsection{Sin()}
\label{\detokenize{reference/peblmath:sin}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Sine of \sphinxcode{\sphinxupquote{\textless{}deg\textgreater{}}} degrees.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Sin}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{deg}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Sin}\PYG{p}{(}\PYG{l+m+mi}{180}\PYG{p}{)}
\PYG{+w}{ }\PYG{n+nf}{Sin}\PYG{p}{(}\PYG{l+m+mi}{0}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Cos()}}, \sphinxcode{\sphinxupquote{Tan()}}, \sphinxcode{\sphinxupquote{ATan()}}, \sphinxcode{\sphinxupquote{ACos()}}, \sphinxcode{\sphinxupquote{ATan()}}


\subsection{Sqrt()}
\label{\detokenize{reference/peblmath:sqrt}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Square root of \sphinxcode{\sphinxupquote{\textless{}num\textgreater{}}}.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Sqrt}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{num}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Sqrt}\PYG{p}{(}\PYG{l+m+mi}{100}\PYG{p}{)}\PYG{+w}{  }\PYG{c+c1}{\PYGZsh{} == 10}
\end{sphinxVerbatim}


\subsection{Tan()}
\label{\detokenize{reference/peblmath:tan}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Tangent of \sphinxcode{\sphinxupquote{\textless{}deg\textgreater{}}} degrees.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Tan}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{deg}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Tan}\PYG{p}{(}\PYG{l+m+mi}{180}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Cos()}}, \sphinxcode{\sphinxupquote{Sin()}}, \sphinxcode{\sphinxupquote{ATan()}}, \sphinxcode{\sphinxupquote{ACos()}}, \sphinxcode{\sphinxupquote{ATan()}}


\subsection{ToFloat()}
\label{\detokenize{reference/peblmath:tofloat}}
\sphinxAtStartPar
\sphinxstyleemphasis{Converts number to internal floating\sphinxhyphen{}point representation}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Converts number to internal floating\sphinxhyphen{}point representation.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{ToFloat}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{number}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}


\subsection{ToInteger()}
\label{\detokenize{reference/peblmath:tointeger}}
\sphinxAtStartPar
\sphinxstyleemphasis{Rounds a number to an integer, and changes internal representation}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{ToInteger}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{number}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\PYG{n+nf}{ToInteger}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{floating}\PYG{o}{\PYGZhy{}}\PYG{n+nv}{point}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\PYG{n+nf}{ToInteger}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{string}\PYG{o}{\PYGZhy{}}\PYG{n+nv}{as}\PYG{o}{\PYGZhy{}}\PYG{n+nv}{number}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{ToInteger}\PYG{p}{(}\PYG{l+m+mf}{33.332}\PYG{p}{)}\PYG{+w}{  }\PYG{c+c1}{\PYGZsh{} == 33}
\PYG{n+nf}{ToInteger}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}3213\PYGZdq{}}\PYG{p}{)}\PYG{+w}{  }\PYG{c+c1}{\PYGZsh{} == 3213}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Round()}}, \sphinxcode{\sphinxupquote{Ceiling()}}, \sphinxcode{\sphinxupquote{AbsCeiling()}}, \sphinxcode{\sphinxupquote{Floor()}}, \sphinxcode{\sphinxupquote{AbsFloor()}}


\subsection{ToNumber()}
\label{\detokenize{reference/peblmath:tonumber}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{ToNumber}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{string}\PYG{p}{)}
\PYG{n+nf}{ToNumber}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{number}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nv}{a}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{ToNumber}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}3232\PYGZdq{}}\PYG{p}{)}
\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nv}{a}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{l+m+mi}{1}\PYG{p}{)}\PYG{+w}{         }\PYG{c+c1}{\PYGZsh{} produces the output 3233.}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{ToString()}}, \sphinxcode{\sphinxupquote{ToFloat()}}, \sphinxcode{\sphinxupquote{Round()}}


\subsection{ToString()}
\label{\detokenize{reference/peblmath:tostring}}
\sphinxAtStartPar
\sphinxstyleemphasis{Converts a numerical value to a string representation}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{ToString}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{number}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\PYG{n+nf}{ToString}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{string}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nv}{a}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{ToString}\PYG{p}{(}\PYG{l+m+mf}{333.232}\PYG{p}{)}
\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nv}{a}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}111\PYGZdq{}}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{} produces the output \PYGZsq{}333.232111\PYGZsq{}.}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{ToString()}}, \sphinxcode{\sphinxupquote{+}}.
...
\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblobjects:id54}}{\hyperref[\detokenize{reference/peblobjects:setpixel}]{\sphinxcrossref{SetPixel()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblobjects:id55}}{\hyperref[\detokenize{reference/peblobjects:setpoint}]{\sphinxcrossref{SetPoint()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblobjects:id56}}{\hyperref[\detokenize{reference/peblobjects:settext}]{\sphinxcrossref{SetText()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblobjects:id57}}{\hyperref[\detokenize{reference/peblobjects:show}]{\sphinxcrossref{Show()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblobjects:id58}}{\hyperref[\detokenize{reference/peblobjects:square}]{\sphinxcrossref{Square()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblobjects:id59}}{\hyperref[\detokenize{reference/peblobjects:startplayback}]{\sphinxcrossref{StartPlayback()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblobjects:id60}}{\hyperref[\detokenize{reference/peblobjects:stop}]{\sphinxcrossref{Stop()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblobjects:id61}}{\hyperref[\detokenize{reference/peblobjects:thickline}]{\sphinxcrossref{ThickLine()}}}
...
\index{SetPixel@\spxentry{SetPixel}}\ignorespaces 

\subsection{SetPixel()}
\label{\detokenize{reference/peblobjects:setpixel}}\label{\detokenize{reference/peblobjects:index-53}}
\sphinxAtStartPar
\sphinxstyleemphasis{Sets the color of a pixel at specified coordinates}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Sets the pixel at x,y to a particular color. SetPixel is primarily useful for images and canvases\textendash{}labels and textboxes get re\sphinxhyphen{}rendered upon draw so any use of SetPixel will get overwritten when it gets drawn. It won’t work on windows or shapes. This function can also be called using SetPoint().

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{SetPixel}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{widget}\PYG{o}{\PYGZgt{}}\PYG{p}{,}\PYG{+w}{ }\PYG{o}{\PYGZlt{}}\PYG{n+nv}{x}\PYG{o}{\PYGZgt{}}\PYG{p}{,}\PYG{+w}{ }\PYG{o}{\PYGZlt{}}\PYG{n+nv}{y}\PYG{o}{\PYGZgt{}}\PYG{p}{,}\PYG{+w}{ }\PYG{o}{\PYGZlt{}}\PYG{n+nv}{color}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nv}{back}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeCanvas}\PYG{p}{(}\PYG{l+m+mi}{50}\PYG{p}{,}\PYG{l+m+mi}{50}\PYG{p}{)}
\PYG{n+nf}{AddObject}\PYG{p}{(}\PYG{n+nv}{back}\PYG{p}{,}\PYG{n+nv+vg}{gWin}\PYG{p}{)}
\PYG{n+nv}{col}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeColor}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}green\PYGZdq{}}\PYG{p}{)}
\PYG{n+nv}{xy}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{p}{[}\PYG{p}{[}\PYG{l+m+mi}{10}\PYG{p}{,}\PYG{l+m+mi}{10}\PYG{p}{]}\PYG{p}{,}\PYG{p}{[}\PYG{l+m+mi}{10}\PYG{p}{,}\PYG{l+m+mi}{11}\PYG{p}{]}\PYG{p}{,}\PYG{p}{[}\PYG{l+m+mi}{10}\PYG{p}{,}\PYG{l+m+mi}{12}\PYG{p}{]}\PYG{p}{,}\PYG{p}{[}\PYG{l+m+mi}{10}\PYG{p}{,}\PYG{l+m+mi}{13}\PYG{p}{]}\PYG{p}{]}
\PYG{k}{loop}\PYG{p}{(}\PYG{n+nv}{i}\PYG{p}{,}\PYG{n+nv}{xy}\PYG{p}{)}
\PYG{p}{\PYGZob{}}
\PYG{+w}{   }\PYG{n+nf}{SetPixel}\PYG{p}{(}\PYG{n+nv}{back}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nf}{First}\PYG{p}{(}\PYG{n+nv}{i}\PYG{p}{)}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nf}{Second}\PYG{p}{(}\PYG{n+nv}{i}\PYG{p}{)}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{col}\PYG{p}{)}
\PYG{p}{\PYGZcb{}}
\PYG{n+nf}{Draw}\PYG{p}{(}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{SetPoint()}}, \sphinxcode{\sphinxupquote{MakeGabor()}}, \sphinxcode{\sphinxupquote{MakeCanvas()}}, \sphinxcode{\sphinxupquote{GetPixelColor()}}

\index{SetPoint@\spxentry{SetPoint}}\ignorespaces 

\subsection{SetPoint()}
\label{\detokenize{reference/peblobjects:setpoint}}\label{\detokenize{reference/peblobjects:index-54}}
\sphinxAtStartPar
\sphinxstyleemphasis{Sets the color of a point at specified coordinates (alias for SetPixel)}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Sets the pixel at x,y to a particular color. SetPoint is an alias for SetPixel() and functions identically. It is primarily useful for images and canvases\textendash{}labels and textboxes get re\sphinxhyphen{}rendered upon draw so any use of SetPoint will get overwritten when it gets drawn. It won’t work on windows or shapes.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{SetPoint}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{widget}\PYG{o}{\PYGZgt{}}\PYG{p}{,}\PYG{+w}{ }\PYG{o}{\PYGZlt{}}\PYG{n+nv}{x}\PYG{o}{\PYGZgt{}}\PYG{p}{,}\PYG{+w}{ }\PYG{o}{\PYGZlt{}}\PYG{n+nv}{y}\PYG{o}{\PYGZgt{}}\PYG{p}{,}\PYG{+w}{ }\PYG{o}{\PYGZlt{}}\PYG{n+nv}{color}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\PYG{k}{loop}\PYG{p}{(}\PYG{n+nv}{i}\PYG{p}{,}\PYG{n+nv}{xy}\PYG{p}{)}
\PYG{p}{\PYGZob{}}
\PYG{+w}{   }\PYG{n+nf}{SetPoint}\PYG{p}{(}\PYG{n+nv}{back}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nf}{First}\PYG{p}{(}\PYG{n+nv}{i}\PYG{p}{)}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nf}{Second}\PYG{p}{(}\PYG{n+nv}{i}\PYG{p}{)}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{col}\PYG{p}{)}
\PYG{p}{\PYGZcb{}}
\PYG{n+nf}{Draw}\PYG{p}{(}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{SetPixel()}}, \sphinxcode{\sphinxupquote{MakeGabor()}}, \sphinxcode{\sphinxupquote{MakeCanvas()}}, \sphinxcode{\sphinxupquote{GetPixelColor()}}

\index{SetText@\spxentry{SetText}}\ignorespaces 

\subsection{SetText()}
\label{\detokenize{reference/peblobjects:settext}}\label{\detokenize{reference/peblobjects:index-55}}
\sphinxAtStartPar
...
\subsection{Show()}
\label{\detokenize{reference/peblobjects:show}}\label{\detokenize{reference/peblobjects:index-56}}
\sphinxAtStartPar
...
\subsection{Square()}
\label{\detokenize{reference/peblobjects:square}}\label{\detokenize{reference/peblobjects:index-57}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblobjects:startplayback}}\label{\detokenize{reference/peblobjects:index-58}}
\sphinxAtStartPar
...
\subsection{Stop()}
\label{\detokenize{reference/peblobjects:stop}}\label{\detokenize{reference/peblobjects:index-59}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblobjects:thickline}}\label{\detokenize{reference/peblobjects:index-60}}
\sphinxAtStartPar
...
\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id22}}{\hyperref[\detokenize{reference/peblstream:md5file}]{\sphinxcrossref{MD5File()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id23}}{\hyperref[\detokenize{reference/peblstream:md5sum}]{\sphinxcrossref{MD5Sum()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id24}}{\hyperref[\detokenize{reference/peblstream:getdata}]{\sphinxcrossref{GetData()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id25}}{\hyperref[\detokenize{reference/peblstream:getmyipaddress}]{\sphinxcrossref{GetMyIPAddress()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id26}}{\hyperref[\detokenize{reference/peblstream:getpportstate}]{\sphinxcrossref{GetPPortState()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id27}}{\hyperref[\detokenize{reference/peblstream:opencomport}]{\sphinxcrossref{OpenCOMPort()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id28}}{\hyperref[\detokenize{reference/peblstream:opennetworklistener}]{\sphinxcrossref{OpenNetworkListener()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id29}}{\hyperref[\detokenize{reference/peblstream:openpport}]{\sphinxcrossref{OpenPPort()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id30}}{\hyperref[\detokenize{reference/peblstream:parsejson}]{\sphinxcrossref{ParseJSON()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id31}}{\hyperref[\detokenize{reference/peblstream:print}]{\sphinxcrossref{Print()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id32}}{\hyperref[\detokenize{reference/peblstream:senddata}]{\sphinxcrossref{SendData()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id33}}{\hyperref[\detokenize{reference/peblstream:setnetworkport}]{\sphinxcrossref{SetNetworkPort()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id34}}{\hyperref[\detokenize{reference/peblstream:setpportmode}]{\sphinxcrossref{SetPPortMode()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id35}}{\hyperref[\detokenize{reference/peblstream:setpportstate}]{\sphinxcrossref{SetPPortState()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id36}}{\hyperref[\detokenize{reference/peblstream:waitfornetworkconnection}]{\sphinxcrossref{WaitForNetworkConnection()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id37}}{\hyperref[\detokenize{reference/peblstream:writepng}]{\sphinxcrossref{WritePNG()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id38}}{\hyperref[\detokenize{reference/peblstream:comportgetbyte}]{\sphinxcrossref{COMPortGetByte()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id39}}{\hyperref[\detokenize{reference/peblstream:comportsendbyte}]{\sphinxcrossref{COMPortSendByte()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id40}}{\hyperref[\detokenize{reference/peblstream:gethttpfile}]{\sphinxcrossref{GetHTTPFile()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id41}}{\hyperref[\detokenize{reference/peblstream:gethttptext}]{\sphinxcrossref{GetHTTPText()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id42}}{\hyperref[\detokenize{reference/peblstream:posthttp}]{\sphinxcrossref{PostHTTP()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id43}}{\hyperref[\detokenize{reference/peblstream:posthttpfile}]{\sphinxcrossref{PostHTTPFile()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstream:id44}}{\hyperref[\detokenize{reference/peblstream:uploadline}]{\sphinxcrossref{UploadLine()}}}
...
\index{MD5File@\spxentry{MD5File}}\ignorespaces 

\subsection{MD5File()}
\label{\detokenize{reference/peblstream:md5file}}\label{\detokenize{reference/peblstream:index-21}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{MD5File}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{filename}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nv}{text}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{FileReadText}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}test.pbl\PYGZdq{}}\PYG{p}{)}
\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nf}{MD5Sum}\PYG{p}{(}\PYG{n+nv}{text}\PYG{p}{)}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}returns: 3396a651bd3c96f9799ce02eecb48801; see similar example next}

\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nf}{MD5File}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}test.pbl\PYGZdq{}}\PYG{p}{)}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{} returns 3396a651bd3c96f9799ce02eecb48801}

\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nf}{MD5File}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}doesnotexist.txt\PYGZdq{}}\PYG{p}{)}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}returns 0}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{MD5Sum()}}, \sphinxcode{\sphinxupquote{FileReadText()}}

\index{MD5Sum@\spxentry{MD5Sum}}\ignorespaces 

\subsection{MD5Sum()}
\label{\detokenize{reference/peblstream:md5sum}}\label{\detokenize{reference/peblstream:index-22}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{MD5Sum}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{text}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nf}{MD5Sum}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}\PYGZdq{}}\PYG{p}{)}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}Return: d41d8cd98f00b204e9800998ecf8427e}

\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nf}{MD5Sum}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}bananana\PYGZdq{}}\PYG{p}{)}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}returns bb8e9af523e4aeffa88f1807fb2af9ce}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{MD5File()}}, \sphinxcode{\sphinxupquote{FileReadText()}}

\index{GetData@\spxentry{GetData}}\ignorespaces 

\subsection{GetData()}
\label{\detokenize{reference/peblstream:getdata}}\label{\detokenize{reference/peblstream:index-23}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstream:getmyipaddress}}\label{\detokenize{reference/peblstream:index-24}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstream:getpportstate}}\label{\detokenize{reference/peblstream:index-25}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstream:opencomport}}\label{\detokenize{reference/peblstream:index-26}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstream:opennetworklistener}}\label{\detokenize{reference/peblstream:index-27}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstream:openpport}}\label{\detokenize{reference/peblstream:index-28}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstream:parsejson}}\label{\detokenize{reference/peblstream:index-29}}
\sphinxAtStartPar
...
\subsection{Print()}
\label{\detokenize{reference/peblstream:print}}\label{\detokenize{reference/peblstream:index-30}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{SendData()}
\label{\detokenize{reference/peblstream:senddata}}\label{\detokenize{reference/peblstream:index-31}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstream:setnetworkport}}\label{\detokenize{reference/peblstream:index-32}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstream:setpportmode}}\label{\detokenize{reference/peblstream:index-33}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstream:setpportstate}}\label{\detokenize{reference/peblstream:index-34}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstream:waitfornetworkconnection}}\label{\detokenize{reference/peblstream:index-35}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{WritePNG()}
\label{\detokenize{reference/peblstream:writepng}}\label{\detokenize{reference/peblstream:index-36}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstream:comportgetbyte}}\label{\detokenize{reference/peblstream:index-37}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstream:comportsendbyte}}\label{\detokenize{reference/peblstream:index-38}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstream:gethttpfile}}\label{\detokenize{reference/peblstream:index-39}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstream:gethttptext}}\label{\detokenize{reference/peblstream:index-40}}
\sphinxAtStartPar
...
\subsection{PostHTTP()}
\label{\detokenize{reference/peblstream:posthttp}}\label{\detokenize{reference/peblstream:index-41}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstream:posthttpfile}}\label{\detokenize{reference/peblstream:index-42}}
\sphinxAtStartPar
...
\index{UploadLine@\spxentry{UploadLine}}\ignorespaces 

\subsection{UploadLine()}
\label{\detokenize{reference/peblstream:uploadline}}\label{\detokenize{reference/peblstream:index-43}}
\sphinxAtStartPar
\sphinxstyleemphasis{Appends a single CSV line to a file on the PEBL data server.}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Uploads a single line of CSV data to a remote PEBL Simple Data Server or PEBLHub, appending it to a named file.  Unlike \sphinxcode{\sphinxupquote{UploadFile()}}, which sends a complete file after the experiment, \sphinxcode{\sphinxupquote{UploadLine()}} sends each data row immediately as it is collected.  This is useful for long experiments where data loss from a crash or network interruption would be costly.

\sphinxAtStartPar
\sphinxcode{\sphinxupquote{UploadLine()}} is a no\sphinxhyphen{}op when \sphinxcode{\sphinxupquote{gUpload}} is false (i.e., when the experiment was not started with \sphinxcode{\sphinxupquote{\sphinxhyphen{}\sphinxhyphen{}upload}}).

\sphinxAtStartPar
The settings file is resolved in this order: the explicit \sphinxcode{\sphinxupquote{settingsfile}} argument, then \sphinxcode{\sphinxupquote{gUploadFile}}, then a file named \sphinxcode{\sphinxupquote{upload.json}} in the working directory.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{UploadLine}\PYG{p}{(}\PYG{n+nv}{subcode}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{filename}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{header}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{line}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{pooled}\PYG{o}{:}\PYG{l+m+mi}{1}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{settingsfile}\PYG{o}{:}\PYG{l+s+s2}{\PYGZdq{}\PYGZdq{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{subcode}} — participant identifier

\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{filename}} — target filename on the server (e.g., \sphinxcode{\sphinxupquote{"stroop\sphinxhyphen{}pooled.csv"}})

\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{header}} — CSV header line (written only when the server file is new)

\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{line}} — CSV data line to append

\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{pooled}} — 1 (default) to write to a shared task\sphinxhyphen{}level file; 0 for a per\sphinxhyphen{}participant file

\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{settingsfile}} — optional path to an \sphinxcode{\sphinxupquote{upload.json}} configuration file
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nv}{header}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}subnum,trial,condition,response,rt\PYGZdq{}}
\PYG{n+nv}{line}\PYG{+w}{   }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nv+vg}{gSubNum}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{},\PYGZdq{}}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{n+nv}{trial}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{},\PYGZdq{}}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{n+nv}{cond}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{},\PYGZdq{}}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{n+nv}{resp}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{},\PYGZdq{}}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{n+nv}{rt}
\PYG{n+nf}{UploadLine}\PYG{p}{(}\PYG{n+nv+vg}{gSubNum}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}mytest\PYGZhy{}pooled.csv\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{header}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{line}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{UploadFile()}}, \sphinxcode{\sphinxupquote{FilePrint()}}, \sphinxcode{\sphinxupquote{GetNewDataFile()}}
...
\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstring:id3}}{\hyperref[\detokenize{reference/peblstring:format}]{\sphinxcrossref{Format()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstring:id4}}{\hyperref[\detokenize{reference/peblstring:lowercase}]{\sphinxcrossref{Lowercase()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstring:id5}}{\hyperref[\detokenize{reference/peblstring:splitstring}]{\sphinxcrossref{SplitString()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstring:id6}}{\hyperref[\detokenize{reference/peblstring:stringlength}]{\sphinxcrossref{StringLength()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstring:id7}}{\hyperref[\detokenize{reference/peblstring:substring}]{\sphinxcrossref{SubString()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstring:id8}}{\hyperref[\detokenize{reference/peblstring:toascii}]{\sphinxcrossref{ToASCII()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstring:id9}}{\hyperref[\detokenize{reference/peblstring:uppercase}]{\sphinxcrossref{Uppercase()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstring:id10}}{\hyperref[\detokenize{reference/peblstring:detecttextscript}]{\sphinxcrossref{DetectTextScript()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstring:id11}}{\hyperref[\detokenize{reference/peblstring:isrtl}]{\sphinxcrossref{IsRTL()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstring:id12}}{\hyperref[\detokenize{reference/peblstring:getfontfortext}]{\sphinxcrossref{GetFontForText()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstring:id13}}{\hyperref[\detokenize{reference/peblstring:getsystemlocale}]{\sphinxcrossref{GetSystemLocale()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstring:id14}}{\hyperref[\detokenize{reference/peblstring:issystemlocalertl}]{\sphinxcrossref{IsSystemLocaleRTL()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/peblstring:id15}}{\hyperref[\detokenize{reference/peblstring:regexmatch}]{\sphinxcrossref{RegexMatch()}}}
...
\index{Format@\spxentry{Format}}\ignorespaces 

\subsection{Format()}
\label{\detokenize{reference/peblstring:format}}\label{\detokenize{reference/peblstring:index-2}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Formats the printing of values to ensure proper spacing. It will either truncate or pad \sphinxcode{\sphinxupquote{\textless{}value\textgreater{}}} with spaces so that it ends up exactly \sphinxcode{\sphinxupquote{\textless{}length\textgreater{}}} characters long. Character padding is at the end.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Format}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{value}\PYG{o}{\PYGZgt{}}\PYG{p}{,}\PYG{+w}{ }\PYG{o}{\PYGZlt{}}\PYG{n+nv}{length}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nv}{x}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+m+mf}{33.23425225}
\PYG{n+nv}{y}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+m+mf}{23.3}
\PYG{n+nf}{Print}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}[\PYGZdq{}}\PYG{o}{+}\PYG{n+nf}{Format}\PYG{p}{(}\PYG{n+nv}{x}\PYG{p}{,}\PYG{l+m+mi}{5}\PYG{p}{)}\PYG{o}{+}\PYG{l+s+s2}{\PYGZdq{}]\PYGZdq{}}\PYG{p}{)}
\PYG{n+nf}{Print}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}[\PYGZdq{}}\PYG{o}{+}\PYG{n+nf}{Format}\PYG{p}{(}\PYG{n+nv}{y}\PYG{p}{,}\PYG{l+m+mi}{5}\PYG{p}{)}\PYG{o}{+}\PYG{l+s+s2}{\PYGZdq{}]\PYGZdq{}}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{} Output:}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{} [33.23 ]}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{} [23.3  ]}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{CR()}}, \sphinxcode{\sphinxupquote{Tab()}}

\index{Lowercase@\spxentry{Lowercase}}\ignorespaces 

\subsection{Lowercase()}
\label{\detokenize{reference/peblstring:lowercase}}\label{\detokenize{reference/peblstring:index-3}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstring:splitstring}}\label{\detokenize{reference/peblstring:index-4}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/peblstring:stringlength}}\label{\detokenize{reference/peblstring:index-5}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstring:substring}}\label{\detokenize{reference/peblstring:index-6}}
\sphinxAtStartPar
...
\subsection{ToASCII()}
\label{\detokenize{reference/peblstring:toascii}}\label{\detokenize{reference/peblstring:index-7}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstring:uppercase}}\label{\detokenize{reference/peblstring:index-8}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstring:detecttextscript}}\label{\detokenize{reference/peblstring:index-9}}
\sphinxAtStartPar
...
\subsection{IsRTL()}
\label{\detokenize{reference/peblstring:isrtl}}\label{\detokenize{reference/peblstring:index-10}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstring:getfontfortext}}\label{\detokenize{reference/peblstring:index-11}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstring:getsystemlocale}}\label{\detokenize{reference/peblstring:index-12}}
\sphinxAtStartPar
...
\label{\detokenize{reference/peblstring:issystemlocalertl}}\label{\detokenize{reference/peblstring:index-13}}
\sphinxAtStartPar
...
\index{RegexMatch@\spxentry{RegexMatch}}\ignorespaces 

\subsection{RegexMatch()}
\label{\detokenize{reference/peblstring:regexmatch}}\label{\detokenize{reference/peblstring:index-14}}
\sphinxAtStartPar
\sphinxstyleemphasis{Searches a string with a regular expression.}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Searches \sphinxcode{\sphinxupquote{string}} for the first occurrence of \sphinxcode{\sphinxupquote{pattern}} (a POSIX\sphinxhyphen{}style regular expression) and returns the 1\sphinxhyphen{}based index of the match start, or 0 if no match is found.  The return convention is consistent with \sphinxcode{\sphinxupquote{FindInString()}}.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{RegexMatch}\PYG{p}{(}\PYG{n+nv}{string}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{pattern}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nv}{pos}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{RegexMatch}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}hello world\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}wor\PYGZdq{}}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{} pos == 7}

\PYG{n+nv}{pos}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{RegexMatch}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}abc123\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}[0\PYGZhy{}9]+\PYGZdq{}}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{} pos == 4}

\PYG{n+nv}{pos}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{RegexMatch}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}no digits here\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}[0\PYGZhy{}9]\PYGZdq{}}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{} pos == 0  (no match)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{FindInString()}}, \sphinxcode{\sphinxupquote{SubString()}}, \sphinxcode{\sphinxupquote{SplitString()}}
...
\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id1}}{\hyperref[\detokenize{reference/design:choosen}]{\sphinxcrossref{ChooseN()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id2}}{\hyperref[\detokenize{reference/design:designbalancedsampling}]{\sphinxcrossref{DesignBalancedSampling()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id3}}{\hyperref[\detokenize{reference/design:designgrecolatinsquare}]{\sphinxcrossref{DesignGrecoLatinSquare()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id4}}{\hyperref[\detokenize{reference/design:designlatinsquare}]{\sphinxcrossref{DesignLatinSquare()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id5}}{\hyperref[\detokenize{reference/design:extractlistitems}]{\sphinxcrossref{ExtractListItems()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id6}}{\hyperref[\detokenize{reference/design:flatten}]{\sphinxcrossref{Flatten()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id7}}{\hyperref[\detokenize{reference/design:flattenn}]{\sphinxcrossref{FlattenN()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id8}}{\hyperref[\detokenize{reference/design:foldlist}]{\sphinxcrossref{FoldList()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id9}}{\hyperref[\detokenize{reference/design:insert}]{\sphinxcrossref{Insert()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id10}}{\hyperref[\detokenize{reference/design:latinsquare}]{\sphinxcrossref{LatinSquare()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id11}}{\hyperref[\detokenize{reference/design:levels}]{\sphinxcrossref{Levels()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id12}}{\hyperref[\detokenize{reference/design:listby}]{\sphinxcrossref{ListBy()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id13}}{\hyperref[\detokenize{reference/design:removesubset}]{\sphinxcrossref{RemoveSubset()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id14}}{\hyperref[\detokenize{reference/design:replace}]{\sphinxcrossref{Replace()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id15}}{\hyperref[\detokenize{reference/design:rest}]{\sphinxcrossref{Rest()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id16}}{\hyperref[\detokenize{reference/design:sample}]{\sphinxcrossref{Sample()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id17}}{\hyperref[\detokenize{reference/design:samplen}]{\sphinxcrossref{SampleN()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id18}}{\hyperref[\detokenize{reference/design:samplenwithreplacement}]{\sphinxcrossref{SampleNWithReplacement()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id19}}{\hyperref[\detokenize{reference/design:shufflerepeat}]{\sphinxcrossref{ShuffleRepeat()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id20}}{\hyperref[\detokenize{reference/design:shufflewithoutadjacents}]{\sphinxcrossref{ShuffleWithoutAdjacents()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id21}}{\hyperref[\detokenize{reference/design:subset}]{\sphinxcrossref{Subset()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id22}}{\hyperref[\detokenize{reference/design:functions-pending-documentation}]{\sphinxcrossref{Functions Pending Documentation}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id23}}{\hyperref[\detokenize{reference/design:findtoken}]{\sphinxcrossref{FindToken()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id24}}{\hyperref[\detokenize{reference/design:reverse}]{\sphinxcrossref{Reverse()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id25}}{\hyperref[\detokenize{reference/design:union}]{\sphinxcrossref{Union()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id26}}{\hyperref[\detokenize{reference/design:intersect}]{\sphinxcrossref{Intersect()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/design:id27}}{\hyperref[\detokenize{reference/design:setdifference}]{\sphinxcrossref{SetDifference()}}}
...
\sphinxAtStartPar
This will return a list of lists formed by rotating   through each element of the \sphinxcode{\sphinxupquote{\textless{}treatment\_list\textgreater{}}} s, making a list   containing all element of the list, according to a greco\sphinxhyphen{}latin   square.  All lists must be of the same length.
...
\index{Union@\spxentry{Union}}\ignorespaces 

\subsection{Union()}
\label{\detokenize{reference/design:union}}\label{\detokenize{reference/design:index-23}}
\sphinxAtStartPar
\sphinxstyleemphasis{Computes the union of two lists.}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Returns a list containing all elements that appear in either \sphinxcode{\sphinxupquote{list1}} or \sphinxcode{\sphinxupquote{list2}}.  Each element appears only once; duplicates are removed.  The result is not guaranteed to be in any particular order.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{Union}\PYG{p}{(}\PYG{n+nv}{list1}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{list2}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nv}{a}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{p}{[}\PYG{l+m+mi}{1}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{2}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{3}\PYG{p}{]}
\PYG{n+nv}{b}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{p}{[}\PYG{l+m+mi}{2}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{3}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{4}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{5}\PYG{p}{]}
\PYG{n+nv}{result}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{Union}\PYG{p}{(}\PYG{n+nv}{a}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{b}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{} result == [1, 2, 3, 4, 5]}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Intersect()}}, \sphinxcode{\sphinxupquote{SetDifference()}}, \sphinxcode{\sphinxupquote{IsMember()}}

\index{Intersect@\spxentry{Intersect}}\ignorespaces 

\subsection{Intersect()}
\label{\detokenize{reference/design:intersect}}\label{\detokenize{reference/design:index-24}}
\sphinxAtStartPar
\sphinxstyleemphasis{Computes the intersection of two lists.}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Returns a list containing only the elements that appear in both \sphinxcode{\sphinxupquote{list1}} and \sphinxcode{\sphinxupquote{list2}}.  Each matched element appears once in the output.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{Intersect}\PYG{p}{(}\PYG{n+nv}{list1}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{list2}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nv}{a}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{p}{[}\PYG{l+m+mi}{1}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{2}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{3}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{4}\PYG{p}{]}
\PYG{n+nv}{b}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{p}{[}\PYG{l+m+mi}{2}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{4}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{6}\PYG{p}{]}
\PYG{n+nv}{result}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{Intersect}\PYG{p}{(}\PYG{n+nv}{a}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{b}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{} result == [2, 4]}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Union()}}, \sphinxcode{\sphinxupquote{SetDifference()}}, \sphinxcode{\sphinxupquote{IsMember()}}

\index{SetDifference@\spxentry{SetDifference}}\ignorespaces 

\subsection{SetDifference()}
\label{\detokenize{reference/design:setdifference}}\label{\detokenize{reference/design:index-25}}
\sphinxAtStartPar
\sphinxstyleemphasis{Returns elements in one list that are absent from another.}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Returns the elements of \sphinxcode{\sphinxupquote{list2}} that do not appear in \sphinxcode{\sphinxupquote{list1}}.  This is the asymmetric set difference: elements unique to \sphinxcode{\sphinxupquote{list1}} are not included.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{SetDifference}\PYG{p}{(}\PYG{n+nv}{list1}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{list2}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nv}{baseline}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{p}{[}\PYG{l+m+mi}{1}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{2}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{3}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{4}\PYG{p}{]}
\PYG{n+nv}{current}\PYG{+w}{  }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{p}{[}\PYG{l+m+mi}{2}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{4}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{5}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{6}\PYG{p}{]}
\PYG{n+nv}{added}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{SetDifference}\PYG{p}{(}\PYG{n+nv}{baseline}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{current}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{} added == [5, 6]}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Union()}}, \sphinxcode{\sphinxupquote{Intersect()}}, \sphinxcode{\sphinxupquote{IsMember()}}
...
\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id1}}{\hyperref[\detokenize{reference/graphics:blocke}]{\sphinxcrossref{BlockE()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id2}}{\hyperref[\detokenize{reference/graphics:convexhull}]{\sphinxcrossref{ConvexHull()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id3}}{\hyperref[\detokenize{reference/graphics:getangle}]{\sphinxcrossref{GetAngle()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id4}}{\hyperref[\detokenize{reference/graphics:getangle3}]{\sphinxcrossref{GetAngle3()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id5}}{\hyperref[\detokenize{reference/graphics:kaniszapolygon}]{\sphinxcrossref{KaniszaPolygon()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id6}}{\hyperref[\detokenize{reference/graphics:kaniszasquare}]{\sphinxcrossref{KaniszaSquare()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id7}}{\hyperref[\detokenize{reference/graphics:layoutgrid}]{\sphinxcrossref{LayoutGrid()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id8}}{\hyperref[\detokenize{reference/graphics:makeattneave}]{\sphinxcrossref{MakeAttneave()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id9}}{\hyperref[\detokenize{reference/graphics:makegabor}]{\sphinxcrossref{MakeGabor()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id10}}{\hyperref[\detokenize{reference/graphics:makegraph}]{\sphinxcrossref{MakeGraph()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id11}}{\hyperref[\detokenize{reference/graphics:makengonpoints}]{\sphinxcrossref{MakeNGonPoints()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id12}}{\hyperref[\detokenize{reference/graphics:makestarpoints}]{\sphinxcrossref{MakeStarPoints()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id13}}{\hyperref[\detokenize{reference/graphics:nonoverlaplayout}]{\sphinxcrossref{NonOverlapLayout()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id14}}{\hyperref[\detokenize{reference/graphics:plus}]{\sphinxcrossref{Plus()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id15}}{\hyperref[\detokenize{reference/graphics:reflectpoints}]{\sphinxcrossref{ReflectPoints()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id16}}{\hyperref[\detokenize{reference/graphics:resetcanvas}]{\sphinxcrossref{ResetCanvas()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id17}}{\hyperref[\detokenize{reference/graphics:rgbtohsv}]{\sphinxcrossref{RGBtoHSV()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id18}}{\hyperref[\detokenize{reference/graphics:rotatepoints}]{\sphinxcrossref{RotatePoints()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id19}}{\hyperref[\detokenize{reference/graphics:segmentsintersect}]{\sphinxcrossref{SegmentsIntersect()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id20}}{\hyperref[\detokenize{reference/graphics:toright}]{\sphinxcrossref{ToRight()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id21}}{\hyperref[\detokenize{reference/graphics:zoompoints}]{\sphinxcrossref{ZoomPoints()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id22}}{\hyperref[\detokenize{reference/graphics:functions-pending-documentation}]{\sphinxcrossref{Functions Pending Documentation}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id23}}{\hyperref[\detokenize{reference/graphics:getmindist}]{\sphinxcrossref{GetMinDist()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id24}}{\hyperref[\detokenize{reference/graphics:hideobject}]{\sphinxcrossref{HideObject()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id25}}{\hyperref[\detokenize{reference/graphics:landoltring}]{\sphinxcrossref{LandoltRing()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id26}}{\hyperref[\detokenize{reference/graphics:maketable}]{\sphinxcrossref{MakeTable()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id27}}{\hyperref[\detokenize{reference/graphics:showobject}]{\sphinxcrossref{ShowObject()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id28}}{\hyperref[\detokenize{reference/graphics:functions-under-investigation}]{\sphinxcrossref{Functions Under Investigation}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/graphics:id29}}{\hyperref[\detokenize{reference/graphics:thickline2}]{\sphinxcrossref{ThickLine2()}}}
...
\sphinxAtStartPar
Creates generic polygon, defined only by with \sphinxcode{\sphinxupquote{pac\sphinxhyphen{}man}} circles at specified vertices.
...
\sphinxAtStartPar
Creates generic Kanesza Square, one defined only by with \sphinxcode{\sphinxupquote{pac\sphinxhyphen{}man}} circles at its vertices:
...
\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/math:id20}}{\hyperref[\detokenize{reference/math:gcd}]{\sphinxcrossref{GCD()}}}
...
\index{GCD@\spxentry{GCD}}\ignorespaces 

\subsection{GCD()}
\label{\detokenize{reference/math:gcd}}\label{\detokenize{reference/math:index-19}}
\sphinxAtStartPar
\sphinxstyleemphasis{Computes the greatest common divisor of two integers}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{GCD}\PYG{p}{(}\PYG{n+nv}{a}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{b}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nf}{GCD}\PYG{p}{(}\PYG{l+m+mi}{48}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{18}\PYG{p}{)}\PYG{p}{)}\PYG{+w}{   }\PYG{c+c1}{\PYGZsh{} Returns 6}
\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nf}{GCD}\PYG{p}{(}\PYG{l+m+mi}{100}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{25}\PYG{p}{)}\PYG{p}{)}\PYG{+w}{  }\PYG{c+c1}{\PYGZsh{} Returns 25}
\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nf}{GCD}\PYG{p}{(}\PYG{l+m+mi}{17}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{19}\PYG{p}{)}\PYG{p}{)}\PYG{+w}{   }\PYG{c+c1}{\PYGZsh{} Returns 1 (coprime)}
\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nf}{GCD}\PYG{p}{(}\PYG{o}{\PYGZhy{}}\PYG{l+m+mi}{24}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{36}\PYG{p}{)}\PYG{p}{)}\PYG{+w}{  }\PYG{c+c1}{\PYGZsh{} Returns 12}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Mod()}}, \sphinxcode{\sphinxupquote{Abs()}}
...
\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id2}}{\hyperref[\detokenize{reference/ui:clickcheckbox}]{\sphinxcrossref{ClickCheckbox()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id3}}{\hyperref[\detokenize{reference/ui:clickonmenu}]{\sphinxcrossref{ClickOnMenu()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id4}}{\hyperref[\detokenize{reference/ui:clickonscrollbox}]{\sphinxcrossref{ClickOnScrollbox()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id5}}{\hyperref[\detokenize{reference/ui:copytextbox}]{\sphinxcrossref{CopyTextBox()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id6}}{\hyperref[\detokenize{reference/ui:drawpulldown}]{\sphinxcrossref{DrawPulldown()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id7}}{\hyperref[\detokenize{reference/ui:drawscrollbox}]{\sphinxcrossref{DrawScrollbox()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id8}}{\hyperref[\detokenize{reference/ui:drawscrollingtextbox}]{\sphinxcrossref{DrawScrollingTextBox()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id9}}{\hyperref[\detokenize{reference/ui:editscrollboxvalue}]{\sphinxcrossref{EditScrollboxValue()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id10}}{\hyperref[\detokenize{reference/ui:filterlist}]{\sphinxcrossref{FilterList()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id11}}{\hyperref[\detokenize{reference/ui:getfulllinebreaks}]{\sphinxcrossref{GetFullLineBreaks()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id12}}{\hyperref[\detokenize{reference/ui:insidemenu}]{\sphinxcrossref{InsideMenu()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id13}}{\hyperref[\detokenize{reference/ui:insidetb}]{\sphinxcrossref{InsideTB()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id14}}{\hyperref[\detokenize{reference/ui:makebutton}]{\sphinxcrossref{MakeButton()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id15}}{\hyperref[\detokenize{reference/ui:makecheckbox}]{\sphinxcrossref{MakeCheckbox()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id16}}{\hyperref[\detokenize{reference/ui:makemenu}]{\sphinxcrossref{MakeMenu()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id17}}{\hyperref[\detokenize{reference/ui:makemenuitem}]{\sphinxcrossref{MakeMenuItem()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id18}}{\hyperref[\detokenize{reference/ui:makepulldown}]{\sphinxcrossref{MakePulldown()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id19}}{\hyperref[\detokenize{reference/ui:makescrollbox}]{\sphinxcrossref{MakeScrollBox()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id20}}{\hyperref[\detokenize{reference/ui:makescrollingtextbox}]{\sphinxcrossref{MakeScrollingTextBox()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id21}}{\hyperref[\detokenize{reference/ui:maketextlist}]{\sphinxcrossref{MakeTextList()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id22}}{\hyperref[\detokenize{reference/ui:opensubmenus}]{\sphinxcrossref{OpenSubMenus()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id23}}{\hyperref[\detokenize{reference/ui:pastetextbox}]{\sphinxcrossref{PasteTextBox()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id24}}{\hyperref[\detokenize{reference/ui:popupentrybox}]{\sphinxcrossref{PopUpEntryBox()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id25}}{\hyperref[\detokenize{reference/ui:popupmessagebox}]{\sphinxcrossref{PopupMessageBox()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id26}}{\hyperref[\detokenize{reference/ui:pushbutton}]{\sphinxcrossref{PushButton()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id27}}{\hyperref[\detokenize{reference/ui:pulldown}]{\sphinxcrossref{Pulldown()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id28}}{\hyperref[\detokenize{reference/ui:setscrollingtext}]{\sphinxcrossref{SetScrollingText()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id29}}{\hyperref[\detokenize{reference/ui:setcheckbox}]{\sphinxcrossref{SetCheckbox()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id30}}{\hyperref[\detokenize{reference/ui:settextboxcursorfromclick}]{\sphinxcrossref{SetTextBoxCursorFromClick()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id31}}{\hyperref[\detokenize{reference/ui:sortdir}]{\sphinxcrossref{SortDir()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id32}}{\hyperref[\detokenize{reference/ui:updatepulldown}]{\sphinxcrossref{UpdatePulldown()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id33}}{\hyperref[\detokenize{reference/ui:updatescrollbox}]{\sphinxcrossref{UpdateScrollbox()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id34}}{\hyperref[\detokenize{reference/ui:vecplus}]{\sphinxcrossref{VecPlus()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/ui:id35}}{\hyperref[\detokenize{reference/ui:adaptivetextbox}]{\sphinxcrossref{AdaptiveTextBox()}}}
...
\index{ClickCheckbox@\spxentry{ClickCheckbox}}\ignorespaces 

\subsection{ClickCheckbox()}
\label{\detokenize{reference/ui:clickcheckbox}}\label{\detokenize{reference/ui:index-1}}
\sphinxAtStartPar
\sphinxstyleemphasis{Toggles checkbox state}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{ClickCheckBox}\PYG{p}{(}\PYG{n+nv}{obj}\PYG{p}{,}\PYG{+w}{ }\PYG{p}{[}\PYG{n+nv}{x}\PYG{p}{,}\PYG{n+nv}{y}\PYG{p}{]}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}The following creates a button, waits for you to click on it, and animates a button press}

\PYG{n+nv}{ok}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeCheckbox}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}OK?\PYGZdq{}}\PYG{p}{,}\PYG{l+m+mi}{400}\PYG{p}{,}\PYG{l+m+mi}{250}\PYG{p}{,}\PYG{n+nv+vg}{gWin}\PYG{p}{,}\PYG{l+m+mi}{150}\PYG{p}{)}
\PYG{n+nv}{resp}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{WaitForClickOnTarget}\PYG{p}{(}\PYG{p}{[}\PYG{n+nv}{ok}\PYG{p}{]}\PYG{p}{,}\PYG{p}{[}\PYG{l+m+mi}{1}\PYG{p}{]}\PYG{p}{)}
\PYG{n+nf}{ClickCheckBox}\PYG{p}{(}\PYG{n+nv}{ok}\PYG{p}{,}\PYG{n+nv+vg}{gClick}\PYG{p}{)}
\PYG{n+nf}{Draw}\PYG{p}{(}\PYG{p}{)}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{}You can handle a bunch of objects together using an idiom like this:}

\PYG{n+nv}{ok}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeCheckbox}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}OK?\PYGZdq{}}\PYG{p}{,}\PYG{l+m+mi}{400}\PYG{p}{,}\PYG{l+m+mi}{250}\PYG{p}{,}\PYG{n+nv+vg}{gWin}\PYG{p}{,}\PYG{l+m+mi}{150}\PYG{p}{)}
\PYG{n+nv}{ok2}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeCheckbox}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}Otherwise?\PYGZdq{}}\PYG{p}{,}\PYG{l+m+mi}{400}\PYG{p}{,}\PYG{l+m+mi}{280}\PYG{p}{,}\PYG{n+nv+vg}{gWin}\PYG{p}{,}\PYG{l+m+mi}{150}\PYG{p}{)}
\PYG{n+nv}{checks}\PYG{+w}{  }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{p}{[}\PYG{n+nv}{ok}\PYG{p}{,}\PYG{n+nv}{ok2}\PYG{p}{]}
\PYG{n+nv}{resp}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{WaitForClickOnTarget}\PYG{p}{(}\PYG{n+nv}{checks}\PYG{p}{,}\PYG{p}{[}\PYG{l+m+mi}{1}\PYG{p}{,}\PYG{l+m+mi}{2}\PYG{p}{]}\PYG{p}{)}
\PYG{n+nv}{check}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{Nth}\PYG{p}{(}\PYG{n+nv}{checks}\PYG{p}{,}\PYG{n+nv}{resp}\PYG{p}{)}
\PYG{n+nf}{CallFunction}\PYG{p}{(}\PYG{n+nv}{check.clickon}\PYG{p}{,}\PYG{p}{[}\PYG{n+nv}{check}\PYG{p}{,}\PYG{n+nv+vg}{gClick}\PYG{p}{]}\PYG{p}{)}
\PYG{n+nf}{Draw}\PYG{p}{(}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{MakeCheckBox()}}, \sphinxcode{\sphinxupquote{SetCheckBox()}}

\index{ClickOnMenu@\spxentry{ClickOnMenu}}\ignorespaces 

\subsection{ClickOnMenu()}
\label{\detokenize{reference/ui:clickonmenu}}\label{\detokenize{reference/ui:index-2}}
\sphinxAtStartPar
...
\label{\detokenize{reference/ui:clickonscrollbox}}\label{\detokenize{reference/ui:index-3}}
\sphinxAtStartPar
...
\index{CopyTextBox@\spxentry{CopyTextBox}}\ignorespaces 

\subsection{CopyTextBox()}
\label{\detokenize{reference/ui:copytextbox}}\label{\detokenize{reference/ui:index-4}}
\sphinxAtStartPar
\sphinxstyleemphasis{Copies textbox content to clipboard}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Copies the text content of a textbox to the system clipboard. This function is typically bound to a right\sphinxhyphen{}click menu on textboxes, allowing users to copy text for pasting into other applications or textboxes within PEBL.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{CopyTextBox}\PYG{p}{(}\PYG{n+nv}{menu}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{xy}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{box}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Create a textbox with some text}
\PYG{n+nv}{font}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeFont}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}DejaVuSans.ttf\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{0}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{14}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nf}{MakeColor}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}black\PYGZdq{}}\PYG{p}{)}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nf}{MakeColor}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}white\PYGZdq{}}\PYG{p}{)}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{1}\PYG{p}{)}
\PYG{n+nv}{textbox}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeTextBox}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}Sample text to copy\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{font}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{300}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{100}\PYG{p}{)}
\PYG{n+nf}{AddObject}\PYG{p}{(}\PYG{n+nv}{textbox}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv+vg}{gWin}\PYG{p}{)}
\PYG{n+nf}{Move}\PYG{p}{(}\PYG{n+nv}{textbox}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{320}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{240}\PYG{p}{)}
\PYG{n+nf}{Draw}\PYG{p}{(}\PYG{p}{)}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Copy the textbox content (typically called from a right\PYGZhy{}click menu)}
\PYG{n+nf}{CopyTextBox}\PYG{p}{(}\PYG{l+m+mi}{0}\PYG{p}{,}\PYG{+w}{ }\PYG{p}{[}\PYG{l+m+mi}{0}\PYG{p}{,}\PYG{l+m+mi}{0}\PYG{p}{]}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{textbox}\PYG{p}{)}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Now clipboard contains \PYGZdq{}Sample text to copy\PYGZdq{}}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{PasteTextBox()}}, \sphinxcode{\sphinxupquote{CopyToClipboard()}}, \sphinxcode{\sphinxupquote{CopyFromClipboard()}}, \sphinxcode{\sphinxupquote{MakeTextBox()}}

\index{DrawPulldown@\spxentry{DrawPulldown}}\ignorespaces 

\subsection{DrawPulldown()}
\label{\detokenize{reference/ui:drawpulldown}}\label{\detokenize{reference/ui:index-5}}
\sphinxAtStartPar
...
\index{DrawScrollbox@\spxentry{DrawScrollbox}}\ignorespaces 

\subsection{DrawScrollbox()}
\label{\detokenize{reference/ui:drawscrollbox}}\label{\detokenize{reference/ui:index-6}}
\sphinxAtStartPar
\sphinxstyleemphasis{Redraws a scrollbox}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{DrawScrollBox}\PYG{p}{(}\PYG{n+nv}{sb}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nv}{sb}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeScrollBox}\PYG{p}{(}\PYG{n+nf}{Sequence}\PYG{p}{(}\PYG{l+m+mi}{1}\PYG{p}{,}\PYG{l+m+mi}{50}\PYG{p}{,}\PYG{l+m+mi}{1}\PYG{p}{)}\PYG{p}{,}\PYG{l+s+s2}{\PYGZdq{}The numbers\PYGZdq{}}\PYG{p}{,}\PYG{l+m+mi}{40}\PYG{p}{,}\PYG{l+m+mi}{40}\PYG{p}{,}\PYG{n+nv+vg}{gWin}\PYG{p}{,}\PYG{l+m+mi}{12}\PYG{p}{,}\PYG{l+m+mi}{150}\PYG{p}{,}\PYG{l+m+mi}{500}\PYG{p}{,}\PYG{l+m+mi}{3}\PYG{p}{)}
\PYG{n+nf}{Draw}\PYG{p}{(}\PYG{p}{)}

\PYG{n+nv}{resp}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{WaitForClickOntarget}\PYG{p}{(}\PYG{p}{[}\PYG{n+nv}{sb}\PYG{p}{]}\PYG{p}{,}\PYG{p}{[}\PYG{l+m+mi}{1}\PYG{p}{]}\PYG{p}{)}
\PYG{n+nf}{CallFunction}\PYG{p}{(}\PYG{n+nv}{sb.clickon}\PYG{p}{,}\PYG{p}{[}\PYG{n+nv}{sb}\PYG{p}{,}\PYG{n+nv+vg}{gClick}\PYG{p}{]}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Alternately: ClickOnScrollbox(sb,gClick)}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{}change the selected items}
\PYG{n+nv}{sb.list}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{Sequence}\PYG{p}{(}\PYG{n+nv}{sb.selected}\PYG{p}{,}\PYG{n+nv}{sb.selected}\PYG{o}{+}\PYG{l+m+mi}{50}\PYG{p}{,}\PYG{l+m+mi}{1}\PYG{p}{)}
\PYG{n+nf}{UpdateScrollbox}\PYG{p}{(}\PYG{n+nv}{sb}\PYG{p}{)}
\PYG{n+nf}{DrawScrollbox}\PYG{p}{(}\PYG{n+nv}{sb}\PYG{p}{)}
\PYG{n+nf}{Draw}\PYG{p}{(}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{MakeScrollingTextBox()}}, \sphinxcode{\sphinxupquote{MakeScrollBox()}}, \sphinxcode{\sphinxupquote{UpdateScrollBox()}}, \sphinxcode{\sphinxupquote{ClickOnScrollBox()}}

\index{DrawScrollingTextBox@\spxentry{DrawScrollingTextBox}}\ignorespaces 

\subsection{DrawScrollingTextBox()}
\label{\detokenize{reference/ui:drawscrollingtextbox}}\label{\detokenize{reference/ui:index-7}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/ui:editscrollboxvalue}}\label{\detokenize{reference/ui:index-8}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\index{FilterList@\spxentry{FilterList}}\ignorespaces 

\subsection{FilterList()}
\label{\detokenize{reference/ui:filterlist}}\label{\detokenize{reference/ui:index-9}}
\sphinxAtStartPar
\sphinxstyleemphasis{Filters a list by substring match}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Filters a list to include only items that contain a specified substring. This function searches each item in the list for the filter string and returns a new list containing only matching items. The search is case\sphinxhyphen{}sensitive and matches any occurrence of the filter string within each list item.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{FilterList}\PYG{p}{(}\PYG{n+nv}{list}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{filter}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Filter a list of files to show only .txt files}
\PYG{n+nv}{files}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{p}{[}\PYG{l+s+s2}{\PYGZdq{}data1.txt\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}data2.csv\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}notes.txt\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}readme.md\PYGZdq{}}\PYG{p}{]}
\PYG{n+nv}{txtFiles}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{FilterList}\PYG{p}{(}\PYG{n+nv}{files}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}.txt\PYGZdq{}}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Returns: [\PYGZdq{}data1.txt\PYGZdq{}, \PYGZdq{}notes.txt\PYGZdq{}]}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Filter a list of names}
\PYG{n+nv}{names}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{p}{[}\PYG{l+s+s2}{\PYGZdq{}Alice\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}Bob\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}Charlie\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}David\PYGZdq{}}\PYG{p}{]}
\PYG{n+nv}{aNames}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{FilterList}\PYG{p}{(}\PYG{n+nv}{names}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}a\PYGZdq{}}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Returns: [\PYGZdq{}Charlie\PYGZdq{}, \PYGZdq{}David\PYGZdq{}] (contains lowercase \PYGZsq{}a\PYGZsq{})}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{FindInString()}}, \sphinxcode{\sphinxupquote{SubString()}}, \sphinxcode{\sphinxupquote{Filter()}}

\index{GetFullLineBreaks@\spxentry{GetFullLineBreaks}}\ignorespaces 

\subsection{GetFullLineBreaks()}
\label{\detokenize{reference/ui:getfulllinebreaks}}\label{\detokenize{reference/ui:index-10}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/ui:insidemenu}}\label{\detokenize{reference/ui:index-11}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{InsideTB()}
\label{\detokenize{reference/ui:insidetb}}\label{\detokenize{reference/ui:index-12}}
\sphinxAtStartPar
...
\label{\detokenize{reference/ui:makebutton}}\label{\detokenize{reference/ui:index-13}}
\sphinxAtStartPar
...
\index{MakeCheckbox@\spxentry{MakeCheckbox}}\ignorespaces 

\subsection{MakeCheckbox()}
\label{\detokenize{reference/ui:makecheckbox}}\label{\detokenize{reference/ui:index-14}}
\sphinxAtStartPar
\sphinxstyleemphasis{Creates a checkbox widget}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{MakeCheckBox}\PYG{p}{(}\PYG{n+nv}{label}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{x}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{y}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{window}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{width}\PYG{p}{)}
\end{sphinxVerbatim}
...
\PYG{n+nv}{ok}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeCheckbox}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}OK?\PYGZdq{}}\PYG{p}{,}\PYG{l+m+mi}{400}\PYG{p}{,}\PYG{l+m+mi}{250}\PYG{p}{,}\PYG{n+nv+vg}{gWin}\PYG{p}{,}\PYG{l+m+mi}{150}\PYG{p}{)}
\PYG{n+nv}{resp}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{WaitForClickOnTarget}\PYG{p}{(}\PYG{p}{[}\PYG{n+nv}{ok}\PYG{p}{]}\PYG{p}{,}\PYG{p}{[}\PYG{l+m+mi}{1}\PYG{p}{]}\PYG{p}{)}
\PYG{n+nf}{CallFunction}\PYG{p}{(}\PYG{n+nv}{ok.clickon}\PYG{p}{,}\PYG{p}{[}\PYG{n+nv}{ok}\PYG{p}{,}\PYG{n+nv+vg}{gClick}\PYG{p}{]}\PYG{p}{)}
\PYG{n+nf}{Draw}\PYG{p}{(}\PYG{p}{)}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Alternately:}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{ClickCheckBox()}}, \sphinxcode{\sphinxupquote{SetCheckBox()}}

\index{MakeMenu@\spxentry{MakeMenu}}\ignorespaces 

\subsection{MakeMenu()}
\label{\detokenize{reference/ui:makemenu}}\label{\detokenize{reference/ui:index-15}}
\sphinxAtStartPar
...
\label{\detokenize{reference/ui:makemenuitem}}\label{\detokenize{reference/ui:index-16}}
\sphinxAtStartPar
...
\index{MakePulldown@\spxentry{MakePulldown}}\ignorespaces 

\subsection{MakePulldown()}
\label{\detokenize{reference/ui:makepulldown}}\label{\detokenize{reference/ui:index-17}}
\sphinxAtStartPar
\sphinxstyleemphasis{Creates a pulldown selection list}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{MakePulldown}\PYG{p}{(}\PYG{n+nv}{options}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{x}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{y}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{window}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{fontsize}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{width}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{selected}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
Pulldown objects have a property .maxitems, that specify how many elements are displayed. If the list contains more than obj.maxitems, the pulldown will enable scrolling. A pulldown’s click\sphinxhyphen{}on handler is by default bound to the ‘Pulldown’ function. When Pulldown(obj,mousexy) is called, it will pop open the pulldown, allow for a new option to be selected, and return. It returns the index of the selected object, but the selected index can also be accessed using obj.selected.

\sphinxAtStartPar
\sphinxstylestrong{Example:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}See ui.pbl in the demo directory for examples of the use of pulldowns.}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}A basic example is:}

\PYG{n+nv}{options}\PYG{+w}{  }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakePulldownButton}\PYG{p}{(}\PYG{p}{[}\PYG{l+s+s2}{\PYGZdq{}A\PYGZdq{}}\PYG{p}{,}\PYG{l+s+s2}{\PYGZdq{}B\PYGZdq{}}\PYG{p}{,}\PYG{l+s+s2}{\PYGZdq{}C\PYGZdq{}}\PYG{p}{]}\PYG{p}{,}\PYG{l+m+mi}{400}\PYG{p}{,}\PYG{l+m+mi}{250}\PYG{p}{,}\PYG{n+nv+vg}{gWin}\PYG{p}{,}\PYG{l+m+mi}{14}\PYG{p}{,}\PYG{l+m+mi}{100}\PYG{p}{,}\PYG{l+m+mi}{1}\PYG{p}{)}
\PYG{n+nv}{resp}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{WaitForClickOntarget}\PYG{p}{(}\PYG{p}{[}\PYG{n+nv}{options}\PYG{p}{]}\PYG{p}{,}\PYG{p}{[}\PYG{l+m+mi}{1}\PYG{p}{]}\PYG{p}{)}
\PYG{n+nf}{CallFunction}\PYG{p}{(}\PYG{n+nv}{options.clickon}\PYG{p}{,}\PYG{p}{[}\PYG{n+nv}{options}\PYG{p}{,}\PYG{n+nv+vg}{gClick}\PYG{p}{]}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{PullDown()}}, \sphinxcode{\sphinxupquote{DrawPulldown()}}, \sphinxcode{\sphinxupquote{UpdatePulldown()}}

\index{MakeScrollBox@\spxentry{MakeScrollBox}}\ignorespaces 

\subsection{MakeScrollBox()}
\label{\detokenize{reference/ui:makescrollbox}}\label{\detokenize{reference/ui:index-18}}
\sphinxAtStartPar
...
\label{\detokenize{reference/ui:makescrollingtextbox}}\label{\detokenize{reference/ui:index-19}}
\sphinxAtStartPar
...
\label{\detokenize{reference/ui:maketextlist}}\label{\detokenize{reference/ui:index-20}}
\sphinxAtStartPar
...
\label{\detokenize{reference/ui:opensubmenus}}\label{\detokenize{reference/ui:index-21}}
\sphinxAtStartPar
...
\index{PasteTextBox@\spxentry{PasteTextBox}}\ignorespaces 

\subsection{PasteTextBox()}
\label{\detokenize{reference/ui:pastetextbox}}\label{\detokenize{reference/ui:index-22}}
\sphinxAtStartPar
\sphinxstyleemphasis{Pastes clipboard content into textbox}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Pastes text from the system clipboard into a textbox, replacing its current content. This function is typically bound to a right\sphinxhyphen{}click menu on textboxes, allowing users to paste text from other applications or from previously copied PEBL textbox content. The textbox is automatically redrawn after pasting.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{PasteTextBox}\PYG{p}{(}\PYG{n+nv}{menu}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{xy}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{box}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}First, copy some text to clipboard}
\PYG{n+nf}{CopyToClipboard}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}Hello from PEBL!\PYGZdq{}}\PYG{p}{)}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Create a textbox}
\PYG{n+nv}{font}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeFont}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}DejaVuSans.ttf\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{0}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{14}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nf}{MakeColor}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}black\PYGZdq{}}\PYG{p}{)}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nf}{MakeColor}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}white\PYGZdq{}}\PYG{p}{)}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{1}\PYG{p}{)}
\PYG{n+nv}{textbox}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeTextBox}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{font}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{300}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{100}\PYG{p}{)}
\PYG{n+nf}{AddObject}\PYG{p}{(}\PYG{n+nv}{textbox}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv+vg}{gWin}\PYG{p}{)}
\PYG{n+nf}{Move}\PYG{p}{(}\PYG{n+nv}{textbox}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{320}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{240}\PYG{p}{)}
\PYG{n+nf}{Draw}\PYG{p}{(}\PYG{p}{)}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Paste clipboard content into the textbox (typically called from a right\PYGZhy{}click menu)}
\PYG{n+nf}{PasteTextBox}\PYG{p}{(}\PYG{l+m+mi}{0}\PYG{p}{,}\PYG{+w}{ }\PYG{p}{[}\PYG{l+m+mi}{0}\PYG{p}{,}\PYG{l+m+mi}{0}\PYG{p}{]}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{textbox}\PYG{p}{)}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Now textbox.text contains \PYGZdq{}Hello from PEBL!\PYGZdq{}}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{CopyTextBox()}}, \sphinxcode{\sphinxupquote{CopyToClipboard()}}, \sphinxcode{\sphinxupquote{CopyFromClipboard()}}, \sphinxcode{\sphinxupquote{MakeTextBox()}}

\index{PopUpEntryBox@\spxentry{PopUpEntryBox}}\ignorespaces 

\subsection{PopUpEntryBox()}
\label{\detokenize{reference/ui:popupentrybox}}\label{\detokenize{reference/ui:index-23}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\index{PopupMessageBox@\spxentry{PopupMessageBox}}\ignorespaces 

\subsection{PopupMessageBox()}
\label{\detokenize{reference/ui:popupmessagebox}}\label{\detokenize{reference/ui:index-24}}
\sphinxAtStartPar
\sphinxstyleemphasis{Creates a popup message box}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{PopUpMessageBox}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{text}\PYG{o}{\PYGZgt{}}\PYG{p}{,}\PYG{+w}{ }\PYG{o}{\PYGZlt{}}\PYG{n+nv}{win}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nv}{subnum}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{PopUpMessageBox}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}There has been an error.\PYGZdq{}}\PYG{p}{,}\PYG{n+nv+vg}{gWin}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{MessageBox()}}, \sphinxcode{\sphinxupquote{GetEasyInput()}}, \sphinxcode{\sphinxupquote{PopUpEntryBox()}}

\index{PushButton@\spxentry{PushButton}}\ignorespaces 

\subsection{PushButton()}
\label{\detokenize{reference/ui:pushbutton}}\label{\detokenize{reference/ui:index-25}}
\sphinxAtStartPar
...
\index{Pulldown@\spxentry{Pulldown}}\ignorespaces 

\subsection{Pulldown()}
\label{\detokenize{reference/ui:pulldown}}\label{\detokenize{reference/ui:index-26}}
\sphinxAtStartPar
\sphinxstyleemphasis{Handles pulldown interaction}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Pulldown}\PYG{p}{(}\PYG{n+nv}{object}\PYG{p}{,}\PYG{+w}{ }\PYG{p}{[}\PYG{n+nv}{x}\PYG{p}{,}\PYG{n+nv}{y}\PYG{p}{]}\PYG{p}{)}
\end{sphinxVerbatim}
...
\PYG{n+nv}{options}\PYG{+w}{  }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakePulldownButton}\PYG{p}{(}\PYG{p}{[}\PYG{l+s+s2}{\PYGZdq{}A\PYGZdq{}}\PYG{p}{,}\PYG{l+s+s2}{\PYGZdq{}B\PYGZdq{}}\PYG{p}{,}\PYG{l+s+s2}{\PYGZdq{}C\PYGZdq{}}\PYG{p}{]}\PYG{p}{,}\PYG{l+m+mi}{400}\PYG{p}{,}\PYG{l+m+mi}{250}\PYG{p}{,}\PYG{n+nv+vg}{gWin}\PYG{p}{,}\PYG{l+m+mi}{14}\PYG{p}{,}\PYG{l+m+mi}{100}\PYG{p}{,}\PYG{l+m+mi}{1}\PYG{p}{)}
\PYG{n+nv}{resp}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{WaitForClickOntarget}\PYG{p}{(}\PYG{p}{[}\PYG{n+nv}{options}\PYG{p}{]}\PYG{p}{,}\PYG{p}{[}\PYG{l+m+mi}{1}\PYG{p}{]}\PYG{p}{)}
\PYG{n+nv}{newvalue}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{Pulldown}\PYG{p}{(}\PYG{n+nv}{options}\PYG{p}{,}\PYG{n+nv+vg}{gClick}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{MakePullDown()}}, \sphinxcode{\sphinxupquote{DrawPulldown()}}, \sphinxcode{\sphinxupquote{UpdatePulldown()}}

\index{SetScrollingText@\spxentry{SetScrollingText}}\ignorespaces 

\subsection{SetScrollingText()}
\label{\detokenize{reference/ui:setscrollingtext}}\label{\detokenize{reference/ui:index-27}}
\sphinxAtStartPar
...
\index{SetCheckbox@\spxentry{SetCheckbox}}\ignorespaces 

\subsection{SetCheckbox()}
\label{\detokenize{reference/ui:setcheckbox}}\label{\detokenize{reference/ui:index-28}}
\sphinxAtStartPar
\sphinxstyleemphasis{Sets checkbox state}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{SetCheckBox}\PYG{p}{(}\PYG{n+nv}{obj}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{value}\PYG{p}{)}
\end{sphinxVerbatim}
...
\PYG{n+nv}{ok}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeCheckbox}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}OK?\PYGZdq{}}\PYG{p}{,}\PYG{l+m+mi}{400}\PYG{p}{,}\PYG{l+m+mi}{250}\PYG{p}{,}\PYG{n+nv+vg}{gWin}\PYG{p}{,}\PYG{l+m+mi}{150}\PYG{p}{)}
\PYG{n+nf}{Draw}\PYG{p}{(}\PYG{p}{)}
\PYG{n+nf}{SetCheckBox}\PYG{p}{(}\PYG{n+nv}{ok}\PYG{p}{,}\PYG{l+m+mi}{1}\PYG{p}{)}
\PYG{n+nf}{Draw}\PYG{p}{(}\PYG{p}{)}
\PYG{n+nf}{Wait}\PYG{p}{(}\PYG{l+m+mi}{1000}\PYG{p}{)}
\PYG{n+nf}{SetCheckbox}\PYG{p}{(}\PYG{n+nv}{ok}\PYG{p}{,}\PYG{l+m+mi}{0}\PYG{p}{)}
\PYG{n+nf}{Draw}\PYG{p}{(}\PYG{p}{)}
\PYG{n+nf}{Wait}\PYG{p}{(}\PYG{l+m+mi}{1000}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{MakeCheckBox()}}, \sphinxcode{\sphinxupquote{ClickCheckBox()}}

\index{SetTextBoxCursorFromClick@\spxentry{SetTextBoxCursorFromClick}}\ignorespaces 

\subsection{SetTextBoxCursorFromClick()}
\label{\detokenize{reference/ui:settextboxcursorfromclick}}\label{\detokenize{reference/ui:index-29}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{SortDir()}
\label{\detokenize{reference/ui:sortdir}}\label{\detokenize{reference/ui:index-30}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/ui:updatepulldown}}\label{\detokenize{reference/ui:index-31}}
\sphinxAtStartPar
...
\label{\detokenize{reference/ui:updatescrollbox}}\label{\detokenize{reference/ui:index-32}}
\sphinxAtStartPar
...
\index{VecPlus@\spxentry{VecPlus}}\ignorespaces 

\subsection{VecPlus()}
\label{\detokenize{reference/ui:vecplus}}\label{\detokenize{reference/ui:index-33}}
\sphinxAtStartPar
\sphinxstyleemphasis{Adds a scalar to all vector elements}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{VecPlus}\PYG{p}{(}\PYG{n+nv}{vec}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{add}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Shift a list of values by adding 10 to each}
\PYG{n+nv}{values}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{p}{[}\PYG{l+m+mi}{1}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{2}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{3}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{4}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{5}\PYG{p}{]}
\PYG{n+nv}{shifted}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{VecPlus}\PYG{p}{(}\PYG{n+nv}{values}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{10}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Returns: [11, 12, 13, 14, 15]}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Offset coordinates}
\PYG{n+nv}{xCoords}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{p}{[}\PYG{l+m+mi}{100}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{150}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{200}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{250}\PYG{p}{]}
\PYG{n+nv}{xShifted}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{VecPlus}\PYG{p}{(}\PYG{n+nv}{xCoords}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{50}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Returns: [150, 200, 250, 300]}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Can be used with negative values}
\PYG{n+nv}{temps}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{p}{[}\PYG{l+m+mi}{72}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{75}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{68}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{71}\PYG{p}{]}
\PYG{n+nv}{adjusted}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{VecPlus}\PYG{p}{(}\PYG{n+nv}{temps}\PYG{p}{,}\PYG{+w}{ }\PYG{o}{\PYGZhy{}}\PYG{l+m+mi}{32}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Returns: [40, 43, 36, 39]}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Sequence()}}, \sphinxcode{\sphinxupquote{Repeat()}}, \sphinxcode{\sphinxupquote{Rep()}}

\index{AdaptiveTextBox@\spxentry{AdaptiveTextBox}}\ignorespaces 

\subsection{AdaptiveTextBox()}
\label{\detokenize{reference/ui:adaptivetextbox}}\label{\detokenize{reference/ui:index-34}}
\sphinxAtStartPar
\sphinxstyleemphasis{Creates a textbox that automatically adapts to fit content}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Creates a textbox that automatically adjusts to display text that doesn’t fit in the specified dimensions. Two adaptation strategies are available: scaling the box (preserves font size) or scaling the font (preserves box size). Uses the new \sphinxcode{\sphinxupquote{textComplete}} property to detect when all text has been rendered.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{AdaptiveTextBox}\PYG{p}{(}\PYG{n+nv}{text}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{x}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{y}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{window}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{fontsize}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{width}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{height}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{adaptive}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{maxlines}\PYG{p}{)}
\end{sphinxVerbatim}
...
\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{text}}: The text content to display

\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{x, y}}: Position coordinates (upper\sphinxhyphen{}left corner)

\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{window}}: Parent window object

\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{fontsize}}: Initial font size in points

\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{width, height}}: Target box dimensions in pixels

\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{adaptive}}: Adaptation strategy \sphinxhyphen{} \sphinxcode{\sphinxupquote{0}} (none), \sphinxcode{\sphinxupquote{"scalebox"}}, or \sphinxcode{\sphinxupquote{"scalefont"}}

\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{maxlines}}: Maximum number of lines allowed (default: 30)

\end{itemize}

\sphinxAtStartPar
\sphinxstylestrong{Adaptation Strategies:}
\begin{itemize}
\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{0}} \sphinxhyphen{} No adaptation; creates standard textbox (text may overflow)

\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{"scalebox"}} \sphinxhyphen{} Expands box to fit all text, then scales down using zoom to original size (preserves font size, uses SDL2 anisotropic filtering for quality)

\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{"scalefont"}} \sphinxhyphen{} Iteratively reduces font size until text fits (preserves box dimensions exactly, minimum 8pt)
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Create window}
\PYG{n+nv}{win}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeWindow}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}black\PYGZdq{}}\PYG{p}{)}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Long instruction text that needs adaptation}
\PYG{n+nv}{instructions}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}Welcome to the experiment. Please read these instructions carefully. \PYGZdq{}}\PYG{+w}{ }\PYG{o}{+}
\PYG{+w}{                }\PYG{l+s+s2}{\PYGZdq{}This is a long text that demonstrates the adaptive textbox functionality. \PYGZdq{}}\PYG{+w}{ }\PYG{o}{+}
\PYG{+w}{                }\PYG{l+s+s2}{\PYGZdq{}The textbox will automatically adjust to fit all this content.\PYGZdq{}}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Use scalefont strategy \PYGZhy{} reduces font size to fit}
\PYG{n+nv}{box1}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{AdaptiveTextBox}\PYG{p}{(}\PYG{n+nv}{instructions}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{50}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{50}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{win}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{24}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{400}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{100}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}scalefont\PYGZdq{}}\PYG{p}{)}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Use scalebox strategy \PYGZhy{} preserves font size, scales box down}
\PYG{n+nv}{box2}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{AdaptiveTextBox}\PYG{p}{(}\PYG{n+nv}{instructions}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{50}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{200}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{win}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{24}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{400}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{100}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}scalebox\PYGZdq{}}\PYG{p}{)}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{}No adaptation \PYGZhy{} text may overflow}
\PYG{n+nv}{box3}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{AdaptiveTextBox}\PYG{p}{(}\PYG{n+nv}{instructions}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{50}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{350}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{win}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{24}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{400}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{100}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{0}\PYG{p}{)}

\PYG{n+nf}{Draw}\PYG{p}{(}\PYG{p}{)}
\end{sphinxVerbatim}

\sphinxAtStartPar
\sphinxstylestrong{Strategy Comparison:}

\sphinxAtStartPar
\sphinxstylestrong{ScaleBox:}
\begin{itemize}
\item {} 
\sphinxAtStartPar
...
\item {} 
\sphinxAtStartPar
High\sphinxhyphen{}quality rendering with SDL2 anisotropic filtering
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{EasyTextBox()}}, \sphinxcode{\sphinxupquote{MakeTextBox()}}, \sphinxcode{\sphinxupquote{MakeScrollingTextBox()}}
...
\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id1}}{\hyperref[\detokenize{reference/utility:calibratescreen}]{\sphinxcrossref{CalibrateScreen()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id2}}{\hyperref[\detokenize{reference/utility:concatenatelist}]{\sphinxcrossref{ConcatenateList()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id3}}{\hyperref[\detokenize{reference/utility:convertipstring}]{\sphinxcrossref{ConvertIPString()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id4}}{\hyperref[\detokenize{reference/utility:cr}]{\sphinxcrossref{CR()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id5}}{\hyperref[\detokenize{reference/utility:dirlisttotext}]{\sphinxcrossref{DirlistToText()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id6}}{\hyperref[\detokenize{reference/utility:drawobject}]{\sphinxcrossref{DrawObject()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id7}}{\hyperref[\detokenize{reference/utility:easylabel}]{\sphinxcrossref{EasyLabel()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id8}}{\hyperref[\detokenize{reference/utility:easytextbox}]{\sphinxcrossref{EasyTextBox()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id9}}{\hyperref[\detokenize{reference/utility:endswith}]{\sphinxcrossref{EndsWith()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id10}}{\hyperref[\detokenize{reference/utility:enquote}]{\sphinxcrossref{Enquote()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id11}}{\hyperref[\detokenize{reference/utility:fetchtext}]{\sphinxcrossref{FetchText()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id12}}{\hyperref[\detokenize{reference/utility:fileprintlist}]{\sphinxcrossref{FilePrintList()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id13}}{\hyperref[\detokenize{reference/utility:formattext}]{\sphinxcrossref{FormatText()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id14}}{\hyperref[\detokenize{reference/utility:geteasychoice}]{\sphinxcrossref{GetEasyChoice()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id15}}{\hyperref[\detokenize{reference/utility:geteasyinput}]{\sphinxcrossref{GetEasyInput()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id16}}{\hyperref[\detokenize{reference/utility:geteasymultichoice}]{\sphinxcrossref{GetEasyMultiChoice()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id17}}{\hyperref[\detokenize{reference/utility:getnewdatafile}]{\sphinxcrossref{GetNewDataFile()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id18}}{\hyperref[\detokenize{reference/utility:getnimhdemographics}]{\sphinxcrossref{GetNIMHDemographics()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id19}}{\hyperref[\detokenize{reference/utility:getsubnum}]{\sphinxcrossref{GetSubNum()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id20}}{\hyperref[\detokenize{reference/utility:gettranslations}]{\sphinxcrossref{GetTranslations()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id21}}{\hyperref[\detokenize{reference/utility:initializeupload}]{\sphinxcrossref{InitializeUpload()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id22}}{\hyperref[\detokenize{reference/utility:inside}]{\sphinxcrossref{Inside()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id23}}{\hyperref[\detokenize{reference/utility:isurl}]{\sphinxcrossref{IsURL()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id24}}{\hyperref[\detokenize{reference/utility:jsontext}]{\sphinxcrossref{JSONText()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id25}}{\hyperref[\detokenize{reference/utility:likerttrial}]{\sphinxcrossref{LikertTrial()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id26}}{\hyperref[\detokenize{reference/utility:listtohumantext}]{\sphinxcrossref{ListToHumanText()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id27}}{\hyperref[\detokenize{reference/utility:lookup}]{\sphinxcrossref{Lookup()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id28}}{\hyperref[\detokenize{reference/utility:makeparameterobject}]{\sphinxcrossref{MakeParameterObject()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id29}}{\hyperref[\detokenize{reference/utility:messagebox}]{\sphinxcrossref{MessageBox()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id30}}{\hyperref[\detokenize{reference/utility:movecenter}]{\sphinxcrossref{MoveCenter()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id31}}{\hyperref[\detokenize{reference/utility:movecorner}]{\sphinxcrossref{MoveCorner()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id32}}{\hyperref[\detokenize{reference/utility:moveobject}]{\sphinxcrossref{MoveObject()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id33}}{\hyperref[\detokenize{reference/utility:printlist}]{\sphinxcrossref{PrintList()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id34}}{\hyperref[\detokenize{reference/utility:readcsv}]{\sphinxcrossref{ReadCSV()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id35}}{\hyperref[\detokenize{reference/utility:readjsonparameters}]{\sphinxcrossref{ReadJSONParameters()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id36}}{\hyperref[\detokenize{reference/utility:removeobjects}]{\sphinxcrossref{RemoveObjects()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id37}}{\hyperref[\detokenize{reference/utility:replacechar}]{\sphinxcrossref{ReplaceChar()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id38}}{\hyperref[\detokenize{reference/utility:splitstringslow}]{\sphinxcrossref{SplitStringSlow()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id39}}{\hyperref[\detokenize{reference/utility:stripquotes}]{\sphinxcrossref{StripQuotes()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id40}}{\hyperref[\detokenize{reference/utility:stripspace}]{\sphinxcrossref{StripSpace()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id41}}{\hyperref[\detokenize{reference/utility:tab}]{\sphinxcrossref{Tab()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id42}}{\hyperref[\detokenize{reference/utility:waitforbuttonclickontarget}]{\sphinxcrossref{WaitForButtonClickOnTarget()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id43}}{\hyperref[\detokenize{reference/utility:waitforclickontarget}]{\sphinxcrossref{WaitForClickOnTarget()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id44}}{\hyperref[\detokenize{reference/utility:waitforclickontargetwithtimeout}]{\sphinxcrossref{WaitForClickOnTargetWithTimeout()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id45}}{\hyperref[\detokenize{reference/utility:waitfordownclick}]{\sphinxcrossref{WaitForDownClick()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id46}}{\hyperref[\detokenize{reference/utility:yesnotrial}]{\sphinxcrossref{YesNoTrial()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id47}}{\hyperref[\detokenize{reference/utility:zeropad}]{\sphinxcrossref{ZeroPad()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id48}}{\hyperref[\detokenize{reference/utility:functions-pending-documentation}]{\sphinxcrossref{Functions Pending Documentation}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id49}}{\hyperref[\detokenize{reference/utility:appenddirlist}]{\sphinxcrossref{AppendDirList()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id50}}{\hyperref[\detokenize{reference/utility:createparameters}]{\sphinxcrossref{CreateParameters()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id51}}{\hyperref[\detokenize{reference/utility:dirtotext}]{\sphinxcrossref{DirToText()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id52}}{\hyperref[\detokenize{reference/utility:getdirectory}]{\sphinxcrossref{GetDirectory()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id53}}{\hyperref[\detokenize{reference/utility:getnewsubnum}]{\sphinxcrossref{GetNewSubNum()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id54}}{\hyperref[\detokenize{reference/utility:readtranslation}]{\sphinxcrossref{ReadTranslation()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id55}}{\hyperref[\detokenize{reference/utility:readtranslationjson}]{\sphinxcrossref{ReadTranslationJSON()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id56}}{\hyperref[\detokenize{reference/utility:substitutestrings}]{\sphinxcrossref{SubstituteStrings()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id57}}{\hyperref[\detokenize{reference/utility:syncdatafile}]{\sphinxcrossref{SyncDataFile()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id58}}{\hyperref[\detokenize{reference/utility:uploadfile}]{\sphinxcrossref{UploadFile()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id59}}{\hyperref[\detokenize{reference/utility:clickon}]{\sphinxcrossref{ClickOn()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id60}}{\hyperref[\detokenize{reference/utility:countdown}]{\sphinxcrossref{Countdown()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id61}}{\hyperref[\detokenize{reference/utility:getinput}]{\sphinxcrossref{GetInput()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id62}}{\hyperref[\detokenize{reference/utility:isdefined}]{\sphinxcrossref{IsDefined()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id63}}{\hyperref[\detokenize{reference/utility:indent}]{\sphinxcrossref{Indent()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id64}}{\hyperref[\detokenize{reference/utility:makefontfamily}]{\sphinxcrossref{MakeFontFamily()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id65}}{\hyperref[\detokenize{reference/utility:joinstrings}]{\sphinxcrossref{JoinStrings()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id66}}{\hyperref[\detokenize{reference/utility:convertnewlinestocr}]{\sphinxcrossref{ConvertNewlinesToCR()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id67}}{\hyperref[\detokenize{reference/utility:initializelsl}]{\sphinxcrossref{InitializeLSL()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id68}}{\hyperref[\detokenize{reference/utility:lslmarker}]{\sphinxcrossref{LSLMarker()}}}

\item {} 
\sphinxAtStartPar
\phantomsection\label{\detokenize{reference/utility:id69}}{\hyperref[\detokenize{reference/utility:finalizelsl}]{\sphinxcrossref{FinalizeLSL()}}}
...
\sphinxAtStartPar
Produces \sphinxcode{\sphinxupquote{\textless{}number\textgreater{}}} linefeeds which can be added to a   string and printed or saved to a file.  CR is an abbreviation for \sphinxcode{\sphinxupquote{Carriage Return}}.
...
\index{GetTranslations@\spxentry{GetTranslations}}\ignorespaces 

\subsection{GetTranslations()}
\label{\detokenize{reference/utility:gettranslations}}\label{\detokenize{reference/utility:index-19}}
\sphinxAtStartPar
\sphinxstyleemphasis{Loads multilingual translations with automatic language fallback}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Automatically loads translation strings for experiments from JSON translation files. Implements a three\sphinxhyphen{}tier fallback system: (1) uses explicitly specified language if file exists, (2) falls back to system locale language if available, (3) defaults to English if no other translations are found. Normalizes all language codes to lowercase 2\sphinxhyphen{}letter codes (e.g., “en”, “es”, “ar”). Returns a custom object with translated strings as properties that can be accessed throughout the experiment.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{GetTranslations}\PYG{p}{(}\PYG{n+nv}{testname}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{lang}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Load translations with explicit language}
\PYG{n+nv+vg}{gLanguage}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}es\PYGZdq{}}\PYG{+w}{  }\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Spanish}
\PYG{n+nv+vg}{gStrings}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{GetTranslations}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}stroop\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv+vg}{gLanguage}\PYG{p}{)}
\PYG{n+nf}{MessageBox}\PYG{p}{(}\PYG{n+nv+vg}{gStrings.instructions}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv+vg}{gWin}\PYG{p}{)}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Let it auto\PYGZhy{}detect from system locale}
\PYG{n+nv+vg}{gLanguage}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}\PYGZdq{}}\PYG{+w}{  }\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Empty means use system locale}
\PYG{n+nv+vg}{gStrings}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{GetTranslations}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}flanker\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv+vg}{gLanguage}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Will try system language, fall back to English}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{}Translation files are expected at:}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}translations/stroop.pbl\PYGZhy{}es.json}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}translations/stroop.pbl\PYGZhy{}en.json}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}etc.}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{ReadTranslationJSON()}}, \sphinxcode{\sphinxupquote{ReadTranslation()}}, \sphinxcode{\sphinxupquote{GetSystemLocale()}}, \sphinxcode{\sphinxupquote{Lowercase()}}

\index{InitializeUpload@\spxentry{InitializeUpload}}\ignorespaces 

\subsection{InitializeUpload()}
\label{\detokenize{reference/utility:initializeupload}}\label{\detokenize{reference/utility:index-20}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{Inside()}
\label{\detokenize{reference/utility:inside}}\label{\detokenize{reference/utility:index-21}}
\sphinxAtStartPar
...
\subsection{IsURL()}
\label{\detokenize{reference/utility:isurl}}\label{\detokenize{reference/utility:index-22}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{JSONText()}
\label{\detokenize{reference/utility:jsontext}}\label{\detokenize{reference/utility:index-23}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/utility:likerttrial}}\label{\detokenize{reference/utility:index-24}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/utility:listtohumantext}}\label{\detokenize{reference/utility:index-25}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{Lookup()}
\label{\detokenize{reference/utility:lookup}}\label{\detokenize{reference/utility:index-26}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/utility:makeparameterobject}}\label{\detokenize{reference/utility:index-27}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/utility:messagebox}}\label{\detokenize{reference/utility:index-28}}
\sphinxAtStartPar
...
\label{\detokenize{reference/utility:movecenter}}\label{\detokenize{reference/utility:index-29}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/utility:movecorner}}\label{\detokenize{reference/utility:index-30}}
\sphinxAtStartPar
...
\label{\detokenize{reference/utility:moveobject}}\label{\detokenize{reference/utility:index-31}}
\sphinxAtStartPar
...
\label{\detokenize{reference/utility:printlist}}\label{\detokenize{reference/utility:index-32}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{ReadCSV()}
\label{\detokenize{reference/utility:readcsv}}\label{\detokenize{reference/utility:index-33}}
\sphinxAtStartPar
...
\label{\detokenize{reference/utility:readjsonparameters}}\label{\detokenize{reference/utility:index-34}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/utility:removeobjects}}\label{\detokenize{reference/utility:index-35}}
\sphinxAtStartPar
...
\label{\detokenize{reference/utility:replacechar}}\label{\detokenize{reference/utility:index-36}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/utility:splitstringslow}}\label{\detokenize{reference/utility:index-37}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/utility:stripquotes}}\label{\detokenize{reference/utility:index-38}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/utility:stripspace}}\label{\detokenize{reference/utility:index-39}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{Tab()}
\label{\detokenize{reference/utility:tab}}\label{\detokenize{reference/utility:index-40}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/utility:waitforbuttonclickontarget}}\label{\detokenize{reference/utility:index-41}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/utility:waitforclickontarget}}\label{\detokenize{reference/utility:index-42}}
\sphinxAtStartPar
...
\label{\detokenize{reference/utility:waitforclickontargetwithtimeout}}\label{\detokenize{reference/utility:index-43}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\label{\detokenize{reference/utility:waitfordownclick}}\label{\detokenize{reference/utility:index-44}}
\sphinxAtStartPar
...
\label{\detokenize{reference/utility:yesnotrial}}\label{\detokenize{reference/utility:index-45}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\subsection{ZeroPad()}
\label{\detokenize{reference/utility:zeropad}}\label{\detokenize{reference/utility:index-46}}
\sphinxAtStartPar
...
\label{\detokenize{reference/utility:appenddirlist}}\label{\detokenize{reference/utility:index-47}}
\sphinxAtStartPar
...
\label{\detokenize{reference/utility:createparameters}}\label{\detokenize{reference/utility:index-48}}
\sphinxAtStartPar
...
\label{\detokenize{reference/utility:dirtotext}}\label{\detokenize{reference/utility:index-49}}
\sphinxAtStartPar
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{} Combine directory components with files}
\PYG{n+nv}{dirs}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{p}{[}\PYG{l+s+s2}{\PYGZdq{}data\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}experiment1\PYGZdq{}}\PYG{p}{]}
\PYG{n+nv}{files}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{p}{[}\PYG{l+s+s2}{\PYGZdq{}trial01.csv\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}trial02.csv\PYGZdq{}}\PYG{p}{]}
\PYG{n+nv}{paths}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{DirToText}\PYG{p}{(}\PYG{n+nv}{dirs}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{files}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}\PYGZdq{}}\PYG{p}{)}

\PYG{c+c1}{\PYGZsh{} Results in paths with directory prefixes}
\PYG{k}{loop}\PYG{p}{(}\PYG{n+nv}{p}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{paths}\PYG{p}{)}
\PYG{p}{\PYGZob{}}
\PYG{+w}{   }\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nv}{p}\PYG{p}{)}
\PYG{p}{\PYGZcb{}}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{AppendDirList()}}, \sphinxcode{\sphinxupquote{GetDirectory()}}, \sphinxcode{\sphinxupquote{GetDirectoryListing()}}

\index{GetDirectory@\spxentry{GetDirectory}}\ignorespaces 

\subsection{GetDirectory()}
\label{\detokenize{reference/utility:getdirectory}}\label{\detokenize{reference/utility:index-50}}
\sphinxAtStartPar
\sphinxstyleemphasis{Extracts the directory path from a file path}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{GetDirectory}\PYG{p}{(}\PYG{n+nv}{filepath}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{} Extract directory from file path}
\PYG{n+nv}{dir}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{GetDirectory}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}data/experiment/results.csv\PYGZdq{}}\PYG{p}{)}
\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nv}{dir}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{} Result: \PYGZdq{}data/experiment/\PYGZdq{} (on Unix/Linux/Mac)}

\PYG{c+c1}{\PYGZsh{} Works automatically on Windows too}
\PYG{n+nv}{dir}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{GetDirectory}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}C:\PYGZbs{}Users\PYGZbs{}Lab\PYGZbs{}data\PYGZbs{}subject01.txt\PYGZdq{}}\PYG{p}{)}
\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nv}{dir}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{} Result: \PYGZdq{}C:\PYGZbs{}Users\PYGZbs{}Lab\PYGZbs{}data\PYGZbs{}\PYGZdq{} (on Windows)}

\PYG{c+c1}{\PYGZsh{} Use with other path operations}
\PYG{n+nv}{filepath}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}results/trial\PYGZhy{}data.csv\PYGZdq{}}
\PYG{n+nv}{directory}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{GetDirectory}\PYG{p}{(}\PYG{n+nv}{filepath}\PYG{p}{)}
\PYG{n+nv}{newfile}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nv}{directory}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}summary\PYGZhy{}data.csv\PYGZdq{}}
\PYG{c+c1}{\PYGZsh{} newfile is \PYGZdq{}results/summary\PYGZhy{}data.csv\PYGZdq{}}

\PYG{c+c1}{\PYGZsh{} Common use case: creating pooled data files}
\PYG{n+nv}{fileOut}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{GetNewDataFile}\PYG{p}{(}\PYG{n+nv+vg}{gSubnum}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv+vg}{gWin}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}test\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}csv\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}header\PYGZdq{}}\PYG{p}{)}
\PYG{n+nv}{dir}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{GetDirectory}\PYG{p}{(}\PYG{n+nv}{fileOut.filename}\PYG{p}{)}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}../\PYGZdq{}}
\PYG{n+nv}{pooledFile}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{FileOpenAppend}\PYG{p}{(}\PYG{n+nv}{dir}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}pooled\PYGZhy{}results.csv\PYGZdq{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{GetWorkingDirectory()}}, \sphinxcode{\sphinxupquote{FileExists()}}, \sphinxcode{\sphinxupquote{DirToText()}}

\index{GetNewSubNum@\spxentry{GetNewSubNum}}\ignorespaces 

\subsection{GetNewSubNum()}
\label{\detokenize{reference/utility:getnewsubnum}}\label{\detokenize{reference/utility:index-51}}
\sphinxAtStartPar
\sphinxstyleemphasis{Requests a new subject number from a remote server}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Connects to a remote PEBL data server to request and receive a new unique subject number for data collection. The server maintains a counter and returns sequential subject codes. If the server connection fails, a random 6\sphinxhyphen{}digit number is returned as a fallback. Used in labs or online studies where centralized subject numbering is needed across multiple testing stations or sessions.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{GetNewSubNum}\PYG{p}{(}\PYG{n+nv}{server}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{page}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{port}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{username}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{pword}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{} Get new subject number from server}
\PYG{n+nv}{server}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}data.mylab.edu\PYGZdq{}}
\PYG{n+nv}{page}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}get\PYGZus{}subject\PYGZus{}id.php\PYGZdq{}}
\PYG{n+nv}{port}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+m+mi}{80}
\PYG{n+nv}{username}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}labuser\PYGZdq{}}
\PYG{n+nv}{password}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}secure\PYGZus{}password\PYGZdq{}}

\PYG{n+nv+vg}{gSubNum}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{GetNewSubNum}\PYG{p}{(}\PYG{n+nv}{server}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{page}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{port}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{username}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{password}\PYG{p}{)}
\PYG{n+nf}{Print}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}Assigned subject number: \PYGZdq{}}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{n+nv+vg}{gSubNum}\PYG{p}{)}

\PYG{c+c1}{\PYGZsh{} Use subject number for data files}
\PYG{n+nv}{datafile}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{FileOpenWrite}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}data/\PYGZdq{}}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{n+nv+vg}{gSubNum}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}/results.csv\PYGZdq{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{GetSubNum()}}, \sphinxcode{\sphinxupquote{UploadFile()}}, \sphinxcode{\sphinxupquote{SyncDataFile()}}

\index{ReadTranslation@\spxentry{ReadTranslation}}\ignorespaces 

\subsection{ReadTranslation()}
\label{\detokenize{reference/utility:readtranslation}}\label{\detokenize{reference/utility:index-52}}
\sphinxAtStartPar
\sphinxstyleemphasis{Loads multilingual text from a CSV translation file}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Reads a CSV\sphinxhyphen{}format translation file containing text strings in multiple languages. Creates a custom object with text strings as properties that can be accessed in experiments. Useful for creating experiments that can be presented in different languages. The CSV file should have text keys in the first column and translated text in subsequent columns. Line breaks (\textbackslash{}n) in the file are converted to actual carriage returns.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{ReadTranslation}\PYG{p}{(}\PYG{n+nv}{filename}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{lang}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{} Load English translations from CSV file}
\PYG{c+c1}{\PYGZsh{} translations.csv contains:}
\PYG{c+c1}{\PYGZsh{} welcome,Welcome to the experiment}
\PYG{c+c1}{\PYGZsh{} instructions,Please press any key to begin}
\PYG{c+c1}{\PYGZsh{} thanks,Thank you for participating}

\PYG{n+nv}{trans}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{ReadTranslation}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}translations\PYGZhy{}en.csv\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}en\PYGZdq{}}\PYG{p}{)}
\PYG{n+nf}{MessageBox}\PYG{p}{(}\PYG{n+nv}{trans.welcome}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv+vg}{gWin}\PYG{p}{)}
\PYG{n+nf}{MessageBox}\PYG{p}{(}\PYG{n+nv}{trans.instructions}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv+vg}{gWin}\PYG{p}{)}

\PYG{c+c1}{\PYGZsh{} Run experiment...}

\PYG{n+nf}{MessageBox}\PYG{p}{(}\PYG{n+nv}{trans.thanks}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv+vg}{gWin}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{ReadTranslationJSON()}}, \sphinxcode{\sphinxupquote{ReadCSV()}}, \sphinxcode{\sphinxupquote{FormatText()}}

\index{ReadTranslationJSON@\spxentry{ReadTranslationJSON}}\ignorespaces 

\subsection{ReadTranslationJSON()}
\label{\detokenize{reference/utility:readtranslationjson}}\label{\detokenize{reference/utility:index-53}}
\sphinxAtStartPar
\sphinxstyleemphasis{Loads multilingual text from a JSON translation file}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Reads a JSON\sphinxhyphen{}format translation file containing text strings in multiple languages. Creates a custom object with text strings as properties that can be accessed in experiments. This is the modern alternative to \sphinxcode{\sphinxupquote{ReadTranslation()}} with better support for complex text and special characters. The JSON file should contain key\sphinxhyphen{}value pairs where keys are text identifiers and values are the translated strings. Line breaks (\textbackslash{}n) in the JSON are converted to actual carriage returns.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{ReadTranslationJSON}\PYG{p}{(}\PYG{n+nv}{filename}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{lang}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{} Load English translations from JSON file}
\PYG{c+c1}{\PYGZsh{} translations\PYGZhy{}en.json contains:}
\PYG{c+c1}{\PYGZsh{} \PYGZob{}}
\PYG{c+c1}{\PYGZsh{}   \PYGZdq{}welcome\PYGZdq{}: \PYGZdq{}Welcome to the experiment\PYGZdq{},}
\PYG{c+c1}{\PYGZsh{}   \PYGZdq{}instructions\PYGZdq{}: \PYGZdq{}Please press any key to begin\PYGZdq{},}
\PYG{c+c1}{\PYGZsh{}   \PYGZdq{}thanks\PYGZdq{}: \PYGZdq{}Thank you for participating\PYGZdq{}}
\PYG{c+c1}{\PYGZsh{} \PYGZcb{}}

\PYG{n+nv}{trans}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{ReadTranslationJSON}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}translations\PYGZhy{}en.json\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}en\PYGZdq{}}\PYG{p}{)}
\PYG{n+nf}{MessageBox}\PYG{p}{(}\PYG{n+nv}{trans.welcome}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv+vg}{gWin}\PYG{p}{)}
\PYG{n+nf}{MessageBox}\PYG{p}{(}\PYG{n+nv}{trans.instructions}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv+vg}{gWin}\PYG{p}{)}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{ReadTranslation()}}, \sphinxcode{\sphinxupquote{ParseJSON()}}, \sphinxcode{\sphinxupquote{FormatText()}}

\index{SubstituteStrings@\spxentry{SubstituteStrings}}\ignorespaces 

\subsection{SubstituteStrings()}
\label{\detokenize{reference/utility:substitutestrings}}\label{\detokenize{reference/utility:index-54}}
\sphinxAtStartPar
\sphinxstyleemphasis{Makes multiple substitutions in text}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Performs multiple character substitutions in a text string. Takes a list of replacement pairs and applies each one sequentially using \sphinxcode{\sphinxupquote{ReplaceChar()}}. Useful for cleaning up text, converting special characters, or applying multiple text transformations at once.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{SubstituteStrings}\PYG{p}{(}\PYG{n+nv}{text}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{replist}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{} Replace multiple characters for file\PYGZhy{}safe names}
\PYG{n+nv}{text}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}Subject: John Doe (Test \PYGZsh{}1)\PYGZdq{}}
\PYG{n+nv}{replacements}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{p}{[}\PYG{p}{[}\PYG{l+s+s2}{\PYGZdq{} \PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}\PYGZus{}\PYGZdq{}}\PYG{p}{]}\PYG{p}{,}\PYG{+w}{ }\PYG{p}{[}\PYG{l+s+s2}{\PYGZdq{}:\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}\PYGZhy{}\PYGZdq{}}\PYG{p}{]}\PYG{p}{,}\PYG{+w}{ }\PYG{p}{[}\PYG{l+s+s2}{\PYGZdq{}(\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}[\PYGZdq{}}\PYG{p}{]}\PYG{p}{,}\PYG{+w}{ }\PYG{p}{[}\PYG{l+s+s2}{\PYGZdq{})\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}]\PYGZdq{}}\PYG{p}{]}\PYG{p}{,}\PYG{+w}{ }\PYG{p}{[}\PYG{l+s+s2}{\PYGZdq{}\PYGZsh{}\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}num\PYGZdq{}}\PYG{p}{]}\PYG{p}{]}
\PYG{n+nv}{cleaned}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{SubstituteStrings}\PYG{p}{(}\PYG{n+nv}{text}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{replacements}\PYG{p}{)}
\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nv}{cleaned}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{} Result: \PYGZdq{}Subject\PYGZhy{}\PYGZus{}John\PYGZus{}Doe\PYGZus{}[Test\PYGZus{}num1]\PYGZdq{}}

\PYG{c+c1}{\PYGZsh{} Convert special characters in user input}
\PYG{n+nv}{userInput}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}Hello\PYGZbs{}nWorld!\PYGZdq{}}
\PYG{n+nv}{subs}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{p}{[}\PYG{p}{[}\PYG{l+s+s2}{\PYGZdq{}\PYGZbs{}n\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{} \PYGZdq{}}\PYG{p}{]}\PYG{p}{,}\PYG{+w}{ }\PYG{p}{[}\PYG{l+s+s2}{\PYGZdq{}!\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}.\PYGZdq{}}\PYG{p}{]}\PYG{p}{]}
\PYG{n+nv}{formatted}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{SubstituteStrings}\PYG{p}{(}\PYG{n+nv}{userInput}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{subs}\PYG{p}{)}
\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nv}{formatted}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{} Result: \PYGZdq{}Hello World.\PYGZdq{}}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{ReplaceChar()}}, \sphinxcode{\sphinxupquote{Replace()}}

\index{SyncDataFile@\spxentry{SyncDataFile}}\ignorespaces 

\subsection{SyncDataFile()}
\label{\detokenize{reference/utility:syncdatafile}}\label{\detokenize{reference/utility:index-55}}
\sphinxAtStartPar
\sphinxstyleemphasis{Synchronizes a data file with a remote server using HTTP POST}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Uploads a data file to a remote server using HTTP POST with multipart/form\sphinxhyphen{}data encoding. Sends authentication credentials, task name, subject code, and optional authorization token along with the file contents. Used for real\sphinxhyphen{}time data synchronization during experiments or for batch uploads to a PEBL data collection server. Returns the server’s HTTP response.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{SyncDataFile}\PYG{p}{(}\PYG{n+nv}{server}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{page}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{port}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{username}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{pword}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{taskname}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{subcode}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{datafilename}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{token}\PYG{o}{:}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}\PYGZdq{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{} Sync data file to server after each trial block}
\PYG{n+nv}{server}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}data.mylab.edu\PYGZdq{}}
\PYG{n+nv}{page}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}sync\PYGZus{}data.php\PYGZdq{}}
\PYG{n+nv}{port}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+m+mi}{80}
\PYG{n+nv}{username}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}labuser\PYGZdq{}}
\PYG{n+nv}{password}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}secure\PYGZus{}password\PYGZdq{}}
\PYG{n+nv}{taskname}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}stroop\PYGZus{}task\PYGZdq{}}
\PYG{n+nv}{subcode}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nv+vg}{gSubNum}
\PYG{n+nv}{datafile}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}data/\PYGZdq{}}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{n+nv}{subcode}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}/block1.csv\PYGZdq{}}

\PYG{n+nv}{response}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{SyncDataFile}\PYG{p}{(}\PYG{n+nv}{server}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{page}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{port}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{username}\PYG{p}{,}
\PYG{+w}{                         }\PYG{n+nv}{password}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{taskname}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{subcode}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{datafile}\PYG{p}{)}

\PYG{n+nf}{Print}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}Server response: \PYGZdq{}}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{n+nf}{First}\PYG{p}{(}\PYG{n+nv}{response}\PYG{p}{)}\PYG{p}{)}

\PYG{c+c1}{\PYGZsh{} With authorization token for secure studies}
\PYG{n+nv}{token}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}study\PYGZus{}auth\PYGZus{}token\PYGZus{}12345\PYGZdq{}}
\PYG{n+nv}{response}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{SyncDataFile}\PYG{p}{(}\PYG{n+nv}{server}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{page}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{port}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{username}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{password}\PYG{p}{,}
\PYG{+w}{                         }\PYG{n+nv}{taskname}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{subcode}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{datafile}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{token}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{UploadFile()}}, \sphinxcode{\sphinxupquote{GetNewSubNum()}}, \sphinxcode{\sphinxupquote{PostHTTPFile()}}

\index{UploadFile@\spxentry{UploadFile}}\ignorespaces 

\subsection{UploadFile()}
\label{\detokenize{reference/utility:uploadfile}}\label{\detokenize{reference/utility:index-56}}
\sphinxAtStartPar
\sphinxstyleemphasis{Uploads a data file to a remote server}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Uploads experimental data files to a remote server for centralized data collection. Only operates when the \sphinxcode{\sphinxupquote{\sphinxhyphen{}\sphinxhyphen{}upload}} command\sphinxhyphen{}line flag is used with PEBL. Reads server configuration from a JSON settings file containing host, page, port, and authentication details. If no\_upload flag is set in settings or the file doesn’t exist, upload is skipped. Useful for online experiments or multi\sphinxhyphen{}site studies requiring automatic data upload.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{UploadFile}\PYG{p}{(}\PYG{n+nv}{subcode}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{datafilename}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{settings}\PYG{o}{:}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}\PYGZdq{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{c+c1}{\PYGZsh{} Upload data file after experiment completes}
\PYG{c+c1}{\PYGZsh{} Run PEBL with: pebl experiment.pbl \PYGZhy{}\PYGZhy{}upload upload.json}
\PYG{c+c1}{\PYGZsh{}}
\PYG{c+c1}{\PYGZsh{} upload.json contains:}
\PYG{c+c1}{\PYGZsh{} \PYGZob{}}
\PYG{c+c1}{\PYGZsh{}   \PYGZdq{}host\PYGZdq{}: \PYGZdq{}data.mylab.edu\PYGZdq{},}
\PYG{c+c1}{\PYGZsh{}   \PYGZdq{}page\PYGZdq{}: \PYGZdq{}upload.php\PYGZdq{},}
\PYG{c+c1}{\PYGZsh{}   \PYGZdq{}port\PYGZdq{}: 80,}
\PYG{c+c1}{\PYGZsh{}   \PYGZdq{}username\PYGZdq{}: \PYGZdq{}labuser\PYGZdq{},}
\PYG{c+c1}{\PYGZsh{}   \PYGZdq{}password\PYGZdq{}: \PYGZdq{}secure\PYGZus{}password\PYGZdq{}}
\PYG{c+c1}{\PYGZsh{} \PYGZcb{}}

\PYG{n+nv+vg}{gSubNum}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}101\PYGZdq{}}
\PYG{n+nv}{datafile}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}data/\PYGZdq{}}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{n+nv+vg}{gSubNum}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}/results.csv\PYGZdq{}}

\PYG{c+c1}{\PYGZsh{} Upload will only happen if \PYGZhy{}\PYGZhy{}upload was specified}
\PYG{n+nf}{UploadFile}\PYG{p}{(}\PYG{n+nv+vg}{gSubNum}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{datafile}\PYG{p}{)}

\PYG{c+c1}{\PYGZsh{} Or specify custom settings file}
\PYG{n+nf}{UploadFile}\PYG{p}{(}\PYG{n+nv+vg}{gSubNum}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{datafile}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}custom\PYGZus{}upload.json\PYGZdq{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{SyncDataFile()}}, \sphinxcode{\sphinxupquote{GetNewSubNum()}}, \sphinxcode{\sphinxupquote{InitializeUpload()}}

\index{ClickOn@\spxentry{ClickOn}}\ignorespaces 

\subsection{ClickOn()}
\label{\detokenize{reference/utility:clickon}}\label{\detokenize{reference/utility:index-57}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Clickon}\PYG{p}{(}\PYG{n+nv}{obj}\PYG{p}{,}\PYG{p}{[}\PYG{n+nv}{x}\PYG{p}{,}\PYG{n+nv}{y}\PYG{p}{]}\PYG{p}{)}
\end{sphinxVerbatim}
...
\PYG{c+c1}{\PYGZsh{}\PYGZsh{}This overrides buttons placement at the center:}
\PYG{+w}{   }\PYG{n+nv}{done}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeButton}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}QUIT\PYGZdq{}}\PYG{p}{,}\PYG{l+m+mi}{400}\PYG{p}{,}\PYG{l+m+mi}{250}\PYG{p}{,}\PYG{n+nv+vg}{gWin}\PYG{p}{,}\PYG{l+m+mi}{150}\PYG{p}{)}
\PYG{+w}{   }\PYG{n+nf}{WaitForClickOnTarget}\PYG{p}{(}\PYG{p}{[}\PYG{n+nv}{done}\PYG{p}{]}\PYG{p}{,}\PYG{p}{[}\PYG{l+m+mi}{1}\PYG{p}{]}\PYG{p}{)}
\PYG{+w}{   }\PYG{n+nf}{Clickon}\PYG{p}{(}\PYG{n+nv}{done}\PYG{p}{,}\PYG{n+nv+vg}{gClick}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Inside()}}, \sphinxcode{\sphinxupquote{ClickCheckbox()}}, \sphinxcode{\sphinxupquote{MoveObject()}}, \sphinxcode{\sphinxupquote{DrawObject()}}

\index{Countdown@\spxentry{Countdown}}\ignorespaces 

\subsection{Countdown()}
\label{\detokenize{reference/utility:countdown}}\label{\detokenize{reference/utility:index-58}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Displays a 3\sphinxhyphen{}2\sphinxhyphen{}1 countdown on the screen in with 500 ms ISI. \sphinxcode{\sphinxupquote{CountDown}} temporarily hides whatever is on the screen. It is useful in orienting participants to the first trial of a task. The second argument (useBackground) is true (1) by default. In this case, the entire screen will be hidden with a black overlay. If set to 0, this overlay will not be made.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{CountDown}\PYG{p}{(}\PYG{n+nv}{win}\PYG{p}{)}
\PYG{+w}{   }\PYG{n+nf}{CountDown}\PYG{p}{(}\PYG{n+nv}{win}\PYG{p}{,}\PYG{p}{(}\PYG{n+nv}{optional}\PYG{p}{)}\PYG{n+nv}{useBackground}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nv}{win}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeWindow}\PYG{p}{(}\PYG{p}{)}
\PYG{+w}{  }\PYG{n+nf}{MessageBox}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}Press any key to begin\PYGZdq{}}\PYG{p}{,}\PYG{n+nv}{win}\PYG{p}{)}
\PYG{+w}{  }\PYG{n+nf}{CountDown}\PYG{p}{(}\PYG{n+nv}{win}\PYG{p}{)}
\PYG{+w}{  }\PYG{n+nf}{Trial}\PYG{p}{(}\PYG{p}{)}

\PYG{+w}{  }\PYG{n+nf}{CountDown}\PYG{p}{(}\PYG{n+nv}{win}\PYG{p}{,}\PYG{l+m+mi}{0}\PYG{p}{)}
\PYG{+w}{  }T\PYG{n+nv}{rial}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{MessageBox()}}

\index{GetInput@\spxentry{GetInput}}\ignorespaces 

\subsection{GetInput()}
\label{\detokenize{reference/utility:getinput}}\label{\detokenize{reference/utility:index-59}}
\sphinxAtStartPar
\sphinxstylestrong{Description:}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{GetInput}\PYG{p}{(}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{textbox}\PYG{o}{\PYGZgt{}}\PYG{p}{,}\PYG{o}{\PYGZlt{}}\PYG{n+nv}{escape}\PYG{o}{\PYGZhy{}}\PYG{n+nv}{key}\PYG{o}{\PYGZgt{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{SetEditable()}}, \sphinxcode{\sphinxupquote{GetCursorPosition()}}, \sphinxcode{\sphinxupquote{MakeTextBox()}}, \sphinxcode{\sphinxupquote{SetText()}}

\index{IsDefined@\spxentry{IsDefined}}\ignorespaces 

\subsection{IsDefined()}
\label{\detokenize{reference/utility:isdefined}}\label{\detokenize{reference/utility:index-60}}
\sphinxAtStartPar
\sphinxstyleemphasis{Tests whether a variable has been defined.}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Returns 1 if \sphinxcode{\sphinxupquote{varname}} (given as a string) is a currently\sphinxhyphen{}defined variable, or 0 if it has not been defined.  This is a readable alias for \sphinxcode{\sphinxupquote{VariableExists()}}.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{IsDefined}\PYG{p}{(}\PYG{n+nv}{varname}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{if}\PYG{p}{(}\PYG{n+nf}{IsDefined}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}gUploadFile\PYGZdq{}}\PYG{p}{)}\PYG{p}{)}
\PYG{p}{\PYGZob{}}
\PYG{+w}{    }\PYG{n+nf}{UploadLine}\PYG{p}{(}\PYG{n+nv+vg}{gSubNum}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}data.csv\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{header}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{line}\PYG{p}{)}
\PYG{p}{\PYGZcb{}}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{VariableExists()}}, \sphinxcode{\sphinxupquote{PropertyExists()}}

\index{Indent@\spxentry{Indent}}\ignorespaces 

\subsection{Indent()}
\label{\detokenize{reference/utility:indent}}\label{\detokenize{reference/utility:index-61}}
\sphinxAtStartPar
\sphinxstyleemphasis{Returns a string of spaces for indentation.}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Returns a string of \sphinxcode{\sphinxupquote{level * 2}} space characters, useful for building indented text output.  Used internally by \sphinxcode{\sphinxupquote{PrintProperties()}}.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{Indent}\PYG{p}{(}\PYG{n+nv}{level}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nf}{Indent}\PYG{p}{(}\PYG{l+m+mi}{0}\PYG{p}{)}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}top level\PYGZdq{}}\PYG{p}{)}
\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nf}{Indent}\PYG{p}{(}\PYG{l+m+mi}{1}\PYG{p}{)}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}one level in\PYGZdq{}}\PYG{p}{)}
\PYG{n+nf}{Print}\PYG{p}{(}\PYG{n+nf}{Indent}\PYG{p}{(}\PYG{l+m+mi}{2}\PYG{p}{)}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}two levels in\PYGZdq{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{PrintProperties()}}

\index{MakeFontFamily@\spxentry{MakeFontFamily}}\ignorespaces 

\subsection{MakeFontFamily()}
\label{\detokenize{reference/utility:makefontfamily}}\label{\detokenize{reference/utility:index-62}}
\sphinxAtStartPar
\sphinxstyleemphasis{Creates a set of font variants (normal, bold, italic, bold\sphinxhyphen{}italic) from a single font file.}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Creates and returns a custom object with four properties — \sphinxcode{\sphinxupquote{normal}}, \sphinxcode{\sphinxupquote{bold}}, \sphinxcode{\sphinxupquote{italic}}, and \sphinxcode{\sphinxupquote{bolditalic}} — each holding a font object created with \sphinxcode{\sphinxupquote{MakeFont()}}.  All four variants are created once and can be reused without repeated create/destroy overhead, which is especially useful for markdown\sphinxhyphen{}style text rendering that switches between styles inline.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{MakeFontFamily}\PYG{p}{(}\PYG{n+nv}{filename}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{size}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{fgcolor}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{bgcolor}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{antialiased}\PYG{p}{)}
\end{sphinxVerbatim}
...
\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{filename}} — font file name (e.g., \sphinxcode{\sphinxupquote{"DejaVuSans.ttf"}})

\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{size}} — point size (e.g., 24)

\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{fgcolor}} — foreground colour object from \sphinxcode{\sphinxupquote{MakeColor()}}

\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{bgcolor}} — background colour object from \sphinxcode{\sphinxupquote{MakeColor()}}

\item {} 
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{antialiased}} — 1 to enable antialiasing, 0 to disable
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nv}{fg}\PYG{+w}{  }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeColor}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}black\PYGZdq{}}\PYG{p}{)}
\PYG{n+nv}{bg}\PYG{+w}{  }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeColor}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}white\PYGZdq{}}\PYG{p}{)}
\PYG{n+nv}{fam}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeFontFamily}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}DejaVuSans.ttf\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{24}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{fg}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{bg}\PYG{p}{,}\PYG{+w}{ }\PYG{l+m+mi}{1}\PYG{p}{)}

\PYG{n+nv}{normalLabel}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeLabel}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}Regular text\PYGZdq{}}\PYG{p}{,}\PYG{+w}{    }\PYG{n+nv}{fam.normal}\PYG{p}{)}
\PYG{n+nv}{boldLabel}\PYG{+w}{   }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeLabel}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}Bold text\PYGZdq{}}\PYG{p}{,}\PYG{+w}{       }\PYG{n+nv}{fam.bold}\PYG{p}{)}
\PYG{n+nv}{italicLabel}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeLabel}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}Italic text\PYGZdq{}}\PYG{p}{,}\PYG{+w}{     }\PYG{n+nv}{fam.italic}\PYG{p}{)}
\PYG{n+nv}{biBoldLabel}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeLabel}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}Bold\PYGZhy{}italic\PYGZdq{}}\PYG{p}{,}\PYG{+w}{     }\PYG{n+nv}{fam.bolditalic}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{MakeFont()}}, \sphinxcode{\sphinxupquote{MakeLabel()}}

\index{JoinStrings@\spxentry{JoinStrings}}\ignorespaces 

\subsection{JoinStrings()}
\label{\detokenize{reference/utility:joinstrings}}\label{\detokenize{reference/utility:index-63}}
\sphinxAtStartPar
\sphinxstyleemphasis{Joins a list of strings into a single string with a separator.}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Concatenates all strings in \sphinxcode{\sphinxupquote{list}} into a single string, inserting \sphinxcode{\sphinxupquote{separator}} between adjacent elements.  Returns an empty string for an empty list, and the single element unchanged for a one\sphinxhyphen{}element list.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{JoinStrings}\PYG{p}{(}\PYG{n+nv}{list}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{separator}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nv}{parts}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{p}{[}\PYG{l+s+s2}{\PYGZdq{}one\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}two\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}three\PYGZdq{}}\PYG{p}{]}
\PYG{n+nv}{result}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{JoinStrings}\PYG{p}{(}\PYG{n+nv}{parts}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}, \PYGZdq{}}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{} result == \PYGZdq{}one, two, three\PYGZdq{}}

\PYG{n+nv}{csv}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{JoinStrings}\PYG{p}{(}\PYG{p}{[}\PYG{n+nv+vg}{gSubNum}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{trial}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv}{rt}\PYG{p}{]}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{},\PYGZdq{}}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{ConcatenateList()}}, \sphinxcode{\sphinxupquote{SplitString()}}, \sphinxcode{\sphinxupquote{ListToString()}}

\index{ConvertNewlinesToCR@\spxentry{ConvertNewlinesToCR}}\ignorespaces 

\subsection{ConvertNewlinesToCR()}
\label{\detokenize{reference/utility:convertnewlinestocr}}\label{\detokenize{reference/utility:index-64}}
\sphinxAtStartPar
\sphinxstyleemphasis{Converts \textasciigrave{}\textasciigrave{}\textbackslash{}n\textasciigrave{}\textasciigrave{} sequences in a string to PEBL CR() newlines.}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Replaces literal \sphinxcode{\sphinxupquote{\textbackslash{}n\textbackslash{}n}} sequences with \sphinxcode{\sphinxupquote{CR(2)}} and \sphinxcode{\sphinxupquote{\textbackslash{}n}} sequences with \sphinxcode{\sphinxupquote{CR(1)}} in \sphinxcode{\sphinxupquote{text}}.  This is needed because strings loaded from JSON translation files use \sphinxcode{\sphinxupquote{\textbackslash{}n}} for line breaks, while PEBL’s display functions require \sphinxcode{\sphinxupquote{CR()}}.

\sphinxAtStartPar
\sphinxstylestrong{Usage:}

\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{ConvertNewlinesToCR}\PYG{p}{(}\PYG{n+nv}{text}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nv}{raw}\PYG{+w}{  }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}Line one\PYGZbs{}nLine two\PYGZbs{}n\PYGZbs{}nNew paragraph\PYGZdq{}}
\PYG{n+nv}{text}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{ConvertNewlinesToCR}\PYG{p}{(}\PYG{n+nv}{raw}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{} text now contains actual PEBL newlines}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{CR()}}, \sphinxcode{\sphinxupquote{SubstituteStrings()}}, \sphinxcode{\sphinxupquote{GetStrings()}}

\index{InitializeLSL@\spxentry{InitializeLSL}}\ignorespaces 

\subsection{InitializeLSL()}
\label{\detokenize{reference/utility:initializelsl}}\label{\detokenize{reference/utility:index-65}}
\sphinxAtStartPar
\sphinxstyleemphasis{Initializes a Lab Streaming Layer (LSL) outlet for event\sphinxhyphen{}marker streaming.}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Call once at the start of your experiment (after parameter initialization) to create an LSL outlet that downstream recording software (e.g., LabRecorder) can subscribe to.  The function is a no\sphinxhyphen{}op when the experiment was not started with the \sphinxcode{\sphinxupquote{\sphinxhyphen{}\sphinxhyphen{}lsl}} flag, so it can be left in the script unconditionally.

\sphinxAtStartPar
If \sphinxcode{\sphinxupquote{win}} is a valid window object, \sphinxcode{\sphinxupquote{InitializeLSL()}} shows a prompt asking the experimenter to confirm that LabRecorder is recording before continuing.

\sphinxAtStartPar
The stream name is taken from the \sphinxcode{\sphinxupquote{\sphinxhyphen{}\sphinxhyphen{}lsl \textless{}name\textgreater{}}} command\sphinxhyphen{}line argument, or auto\sphinxhyphen{}generated as \sphinxcode{\sphinxupquote{PEBL\_\textless{}scriptbasename\textgreater{}}} if no name was given.
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{InitializeLSL}\PYG{p}{(}\PYG{n+nv}{win}\PYG{o}{:}\PYG{l+m+mi}{0}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nv+vg}{gParams}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{CreateParameters}\PYG{p}{(}\PYG{n+nv}{parpairs}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv+vg}{gParamFile}\PYG{p}{)}
\PYG{n+nv+vg}{gWin}\PYG{+w}{    }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{MakeWindow}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}black\PYGZdq{}}\PYG{p}{)}
\PYG{n+nf}{InitializeLSL}\PYG{p}{(}\PYG{n+nv+vg}{gWin}\PYG{p}{)}\PYG{+w}{   }\PYG{c+c1}{\PYGZsh{}\PYGZsh{} prompts experimenter to start LabRecorder}

\PYG{c+c1}{\PYGZsh{}\PYGZsh{} ... run experiment ...}
\PYG{n+nf}{FinalizeLSL}\PYG{p}{(}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{LSLMarker()}}, \sphinxcode{\sphinxupquote{FinalizeLSL()}}, \sphinxcode{\sphinxupquote{CreateLSLOutlet()}}

\index{LSLMarker@\spxentry{LSLMarker}}\ignorespaces 

\subsection{LSLMarker()}
\label{\detokenize{reference/utility:lslmarker}}\label{\detokenize{reference/utility:index-66}}
\sphinxAtStartPar
\sphinxstyleemphasis{Sends an event marker to the active LSL stream.}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Sends \sphinxcode{\sphinxupquote{marker}} (a string or integer) to the LSL outlet created by \sphinxcode{\sphinxupquote{InitializeLSL()}}.  LSL automatically timestamps the sample.  The function is a no\sphinxhyphen{}op when \sphinxcode{\sphinxupquote{gLSLEnabled}} is false (i.e., \sphinxcode{\sphinxupquote{\sphinxhyphen{}\sphinxhyphen{}lsl}} was not used), so it can be called unconditionally on every trial.
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{LSLMarker}\PYG{p}{(}\PYG{n+nv}{marker}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{LSLMarker}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}trial\PYGZus{}start\PYGZdq{}}\PYG{p}{)}
\PYG{c+c1}{\PYGZsh{}\PYGZsh{} show stimulus}
\PYG{n+nf}{Draw}\PYG{p}{(}\PYG{p}{)}
\PYG{n+nf}{LSLMarker}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}stimulus\PYGZus{}onset\PYGZdq{}}\PYG{p}{)}
\PYG{n+nv}{response}\PYG{+w}{ }\PYG{o}{\PYGZlt{}\PYGZhy{}}\PYG{+w}{ }\PYG{n+nf}{WaitForListKeyPress}\PYG{p}{(}\PYG{p}{[}\PYG{l+s+s2}{\PYGZdq{}z\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{l+s+s2}{\PYGZdq{}/\PYGZdq{}}\PYG{p}{]}\PYG{p}{)}
\PYG{n+nf}{LSLMarker}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}response\PYGZus{}\PYGZdq{}}\PYG{+w}{ }\PYG{o}{+}\PYG{+w}{ }\PYG{n+nv}{response}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{InitializeLSL()}}, \sphinxcode{\sphinxupquote{FinalizeLSL()}}, \sphinxcode{\sphinxupquote{SendLSLMarker()}}

\index{FinalizeLSL@\spxentry{FinalizeLSL}}\ignorespaces 

\subsection{FinalizeLSL()}
\label{\detokenize{reference/utility:finalizelsl}}\label{\detokenize{reference/utility:index-67}}
\sphinxAtStartPar
\sphinxstyleemphasis{Closes the LSL outlet at the end of the experiment.}

\sphinxAtStartPar
\sphinxstylestrong{Description:}

\sphinxAtStartPar
Closes the LSL outlet created by \sphinxcode{\sphinxupquote{InitializeLSL()}} and releases resources.  This call is optional but recommended for a clean shutdown.  It is a no\sphinxhyphen{}op when \sphinxcode{\sphinxupquote{gLSLEnabled}} is false.
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{k}{define}\PYG{+w}{ }\PYG{n+nf}{FinalizeLSL}\PYG{p}{(}\PYG{p}{)}
\end{sphinxVerbatim}
...
\begin{sphinxVerbatim}[commandchars=\\\{\}]
\PYG{n+nf}{MessageBox}\PYG{p}{(}\PYG{l+s+s2}{\PYGZdq{}Thank you for participating!\PYGZdq{}}\PYG{p}{,}\PYG{+w}{ }\PYG{n+nv+vg}{gWin}\PYG{p}{)}
\PYG{n+nf}{FinalizeLSL}\PYG{p}{(}\PYG{p}{)}
\end{sphinxVerbatim}
...
\sphinxAtStartPar
\sphinxcode{\sphinxupquote{InitializeLSL()}}, \sphinxcode{\sphinxupquote{LSLMarker()}}, \sphinxcode{\sphinxupquote{CloseLSLOutlet()}}
