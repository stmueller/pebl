  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/globallocal.data';
      var REMOTE_PACKAGE_BASE = 'globallocal.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "globallocal", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/globallocal", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/globallocal", "stim", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/globallocal", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/globallocal.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/globallocal.data');
    ...
    Module['removeRunDependency']('globallocal.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('globallocal.js.metadata');
    var metadataUrl = Module['locateFile']?.('globallocal.js.metadata', '') ?? 'globallocal.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
