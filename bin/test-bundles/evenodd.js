  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/evenodd.data';
      var REMOTE_PACKAGE_BASE = 'evenodd.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "evenodd", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/evenodd", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/evenodd", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/evenodd.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/evenodd.data');
    ...
    Module['removeRunDependency']('evenodd.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('evenodd.js.metadata');
    var metadataUrl = Module['locateFile']?.('evenodd.js.metadata', '') ?? 'evenodd.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
