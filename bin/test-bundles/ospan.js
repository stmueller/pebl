  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/ospan.data';
      var REMOTE_PACKAGE_BASE = 'ospan.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "ospan", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/ospan", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/ospan", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/ospan.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/ospan.data');
    ...
    Module['removeRunDependency']('ospan.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('ospan.js.metadata');
    var metadataUrl = Module['locateFile']?.('ospan.js.metadata', '') ?? 'ospan.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
