  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/hicks.data';
      var REMOTE_PACKAGE_BASE = 'hicks.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "hicks", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/hicks", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/hicks", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/hicks.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/hicks.data');
    ...
    Module['removeRunDependency']('hicks.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('hicks.js.metadata');
    var metadataUrl = Module['locateFile']?.('hicks.js.metadata', '') ?? 'hicks.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
