  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/timetap.data';
      var REMOTE_PACKAGE_BASE = 'timetap.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "timetap", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/timetap", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/timetap", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/timetap.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/timetap.data');
    ...
    Module['removeRunDependency']('timetap.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('timetap.js.metadata');
    var metadataUrl = Module['locateFile']?.('timetap.js.metadata', '') ?? 'timetap.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
