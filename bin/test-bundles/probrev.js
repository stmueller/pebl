  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/probrev.data';
      var REMOTE_PACKAGE_BASE = 'probrev.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "probrev", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/probrev", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/probrev", "png", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/probrev", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/probrev.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/probrev.data');
    ...
    Module['removeRunDependency']('probrev.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('probrev.js.metadata');
    var metadataUrl = Module['locateFile']?.('probrev.js.metadata', '') ?? 'probrev.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
