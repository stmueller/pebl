  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/plusminus.data';
      var REMOTE_PACKAGE_BASE = 'plusminus.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "plusminus", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/plusminus", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/plusminus", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/plusminus.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/plusminus.data');
    ...
    Module['removeRunDependency']('plusminus.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('plusminus.js.metadata');
    var metadataUrl = Module['locateFile']?.('plusminus.js.metadata', '') ?? 'plusminus.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
