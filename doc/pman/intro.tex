...
For OSX, we provide a \texttt{.app} package that can be dragged into your Applications folder.  The first time any user  runs pebl, it gives the option to install the battery and other files into Documents\\pebl-exp.X.  Afterward, it will run the launcher from that directory.
