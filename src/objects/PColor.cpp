    ...
    PEBLObjectBase(CDT_COLOR)
{
    ...
    mAlpha = pcolor.GetAlpha();
     ...
     InitializeProperty("GREEN",Variant((int)mGreen));
     InitializeProperty("BLUE",Variant((int)mBlue));
     InitializeProperty("ALPHA",Variant((int)mAlpha));
