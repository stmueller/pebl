  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/digitsymbol.data';
      var REMOTE_PACKAGE_BASE = 'digitsymbol.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "digitsymbol", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/digitsymbol", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/digitsymbol", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/digitsymbol.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/digitsymbol.data');
    ...
    Module['removeRunDependency']('digitsymbol.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('digitsymbol.js.metadata');
    var metadataUrl = Module['locateFile']?.('digitsymbol.js.metadata', '') ?? 'digitsymbol.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
