...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "bcst-64", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/bcst-64", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/bcst-64", "png", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/bcst-64", "translations", true, true);
  ...
  async function runMetaWithFS() {
    Module['addRunDependency']('bcst-64.js.metadata');
    var metadataUrl = Module['locateFile']?.('bcst-64.js.metadata', '') ?? 'bcst-64.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
