  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/spatialcueing.data';
      var REMOTE_PACKAGE_BASE = 'spatialcueing.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "spatialcueing", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/spatialcueing", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/spatialcueing", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/spatialcueing.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/spatialcueing.data');
    ...
    Module['removeRunDependency']('spatialcueing.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('spatialcueing.js.metadata');
    var metadataUrl = Module['locateFile']?.('spatialcueing.js.metadata', '') ?? 'spatialcueing.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
