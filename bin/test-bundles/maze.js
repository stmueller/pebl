  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/maze.data';
      var REMOTE_PACKAGE_BASE = 'maze.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery/maze", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/maze.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/maze.data');
    ...
    Module['removeRunDependency']('maze.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('maze.js.metadata');
    var metadataUrl = Module['locateFile']?.('maze.js.metadata', '') ?? 'maze.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
