...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "spanvariants", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/spanvariants", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/spanvariants", "translations", true, true);
  ...
  async function runMetaWithFS() {
    Module['addRunDependency']('spanvariants.js.metadata');
    var metadataUrl = Module['locateFile']?.('spanvariants.js.metadata', '') ?? 'spanvariants.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
