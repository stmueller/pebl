...
!define VERSION "02.0.11.00"
!define COPYRIGHT "Shane T. Mueller, Ph.D., 2018"
!define DESCRIPTION "Application"
!define LICENSE_TXT "..\COPYING"
!define INSTALLER_NAME "..\PEBL_setup.2.0.11.exe"
!define MAIN_APP_EXE "pebl2.exe"
!define INSTALL_TYPE "SetShellVarContext all"
!define REG_ROOT "HKCU"
!define REG_APP_PATH "Software\Microsoft\Windows\CurrentVersion\App Paths\${MAIN_APP_EXE}"
!define UNINSTALL_PATH "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APP_NAME}"
!define USERDIR "$DOCUMENTS\pebl-exp.2.0"
...
File "..\doc\pman\PEBLManual2.0.pdf"
...
#FileWrite $0 "$INSTDIR\bin\pebl2.exe$\r$\n"
#FileWrite $0 "$DOCUMENTS\pebl-exp.2.0$\r$\n"
...
SetOutPath "$INSTDIR"
CreateShortCut "$SMPROGRAMS\$SM_Folder\doc.lnk" "$INSTDIR\doc\pman\PEBLManual2.0.pdf"
!ifdef WEB_SITE
