  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/sternberg.data';
      var REMOTE_PACKAGE_BASE = 'sternberg.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "sternberg", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/sternberg", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/sternberg", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/sternberg.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/sternberg.data');
    ...
    Module['removeRunDependency']('sternberg.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('sternberg.js.metadata');
    var metadataUrl = Module['locateFile']?.('sternberg.js.metadata', '') ?? 'sternberg.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
