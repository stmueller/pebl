  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/matchtosample.data';
      var REMOTE_PACKAGE_BASE = 'matchtosample.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "matchtosample", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/matchtosample", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/matchtosample", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/matchtosample.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/matchtosample.data');
    ...
    Module['removeRunDependency']('matchtosample.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('matchtosample.js.metadata');
    var metadataUrl = Module['locateFile']?.('matchtosample.js.metadata', '') ?? 'matchtosample.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
