  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/mullerlyer.data';
      var REMOTE_PACKAGE_BASE = 'mullerlyer.data';
...
Module['FS_createPath']("/usr/local/share/pebl2/battery", "mullerlyer", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/mullerlyer", "params", true, true);
Module['FS_createPath']("/usr/local/share/pebl2/battery/mullerlyer", "translations", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/mullerlyer.data');
      }
      Module['addRunDependency']('datafile_/home/home/smueller/Dropbox/Research/pebl/pebl/bin/test-bundles/mullerlyer.data');
    ...
    Module['removeRunDependency']('mullerlyer.js.metadata');
  }

  async function runMetaWithFS() {
    Module['addRunDependency']('mullerlyer.js.metadata');
    var metadataUrl = Module['locateFile']?.('mullerlyer.js.metadata', '') ?? 'mullerlyer.js.metadata';
    if (isNode) {
          var fsPromises = require('fs/promises');
